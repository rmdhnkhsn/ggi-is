...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<i class="iconLeft fas fa-angle-left"></i>');
            var $nextMonthNavIcon = $('<i class="iconRight fas fa-angle-right"></i>');
            ...
            var $currMonthLabel = $('<span class="text-white">~</span><span class="tdAbsolute">' + monthLabels[month] + ' ' + year + '</span>');
        ...
        function appendDayOfWeekHeader($calendarElement, $tableObj) {
            if ($calendarElement.data('showDays') === true) {
                ...
                var $dowHeaderRow = $('<tr class="calendar-dow-header table-bordered"></tr>');
        ...
        function appendDaysOfMonth($calendarElement, $tableObj, year, month) {
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                var $dowRow = $('<tr class="calendar-dow table-bordered"></tr>');
        ...
        function drawEvents($calendarElement, type) {
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    if (typeof (value.badgeLibur) !== 'undefined' && value.badgeLibur !== false) {
                        var badgeClass = (value.badgeLibur === true) ? 'badgeLibur' : value.badgeLibur;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeHadir) !== 'undefined' && value.badgeHadir !== false) {
                        var badgeClass = (value.badgeHadir === true) ? 'badgeHadir' : value.badgeHadir;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeMangkir) !== 'undefined' && value.badgeMangkir !== false) {
                        var badgeClass = (value.badgeMangkir === true) ? 'badgeMangkir' : value.badgeMangkir;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeTelat) !== 'undefined' && value.badgeTelat !== false) {
                        var badgeClass = (value.badgeTelat === true) ? 'badgeTelat' : value.badgeTelat;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeIzin) !== 'undefined' && value.badgeIzin !== false) {
                        var badgeClass = (value.badgeIzin === true) ? 'badgeIzin' : value.badgeIzin;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeCuti) !== 'undefined' && value.badgeCuti !== false) {
                        var badgeClass = (value.badgeCuti === true) ? 'badgeCuti' : value.badgeCuti;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeSakit) !== 'undefined' && value.badgeSakit !== false) {
                        var badgeClass = (value.badgeSakit === true) ? 'badgeSakit' : value.badgeSakit;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }

                    if (typeof (value.badgeLembur) !== 'undefined' && value.badgeLembur !== false) {
                        var badgeClass = (value.badgeLembur === true) ? 'badgeLembur' : value.badgeLembur;
                        var dayLabel = $dayElement.data('day');
                        $dayElement.html('<span class="badge ' + badgeClass + '">' + dayLabel + '</span>');
                    }
