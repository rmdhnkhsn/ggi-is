...
(function (a) {
        ...
        x.cuboid = a(x.base, {
            ...
            animate: function (a, d, c) {
                if (f(a.x) && f(a.y)) {
                    ...
                    b !== this.forcedSides && (this.forcedSides = b, this.renderer.styledMode || x.cuboid.fillSetter.call(this,
                        this.fill))
    ...
    a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGElement3D.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]
        ...
        var k = this && this.__extends || function () {
            ...
            return function (e, c) {
                ...
                b(e, c);
                e.prototype = null === c ? Object.create(c) : (d.prototype = c.prototype,
                    new d)
            }
        }(),
            d = a.animObject,
        ...
        return function (a) {
            ...
            m.curveTo = function (b, e, h, r, g, y, c, d) {
                var H = [],
                    a = y - g;
                return y > g && y - g > Math.PI / 2 + .0001 ? (H = H.concat(this.curveTo(b, e, h, r, g, g + Math.PI / 2, c, d)), H = H.concat(this.curveTo(b, e, h, r, g + Math.PI / 2, y, c, d))) : y < g && g - y > Math.PI / 2 + .0001 ? (H = H.concat(this.curveTo(b, e, h, r, g, g - Math.PI / 2, c, d)), H = H.concat(this.curveTo(b, e, h, r, g - Math.PI / 2, y, c, d))) : [
                    ["C", b + h * Math.cos(g) - h * B * a * Math.sin(g) + c, e + r * Math.sin(g) + r * B * a * Math.cos(g) + d, b + h * Math.cos(y) + h * B * a * Math.sin(y) + c, e + r * Math.sin(y) - r * B *
            ...
            m.prototype.face3d = function (c) {
                ...
                h.attr = function (h) {
                    if ("object" === typeof h && (e(h.enabled) ||
                        e(h.vertexes) || e(h.insidePlotArea))) {
            ...
            m.prototype.polyhedron = function (b) {
                ...
                h.attr = function (b, y, r, d) {
                    ...
                    return f.prototype.attr.apply(this,
                        arguments)
                };
            ...
            m.prototype.arc3dPath = function (b) {
                ...
                c > x && g < x ? (f.push(["L", h + k * G(t) + a, r + d * C(t) + B]), f = f.concat(m.curveTo(h, r, k, d, t, x, a, B)), f.push(["L", h + k * G(x), r + d * C(x)]), f = f.concat(m.curveTo(h, r, k, d, x, c, 0, 0)), f.push(["L", h + k * G(c) + a, r + d * C(c) + B]), f = f.concat(m.curveTo(h, r, k, d, c, x, a, B)), f.push(["L", h + k * G(x), r + d * C(x)]),
                    f = f.concat(m.curveTo(h, r, k, d, x, t, 0, 0))) : c > I - p && g < I - p && (f.push(["L", h + k * Math.cos(t) + a, r + d * Math.sin(t) + B]), f = f.concat(m.curveTo(h, r, k, d, t, c, a, B)), f.push(["L", h + k * Math.cos(c), r + d * Math.sin(c)]), f = f.concat(m.curveTo(h, r, k, d, c, t, 0, 0)));
        ...
        (function (a) {
            ...
            function q() {
                ...
                if (this.chart3d && this.is3d()) {
                    ...
                    g[e ? "x" : "y"] = -(c[0] || 0);
                    g[e ? "height" :
                        "width"] = this.chartWidth + (c[3] || 0) + (c[1] || 0);
            ...
            var F = function () {
                ...
                e.prototype.get3dFrame = function () {
                    ...
                    var t = function (e, c, d) {
                        for (var g = ["size", "color", "visible"], a = {}, p = 0; p < g.length; p++)
                            for (var h = g[p], n = 0; n < e.length; n++)
            ...
            a.compose = function (b, f) {
                ...
                f.matrixSetter = function () {
                    if (1 > this.pos && (d(this.start) || d(this.end))) {
                        ...
                        var c = [];
                        for (var a = 0; 6 > a; a++) c.push(this.pos * e[a] + (1 - this.pos) *
                            b[a])
                    } else c = this.end;
        ...
        return function () {
            ...
            a.wrapGetPlotBandPath = function (b) {
                if (!this.chart.is3d() || "colorAxis" ===
                    this.coll) return b.apply(this, [].slice.call(arguments, 1));
                var a = arguments,
                    c = a[2],
                    e = [];
            ...
            a.wrapGetPlotLinePath = function (b) {
                ...
                "M" === l[0] && "L" === k[0] && (a = [a.swapZ({
                    ...
                    y: k[2],
                    z: f
                })], this.horiz ? (this.isZAxis ? (d.left.visible && e.push(a[0], a[2]), d.right.visible && e.push(a[1], a[3])) : (d.front.visible && e.push(a[0], a[2]), d.back.visible && e.push(a[1], a[3])), d.top.visible && e.push(a[0], a[1]), d.bottom.visible && e.push(a[2], a[3])) : (d.front.visible &&
                    e.push(a[0], a[2]), d.back.visible && e.push(a[1], a[3]), d.left.visible && e.push(a[0], a[1]), d.right.visible && e.push(a[2], a[3])), e = v(e, this.chart, !1));
            ...
            a.wrapGetSlotWidth = function (a, c) {
                ...
                if (this.categories && e.frameShapes && e.is3d() && f && c && c.label) {
                    ...
                    e = {
                        ...
                        y: e.plotHeight / 2,
                        z: l.depth / 2,
                        vd: b(l.depth, 1) * b(l.viewDistance,
                            0)
                    };
                    l = c.pos;
                    var k = d[l - 1],
        ...
        t = function (a) {
            ...
            c.prototype.translate3dPoints = function () {
                var b = this.options,
                    ...
                    d = [],
                    e, n = [];
                this.zPadding = (b.stacking ? k(b.stack) ? b.stack :
                    0 : this.index || 0) * (b.depth || 0 + (b.groupZPadding || 1));
            ...
            b.data.forEach(function (c) {
                ...
                if (null !== c.y) {
                    ...
                    [
                        ...
                        p + e[a[1]] > b[a[0] + "Axis"].len && 0 !== e[a[1]] && (e[a[1]] =
                            b[a[0] + "Axis"].len - e[a[0]]);
        ...
        v(b, "setVisible", function (b, a) {
            ...
            c.chart.is3d() && c.data.forEach(function (b) {
                b.visible = b.options.visible =
                    a = "undefined" === typeof a ? !A(c.visible, b.visible) : a;
        ...
        w(a, "afterInit", function () {
            if (this.chart.is3d()) {
                ...
                if ("undefined" === typeof a || a) {
                    ...
                    f = 10 * (a.totalStacks - a[f].position) +
                        (d ? c : -c);
    ...
    E(a, "Series/Pie3D/Pie3DSeries.js",
        [a["Core/Globals.js"], a["Series/Pie3D/Pie3DPoint.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]],
        function (a, w, t, D) {
            var f = this && this.__extends || function () {
                var a = function (d, c) {
                    a = Object.setPrototypeOf || {
                    ...
                    if (this.chart.is3d()) {
                        ...
                        this.data.forEach(function (b) {
                            ...
                            var e = b.connectorPosition,
                                k = -d * (1 - Math.cos((a.alpha ||
                                    c.alpha) * z)) * Math.sin(f),
    ...
    E(a, "Series/Scatter3D/Scatter3DPoint.js", [a["Series/Scatter/ScatterSeries.js"], a["Core/Utilities.js"]], function (a, w) {
        var t = this && this.__extends || function () {
            ...
            return function (f, t) {
                ...
                a(f, t);
                f.prototype = null === t ? Object.create(t) : (v.prototype = t.prototype,
                    new v)
            }
        }(),
            F = w.defined;
    ...
    E(a, "Series/Area3DSeries.js", [a["Extensions/Math3D.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, w, t) {
        ...
        t(a.area.prototype, "getGraphPath", function (a) {
            ...
            if (this.rawPointsX)
                for (var v =
                    0; v < this.points.length; v++) c.push({
                        x: this.rawPointsX[v],
