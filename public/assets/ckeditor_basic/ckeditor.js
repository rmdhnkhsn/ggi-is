...
(function () {
                ...
                on: function (b, c, k, h, q) {
                    ...
                    if (0 > y.getListenerIndex(c)) {
                        ...
                        for (var A = y.length - 1; 0 <= A; A--)
                            if (y[A].priority <= q) return y.splice(A + 1, 0, m), {
                                removeListener: g
                            };
                        y.unshift(m)
                    }
    ...
    (function () {
        ...
        var b = [],
            ...
            k = /</g,
            h = /"/g,
            q = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            m = {
                lt: "\x3c",
                gt: "\x3e",
                amp: "\x26",
        ...
        CKEDITOR.tools = {
            ...
            createClass: function (a) {
                ...
                c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function w() {
            ...
            keystrokeToArray: function (a, b) {
                ...
                c & CKEDITOR.SHIFT && (l.push(h ? "⇧" : a[16]), e.push(a[16]));
            ...
            getCookie: function (a) {
                ...
                for (var b = document.cookie.split(";"), c, g, h = 0; h < b.length; h++)
                    if (c = b[h].split("\x3d"), g = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), g === a) return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            escapeCss: function (a) {
                if (a)
                    if (window.CSS && CSS.escape) a = CSS.escape(a);
                        ...
                        a = String(a);
                        for (var b = a.length, c = -1, g, h = "", l = a.charCodeAt(0); ++c < b;) g = a.charCodeAt(c), h = 0 == g ? h + "�" : 127 == g || 1 <= g && 31 >= g || 0 == c && 48 <=
                            g && 57 >= g || 1 == c && 48 <= g && 57 >= g && 45 == l ? h + ("\\" + g.toString(16) + " ") : 0 == c && 1 == b && 45 == g ? h + ("\\" + a.charAt(c)) : 128 <= g || 45 == g || 95 == g || 48 <= g && 57 >= g || 65 <= g && 90 >= g || 97 <= g && 122 >= g ? h + a.charAt(c) : h + ("\\" + a.charAt(c));
                        a = h
                    }
                else a = "";
                return a
    ...
    (function () {
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var q = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(),
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            function f(a, b, c, g) {
                ...
                if (g && k) return R;
                q || g ? b.append(a.clone(!0, e), c) : (a.remove(), m && b.append(a, c));
                return R
            }

            function l() {
                var a, b, c, g = Math.min(N.length, r.length);
                for (a = 0; a < g; a++)
                    if (b = N[a], c = r[a], !b.equals(c)) return a;
                return a - 1
            }
            ...
            if (q && u.type == CKEDITOR.NODE_TEXT && (p.equals(u) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(u))) c.append(a.document.createText(u.substring(K, E)));
                ...
                u.type == CKEDITOR.NODE_TEXT ? q ? O = !0 : u = u.split(E) : 0 < u.getChildCount() ? E >= u.getChildCount() ? (u = u.getChild(E - 1), t = !0) : u = u.getChild(E) : z = t = !0;
                p.type == CKEDITOR.NODE_TEXT ? q ? H = !0 : p.split(K) : 0 < p.getChildCount() ? 0 === K ? (p = p.getChild(K), C = !0) : p = p.getChild(K - 1) : B = C = !0;
                for (var N = p.getParents(), r = u.getParents(), I = l(),
                    M = N.length - 1, n = r.length - 1, D = c, R, aa, X, ea = -1, V = I; V <= M; V++) {
                    aa = N[V];
                    X = aa.getNext();
                ...
                D = c;
                for (V = I; V <= n; V++)
                    if (c = r[V], X = c.getPrevious(), c.equals(N[V])) b && (D = D.getChild(0));
                    else {
                        V != n || c.equals(N[V]) && n < M ? b && (R = D.append(c.clone(0, e))) : t ? f(c, D, !1, z) : O && D.append(a.document.createText(c.substring(0, E)));
                        if (V > ea)
                            for (; X;) X = f(X, D, !0);
                        D = R
                    } q ||
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        C.type == CKEDITOR.NODE_TEXT ? (t && (C = !CKEDITOR.tools.trim(C.substring(0, t)).length && C, E = !!C), C && ((u = C.getPrevious()) || (p = C.getParent()))) : (t && (u = C.getChild(t - 1) || C.getLast()), u || (p = C));
                        for (p = c(p); p ||
                            u;) {
                            if (p && !u) {
                                !K && p.equals(k) && (K = !0);
                                if (h ? p.isBlockBoundary() : !l.contains(p)) break;
                                E && "inline" == p.getComputedStyle("display") || (E = !1, K ? m = p : this.setStartBefore(p));
                                u = p.getPrevious()
                            }
                            for (; u;)
                                if (C = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious();
                                    ...
                                    C && (E ? K ? m = p : p && this.setStartBefore(p) : E = !0);
                                    if (u) {
                                        C = u.getPrevious();
                                        if (!p && !C) {
                                            p = u;
                        ...
                        p = u = null;
                        K = E = !1;
                        C.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(C.substring(t)).length ? E = !0 : (E = !C.getLength(), t == C.getLength() ? (u = C.getNext()) || (p = C.getParent()) : d(C,
                            t, l) && (p = C.getParent())) : (u = C.getChild(t)) || (p = C);
                        for (; p || u;) {
                            if (p && !u) {
                                !K && p.equals(k) && (K = !0);
                                if (h ? p.isBlockBoundary() : !l.contains(p)) break;
                                E && "inline" == p.getComputedStyle("display") || (E = !1, K ? q = p : p && this.setEndAfter(p));
                                u = p.getNext()
                            }
                            for (; u;) {
                                C = !1;
                        ...
                        m && q && (k = m.contains(q) ? q : m, this.setStartBefore(k), this.setEndAfter(k));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var H, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                            br: 1
                        } : null),
                            r = null,
                            I = function (a) {
                        ...
                        H = H || l;
                        this.setStartAt(H,
                            !H.is("br") && (!p && this.checkStartOfBlock() || p && H.contains(p)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        ...
                        p = p.lastForward();
                        H = H || l;
                        this.setEndAt(H, !p && this.checkEndOfBlock() || p && H.contains(p) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            shrink: function (a, b, c) {
                ...
                if (!this.collapsed) {
                    ...
                    h && h.type == CKEDITOR.NODE_TEXT && (m ? m >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), q = 0) : f.setEndBefore(h));
            ...
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; l;) {
                    ...
                    if (J) l.type == CKEDITOR.NODE_TEXT && f.test(l.getText()) && (J = 0);
                        ...
                        var p = l.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == l.getAttribute("contenteditable")) {
                            d = l;
                            b(this, a, d);
                            break
                            ...
                            if ("br" == p) J = 1;
                            else if (!k && !l.getChildCount() && "hr" != p) {
                                d = l;
                                y = l.equals(v);
                                break
                            }
                            k && (k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = l));
                            L = 1
                        } else {
                            if (l.getFirst()) {
    ...
    (function () {
        ...
        function A(a, b, e, f) {
            ...
            if (f.doTransform && (t = a._.transformations[b.name])) {
                y(b);
                for (r = 0; r < t.length; ++r) p(a, b, t[r]);
                v(b)
            }
            if (f.doFilter) {
                a: {
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (I in H) a.allStyles || D[I] ? O.push(I + ":" + H[I]) : h = !0;
                    O.length && (r.style = O.sort().join("; "))
                } else N && (r.style = N);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
            ...
            transform: function (a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (f in e)
                        if ("class" ==
                            f)
                            for (c = a.classes.join("|"), g = e[f].split(/\s+/); t = g.pop();) - 1 == c.indexOf(t) && a.classes.push(t);
        ...
        return {
            load: function (b, c, f, e) {
                ...
                if (0 === q) x(!0);
                    ...
                    var y = function (a, b) {
                        (b ? m : g).push(a);
                        0 >= --q && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), x(b))
                    },
                        A = function (b, c) {
                            a[b] = 1;
                            var e = d[b];
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function (a, d, b) {
            ...
            for (var c = this.loaded, f = this.registered, e = [], k = {}, h = {}, q = 0; q < a.length; q++) {
                var m = a[q];
                if (m)
        ...
        function x(a) {
            ...
            CKEDITOR.plugins.load(d.split(","), function (b) {
                ...
                for (var g in b) {
                    ...
                    O && !a.lang[g] && (O.split && (O = O.split(",")), 0 <= CKEDITOR.tools.indexOf(O, a.langCode) ?
                        N = a.langCode : (N = a.langCode.replace(/-.*/, ""), N = N != a.langCode && 0 <= CKEDITOR.tools.indexOf(O, N) ? N : 0 <= CKEDITOR.tools.indexOf(O, "en") ? "en" : O[0]), k.langEntries && k.langEntries[N] ? (a.lang[g] = k.langEntries[N], N = null) : f.push(CKEDITOR.getUrl(k.path + "lang/" + N + ".js")));
                    e.push(N);
                    d.push(k)
                }
                        ...
                        if (f = f.toLowerCase(), !/="/.test(f)) {
                            ...
                            if (m)
                                for (; q = a.exec(m);) {
                                    ...
                                    q = q[2] || q[3] || q[4] || "";
                                    h[g] = !q && d[g] ? g : CKEDITOR.tools.htmlDecodeAttr(q)
                                }
        ...
        a.prototype = {
            ...
            exec: function (a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    q, m, g, x;
                for (x = 0; x < h; x++)
                    if (d && (q = c.type, m = c.name), g = k[x], !(a.nonEditable && !g.options.applyToAll ||
                        a.nestedEditable && g.options.excludeNestedEditable)) {
                        g = g.value.apply(null, e);
                        if (!1 === g || d && g && (g.name != m || g.type != q)) return g;
                        null != g && (e[0] = c = g)
                    } return c
            },
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function (a, b) {
                ...
                for (q in k) {
                    for (h = k[q]; ;)
                        if (m = a.onAttributeName(b, q))
                            if (m != q) delete k[q], q = m;
                            else break;
                        else {
                            delete k[q];
                            break
            ...
            writeHtml: function (a, b) {
                ...
                var e = this.name,
                    ...
                    q, m;
                a.openTag(e, h);
                for (q in h) k.push([q, h[q]]);
                a.sortAttributes && k.sort(d);
                q = 0;
                for (m = k.length; q < m; q++) h = k[q], a.attribute(h[0], h[1]);
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            ...
            var g = (k.$.offsetHeight || 0) - (q.$.clientHeight || 0),
    ...
    (function () {
        function a(a) {
            ...
            q(b, e.block, g) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (e = h.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), g = new CKEDITOR.dom.walker(e), g.guard = function (a) {
                ...
                setup: function () {
                    ...
                    if (!this.is("textarea")) {
                                ...
                                if (c in
                                    ...
                                    if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement();
                                        ...
                                        var l = new CKEDITOR.dom.walker(b),
                                            q = b.collapsed ? b.startContainer : l.next(),
                                            m = !1,
                                            C;
                                        if (b.checkStartOfBlock()) {
                                            C = b.startPath().block || b.startPath().blockLimit;
                                            var p = C.getName();
                                            C = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], p) && null === C.getPrevious()
                                        } else C = !1;
                                        if (C) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) {
                            b.data.getKeystroke() in O && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
                        });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (c in O && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                var c = 8 == c,
                                    d = b.getRanges()[0];
                                b = d.startPath();
                                if (d.collapsed) a: {
        ...
        w =
            function () {
                ...
                function b(c, d) {
                    ...
                    e = d.range.startPath();
                    for (var t = l[t.getName()], k = 0, z = c.getChildren(), B = z.count(), H = -1, I = -1, M = 0, m = e.contains(l.$list); k < B; ++k) e = z.getItem(k), a(e) ? (f = e.getName(), m && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (r = !!t[f], "br" != f || !e.data("cke-eol") || k && k != B - 1 || (M = (g = k ? h[k - 1].node : z.getItem(k + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && l.$block[g.getName()]), -1 != H || r || (H = k), r || (I = k), h.push({
                        isElement: 1,
                        isLineBreak: M,
                        ...
                        node: e,
                        allowed: 1
                    }); - 1 < H && (h[H].firstNotAllowed = 1); - 1 < I && (h[I].lastNotAllowed = 1);
                    return h
                }
                ...
                function d(b, c) {
                    ...
                    for (z && e.push(" "); r < f; r++) h = g.getItem(r), a(h) && !h.is(k) ? e = e.concat(d(h, c)) : e.push(h);
                    z && e.push(" ");
                    return e
                }
                ...
                return function (r, D, R, p) {
                    ...
                    if (!p.checkReadOnly()) {
                        ...
                        y = r.getHtml();
                        y = "" === y || y.match(L);
                        x.enterMode === CKEDITOR.ENTER_DIV && y && ((x = r.getFirst()) && x.remove(), p.setStartAt(r, CKEDITOR.POSITION_AFTER_START), p.collapse(!0));
                        if (r = R) {
                            r = D.range;
                            if ("text" == D.type && D.inlineStylesRoot) {
                                p = D.inlineStylesPeak;
                                x = p.getDocument().createText("{cke-peak}");
                                for (y = D.inlineStylesRoot.getParent(); !p.equals(y);) x = x.appendTo(p.clone()), p = p.getParent();
                                R = x.getOuterHtml().split("{cke-peak}").join(R)
                            }
                            p =
                                D.blockLimit.getName();
                            if (/^\s+|\s+$/.test(R) && "span" in CKEDITOR.dtd[p]) {
                            ...
                            p = r.document.createElement("body");
                            p.setHtml(R);
                            J && (p.getFirst().remove(), p.getLast().remove());
                            if ((J = r.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                                var Q;
                                if (1 ==
                                    p.getChildCount() && a(Q = p.getFirst()) && Q.is(I) && !Q.hasAttribute("contenteditable")) {
                        ...
                        if (r) {
                            ...
                            for (D.editor.enterMode !== CKEDITOR.ENTER_BR && k(x, Q); y < x.length; y++) {
                                v = x[y];
                                if (u = v.isLineBreak) u = Q, w = p, W = F = void 0, v.hasBlockSibling ? u = 1 : (F = u.startContainer.getAscendant(l.$block, 1)) && F.is({
                                    div: 1,
                                    p: 1
                                ...
                                if (u) R = 0 < y;
                                    ...
                                    u = Q.startPath();
                                    !v.isBlock && q(D.editor, u.block, u.blockLimit) && (P = m(D.editor)) && (P = r.createElement(P),
        ...
        u = function () {
            ...
            return {
                ...
                autoParagraph: function (a, b) {
                    var c = b.startPath(),
                        d;
                    q(a, c.block, c.blockLimit) && (d = m(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START))
                }
            }
        }()
    })();
    (function () {
        ...
        function k() {
            u = !0;
            p || (h.call(this), p = CKEDITOR.tools.setTimeout(h, 200, this))
        }
        ...
        function m(a) {
            ...
            var c = a.startContainer,
                d = a.getPreviousNode(q,
                    null, c),
                e = a.getNextNode(q, null, c);
            ...
            return function (c) {
                ...
                if (b[d]) {
                    var e = a.getSelection(),
                        g = e.getRanges()[0];
                    e.isCollapsed() && (g = g[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && g.type == CKEDITOR.NODE_ELEMENT && "false" == g.getAttribute("contenteditable") && (e = e.getStartElement(), !e.isBlockBoundary() || "" !== (void 0 === e.$.textContent ? e.$.innerText : e.$.textContent) || 8 !==
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                CKEDITOR.env.gecko && n.attachListener(n, "focus", function (a) {
                    a.removeListener();
                    0 !== q && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == n.$ && (a = c.createRange(), a.moveToElementEditStart(n), a.select())
                }, null, null, -2);
                n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                    if (q && (CKEDITOR.env.webkit ||
                        CKEDITOR.env.gecko)) {
                        q = c._.previousActive && c._.previousActive.equals(f.getActive());
                        var a = null != c._.previousScrollTop && c._.previousScrollTop != n.$.scrollTop;
                        CKEDITOR.env.webkit && q && a && (n.$.scrollTop = c._.previousScrollTop)
                    }
                    c.unlockSelection(q);
                    q = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || B) l ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                    ...
                    function () {
                        ...
                        CKEDITOR.env.gecko && !B && a || (c.lockSelection(p), q = 1)
            ...
            getRanges: function () {
                var a = l ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, g, f, h = b.duplicate(), k = 0, m = e.length - 1, t = -1, l, q; k <= m;)
                        ...
                        for (; 0 < h;) try {
                            f = g[0 < l ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, q = f), g = f
                        } catch (p) {
                            return {
                                container: d,
                                offset: a(g)
                        ...
                        return {
                            container: q,
                            offset: 0 < l ? -h : q.nodeValue.length + h
                        }
                    };
                    return function () {
            ...
            selectRanges: function (a) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var q, M;
                            if (1 == a.length && !(M = a[0]).collapsed && (r = M.getEnclosedNode()) && r.type == CKEDITOR.NODE_ELEMENT && (M = M.clone(), M.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (q = M.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT &&
            ...
            if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (x.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (x = 0); x;) {
                    ...
                    if (x.equals(v)) x = null, m = !0;
                        ...
                        B = w ? !q[w] || A ? 0 : y && !l ? 0 : d(x, v, h, O) : 1;
                        if (B)
                            if (E =
                                x.getParent(), B = h, G = g, H = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[G] && !H || B.parentRule && !B.parentRule(E)) m = !0;
                            else {
                                if (u || w && CKEDITOR.dtd.$removeEmpty[w] && (x.getPosition(v) | O) != O || (u = c.clone(), u.setStartBefore(x)), w = x.type, w == CKEDITOR.NODE_TEXT || y || w == CKEDITOR.NODE_ELEMENT && !x.getChildCount()) {
                                    for (var w = x, K;
                                        (m = !w.getNext(z)) && (K = w.getParent(), q[K.getName()]) && d(K, t, h, N);) w = K;
                                    u.setEndAfter(w)
                                }
                            }
                        else m = !0;
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function (a) {
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ?
                    q : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
            ...
            CKEDITOR.tools.createClass({
                ...
                _: {
                    ...
                    extractColorChannelsFromRgba: function (b) {
                        ...
                        var q = a(c[1], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
                        ...
                        return this._.areColorChannelsValid(b, q, m, g) ? c : null
                    },
                    extractColorChannelsFromHsla: function (b) {
                        ...
                        var f = 4 === c.length,
                            q = a(c[0], CKEDITOR.tools.color.MAX_HUE_CHANNEL_VALUE),
        ...
        CKEDITOR.dom.elementPath = function (b, f) {
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (q.equals(f)) break;
                    if (!k && (m = q.getName(),
                        "true" == q.getAttribute("contenteditable") ? k = q : !e && d[m] && (e = q), a[m])) {
                        if (m = !e && "div" == m) {
                            a: {
                                m = q.getChildren();
    ...
    (function () {
        function a(a, c, d) {
            var e = a.serializable,
                ...
                q = e ? c.document.getById(a.startNode) : a.startNode;
    ...
    */
    ...
    (function () {
        ...
        function da(a) {
            function b(b) {
                ...
                A = Math.floor(A);
                w = Math.floor(w);
                if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) n =
            ...
            if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(),
                    g, k, p, l, h, q, n = CKEDITOR.tools.addFunction(function (d) {
                        function e(a) {
                            return a.isVisible()
                        }
                        h = a.getSize();
                        ...
                        n && (q = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%; left:0; top:0;"\x3e\x3c/div\x3e'), f.append(q));
                        k = h.height -
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            function d(b) {
                if (m == CKEDITOR.dialog._.currentTop) {
                    ...
                    else if (c == CKEDITOR.ALT + 121 && !m._.tabBarMode && 1 < m.getPageCount()) I(m), q = 1;
                    else if (-1 != CKEDITOR.tools.indexOf(g, c) && m._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ?
                        J.call(m) : W.call(m), m.selectPage(c), m._.tabs[c][0].focus(), q = 1;
            ...
            this.on("show", function () {
                ...
                a.config.dialog_startupFocusTab && b ? (m._.tabBarMode = !0, m._.tabs[m._.currentTabId][0].focus(), m._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = b ? -1 : this._.focusList.length -
                ...
                uiElement: function (a, b, c, e, d, f, g) {
                    if (!(4 > arguments.length)) {
                        var k = (e.call ? e(b) : e) || "div",
                            ...
                            n = this.domId = h.id || CKEDITOR.tools.getNextId() + "_uiElement";
                        ...
                        for (var m = h["class"] && h["class"].split ? h["class"].split(" ") : [], n = 0; n < m.length; n++) m[n] && (r[m[n]] = 1);
                        m = [];
                        for (n in r) m.push(n);
                        h["class"] = m.join(" ");
                        b.title && (h.title = b.title);
                        r = (b.style || "").split(";");
                        b.align && (m = b.align, l["margin-left"] = "left" == m ? 0 : "auto", l["margin-right"] = "right" == m ? 0 : "auto");
                        for (n in l) r.push(n + ":" + l[n]);
                        b.hidden && r.push("display:none");
                        for (n = r.length - 1; 0 <=
                            n; n--) "" === r[n] && r.splice(n, 1);
                        0 < r.length && (h.style = (h.style ? h.style + "; " : "") + r.join("; "));
                        for (n in h) p.push(n + '\x3d"' + CKEDITOR.tools.htmlEncode(h[n]) + '" ');
            ...
            CKEDITOR.dialog.validate = {
                functions: function () {
                    ...
                    return function () {
                        ...
                        for (h = 0; h < e.length; h++) q = d == CKEDITOR.VALIDATE_AND ? q && e[h](b) : q || e[h](b);
                        return q ? !0 : c
                    }
                },
                regex: function (a, b) {
                ...
                notEmpty: function (a) {
                    var b = RegExp("^[\\u0020\\u00a0\\u1680\\u202f\\u205f\\u3000\\u2000-\\u200a\\s]+|[\\u0020\\u00a0\\u1680\\u202f\\u205f\\u3000\\u2000-\\u200a\\s]+$", "g");
                    return function (c) {
                        return 0 < (this && this.getValue ? this.getValue() : c).replace(b, "").length || a
                    }
                },
                integer: function (b) {
    ...
    (function () {
        ...
        var E = {
            ...
            readOnly: 1,
            exec: function (a) {
                a.toolbox && (CKEDITOR.env.ie || CKEDITOR.env.air ? setTimeout(function () {
                    a.toolbox.focus()
                }, 100) : a.toolbox.focus())
            }
        };
            ...
            init: function (a) {
                var d, f = function (c, h) {
                    ...
                    switch (h) {
                        ...
                        case q:
                            b = c;
                            do b = b.next, !b &&
                                k && (b = c.toolbar.items[0]); while (b && !b.focus);
                            b ? b.focus() : f(c, 9);
                            return !1;
                        case 40:
                ...
                a.on("uiSpace", function (c) {
                    if (c.data.space == a.config.toolbarLocation) {
                        ...
                        for (var q = a.toolbox.toolbars, n = D(a), g = n.length,
                            l = 0; l < g; l++) {
                            var r, m = 0,
                                w, p = n[l],
                                v = "/" !== p && ("/" === n[l + 1] || l == g - 1),
