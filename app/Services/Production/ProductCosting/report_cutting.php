...
class report_cutting{
    public function cutting_index($data_form)
    {
        ...
        foreach ($data_form as $key => $value) {
            ...
            foreach ($wo as $key2 => $value2) {
                ...
                foreach ($color as $key3 => $value3) {
                    foreach ($value->proses_cutting_user as $key4 => $value4) {
                        // Inisialisasi Awal 
                        ...
                        $banyak_user = collect($value->proses_cutting_user)->count('id');
                        // dd($banyak_user);
