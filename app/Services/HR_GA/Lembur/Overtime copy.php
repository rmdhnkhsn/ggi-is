        ...
        if($request->app==1){
            for ($i=0; $i < count($count_id); $i++) { 
                if($status_lembur[$i]==1){
                    ...
                    RencanaLembur::whereid($id[$i])->update($karyawan);
                    ...
                    DB::table('notification')->insert([
                        ...
                        'url'=>"overtime-request",
                        'title'=>"Form Lembur",
                        'desc'=> 'Tanggal '. $tanggal[$i] . ' Disetujui',
                        'is_read'=>"0"
                    ]);
                }
            }
            ...
            for ($i=0; $i < count($count_id); $i++) { 
                if($status_lembur[$i]==1){
                    ...
                    DB::table('notification')->insert([
                        ...
                        'url'=>"cc.approval",
                        'title'=>"Overtime Request",
                        'desc'=>'From - ' . $request->nama[$i] .' Amount : Rp.'. number_format($request->amount[$i], 2, ",", "."),
                        'is_read'=>"0"
                ]);
                }
            }
