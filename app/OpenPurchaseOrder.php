...
class OpenPurchaseOrder extends Model
{
    ...
    protected $table = "t_v4311cc";
    protected $primaryKey = 'F4311_DOCO';
    ...
    public function item_master(){
        return $this->belongsTo(ItemNumber::class,"F4311_ITM","F4101_ITM");
    }
    public function addressbook(){
        return $this->belongsTo(ListBuyer::class,"F4311_AN8","F0101_AN8");
    }
}
