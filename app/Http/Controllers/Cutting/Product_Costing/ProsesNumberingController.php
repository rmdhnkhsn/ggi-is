...
use App\Models\Cutting\Product_Costing\ProsesNumberingUser;

class ProsesNumberingController extends Controller
{
     /**
    ...
    public function mulai($id)
    {
        ...
        // dd($form);
        return view('production.cutting.product_costing.proses_numbering.mulai_numbering', compact('form', 'page'));
    }
    ...
    public function simpan_user(Request $request)
    {
        ...
        foreach ($request->nik as $key => $value) {
            ...
            if ($value != null) {
                ...
                // dd($data);
                ProsesNumberingUser::create($data);
            }           
        }
