...
class ItemuanController extends Controller
{
    ...
    public function create(Request $request)
        {  
            ...
            //dd($date);
            $page = 'votef';
            return view('indah/idivisi/add', compact('user','page','date','auto_number'));
    ...
    public function store(Request $request){
        ...
        if(CheckValidation::vote_schedule_all_day($nik_petugas, $day)){
            ...
            if (IndahDivisi:: where('id','=',$request->id)->count())
                {
                    return redirect()->route('divisi.create')->with(['ok' => 'Success!!']);
            }else{
            $data = (new  divisi)->store($kabag,$manager,$request,$fileName);
            ...
            // $email_kabag = 'asatria@gistexgroup.com';
