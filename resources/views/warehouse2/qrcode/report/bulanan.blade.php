          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <h4 style="font-size:18px"><b>DAILY REPORT WAREHOUSE</b></h4>
              </div>
              <div class="card-body">
                <form action="{{route ('report-warehouse')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        @include('warehouse.qrcode.report.partials.form-control', ['submit' => 'Get'])
                </form>
              </div>
              <!-- /.card-body -->
            </div>
