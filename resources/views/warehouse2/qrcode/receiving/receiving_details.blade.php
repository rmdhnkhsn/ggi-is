        ...
        <div class="cards" style="padding: 30px 20px">
          <div class="row">
            <div class="col-12 mt-4">
              ...
              <div class="flex mt-3">
                <form action="{{ route('warehouse-qrcode') }}" method="post" enctype="multipart/form-data">
                  @csrf
                <!-- <a href="{{ route('warehouse-delivery') }}" id="save" class="btn-blue-md" style="width:235px">Save</a> -->
                {{-- <button type="submit" id="save" class="btn-blue-md" style="width:235px">Save</button> --}}
                  <button type="submit" class="btn-merah-md ml-2" style="width:235px">Download QRcode<i class="ml-2 fs-18 fas fa-file-pdf"></i></button>
                </form>
