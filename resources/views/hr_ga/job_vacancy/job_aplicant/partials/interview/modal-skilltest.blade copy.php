                        ...
                        <div class="input-group mt-1 mb-3" style="gap:1.4rem">
                            <div class="justify-start">
                                <div class="radioContainer">
                                    <input type="radio" name="conclusion" value="Qualify" id="testQualify" class="radioCustomInput">
                                    <label for="testQualify" class="radioCustom"></label>
                                </div>
                                <label for="testQualify" class="title-16 pointer ml-1" style="margin-top:6px">Qualify</label>
                            </div>
                            <div class="justify-start">
                                <div class="radioContainer">
                                    <input type="radio" name="conclusion" value="Disqualify" id="testDisqualify" class="radioCustomInput">
                                    <label for="testDisqualify" class="radioCustom"></label>
                                </div>
                                <label for="testDisqualify" class="title-16 pointer ml-1" style="margin-top:6px">Disqualify</label>
                            </div>
                        </div>
                    </div>
