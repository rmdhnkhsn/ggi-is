                ...
                <div class="cards" style="padding:34px">
                    <div class="justify-sb">
                        ...
                        <div class="operation flex" style="gap:.8rem">
                            ...
                            <a href="" class="btn-merah deleteAll">Delete All <i class="ml-2 fs-18 fas fa-trash"></i></a>
                        </div>
                    ...
                    <div class="cardBlue" style="padding:34px 28px">
                        <div class="buttons">
                            <a href="" class="btn-simple-edit" data-toggle="modal" data-target="#updateQuest"><i class="fas fa-pencil-alt"></i></a>
                            <a href="" class="btn-simple-delete deleteQuest"><i class="fas fa-trash"></i></a>
                            @include('hr_ga.question.partials.modals')
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <input type="radio" name="quest1" value="A" class="quest-radio" id="1-quest1">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="quest1" value="B" class="quest-radio" id="1-quest2">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="quest1" value="C" class="quest-radio" id="1-quest3">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="quest1" value="D" class="quest-radio" id="1-quest4">
                                <label for="1-quest4" class="containerChoice choice-active">
                                    <div class="choice">D</div>
                                    <div class="subChoice">
                                        <div class="text-truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, earum.</div> 
                                    </div>
                                </label>
                            </div>
                        </div>
