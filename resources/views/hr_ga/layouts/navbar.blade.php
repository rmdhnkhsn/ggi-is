...
<aside class="main-sidebar sidebar-light-primary elevation-4">
  ...
  <div class="navbar-blue">
    <a href="{{url('/home')}}" class="brand-link" style="margin-left:-14px">
      ...
      <span class="brand-text text-white" style="font-size:15px;margin-left:5px;font-weight:600">HR & GA</span>  
    </a>
  </div>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('hrga.index')}}" class="nav-link <?php if($page=='dashboard'){echo 'active';}?>">
          ...
          <li class="nav-item">
            <a href="{{ route('hrga.index_auditbuyer')}}" class="nav-link <?php if($page=='IMaster'){echo 'active';}?>">
              <i class="nav-icon fas fa-luggage-cart"></i>
              <p class="">Audit Buyer</p>
            </a>
          </li>
          @endif
