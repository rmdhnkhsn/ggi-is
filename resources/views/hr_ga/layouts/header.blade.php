...
<head>
  ...
  <link rel="stylesheet" href="{{asset('/assets/css/audit-loading.css')}}">
  <link rel="stylesheet" href="{{asset('/assets/css/menu-bar-audit.css')}}">
  <link rel="stylesheet" href="{{asset('/assets/css/menu-bar-audit2.css')}}">
