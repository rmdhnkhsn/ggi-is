    ...
    <div class="row">
      <div class="col-xl-8">
        <div class="row">
          ...
          <a href="{{route('hrd.map.gc1')}}" class="col-md-6">
          ...
          <a href="{{route('hrd.map.gc2')}}" class="col-md-6">
            <div class="card-map bg-benua p-3 h-220">
              <div class="row">
                <div class="col-12 justify-center mb-1">
          ...
          <a href="{{route('hrd.map.sample')}}" class="col-md-6">
            <div class="card-map bg-benua p-3 h-220">
              <div class="row">
                <div class="col-12 justify-center mb-1">
          ...
          <a href="{{route('hrd.map.marketing')}}" class="col-md-6">
            <div class="card-map bg-benua p-3 h-220">
              <div class="row">
                <div class="col-12 justify-center mb-1">
