...
@section("content")
  <section class="content-header">
      <div class="container-fluid">
        <form action="{{ route('hr_ga.auditbuyer.getsmokepdf')}}" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="col-12">
                  ...
                  <div class="card">
                      <div class="card-body" style="overflow:scroll;">
                          <center>
                            <h3 style="font-weight:bold;font-size:20px;"> ANNUAL REPORT SAFETY COMPLIENCE CONTROLL SMOKE DETECTOR</h3>
