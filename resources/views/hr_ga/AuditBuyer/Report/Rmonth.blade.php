        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ route('hr_ga.auditbuyer.getbln')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        @include('hr_ga.AuditBuyer.Report.partials.form-control-month',['submit' => 'Monthly Report'])
                </form>
