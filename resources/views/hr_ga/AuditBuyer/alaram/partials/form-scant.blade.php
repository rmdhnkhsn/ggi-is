    <div class="row">
        <div class="col-12">
            <div class="judul-scan mt-2">
                SCAN BARCODE ALARM BUTTON
            </div>
        </div>
    </div>
    <form action="{{ route('hr_ga.alaram.controll')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row py-3">
            <div class="col-12">
                ...
                <div class="button-controll">
                    <button type="submit" id="cari_kode_lokasi" class="btn btn-controll">Control<i class="ml-3 far fa-calendar-check"></i></button>
                </div>
            </div>
        </div>
    </form>
