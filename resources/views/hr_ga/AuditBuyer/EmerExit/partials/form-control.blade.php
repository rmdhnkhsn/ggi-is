...
<div class="row">
    <div class="col-12">
        <form action="{{route('hr_ga.emerexit.store')}}" method="post" enctype="multipart/form-data">
         @csrf
            <input type="hidden" class="form-control" id="id_emerexit" name="id_emerexit" value="{{$data->id}}" readonly>
        ...
        <div class="cards w-405 ml-auto mr-auto py-4 px-4">
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <div class="wrapper-radio">
                            <input type="radio" name="ada_exit" value="Ada" class="blue-radio" id="blue-radio-ada" required>
                    ...
                    <div class="col-6">
                        <div class="wrapper-radio"> 
                            <input type="radio" name="ada_exit" value="Tidak" class="red-radio" id="red-radio-tidak" required>
            ...
            <div class="content-apar mb-3">
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <div class="wrapper-radio">
                            <input type="radio" name="kondisi_lampu" value="Menyala" class="blue-radio" id="blue-radio-Menyala" required>
                    ...
                    <div class="col-6">
                        <div class="wrapper-radio"> 
                            <input type="radio" name="kondisi_lampu" value="Mati" class="red-radio" id="red-radio-Mati"required>
                            <label for="red-radio-Mati" class="option option-2">
