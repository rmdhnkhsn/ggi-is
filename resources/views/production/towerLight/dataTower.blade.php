      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title">Monthly Report Signal Tower</h3>
          </div>
          <div class="card-body">
            <form action="{{route ('reporttower.getData')}}" method="post" enctype="multipart/form-data">
                @csrf
                    @include('production.partials.form-bulananData', ['submit' => 'Get'])
            </form>
