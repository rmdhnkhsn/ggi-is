                ...
                <form id="formStorePackingList" method="post" enctype="multipart/form-data">
                    ...
                    <div class="cards-18" style="padding: 30px 35px">
                        ...
                        <div class="row mt-4">
                            ...
                            <!-- Wo Packing  -->
                            <div class="col-md-12 mb-3 d-none" id="woPacking">
                        ...
                        @include('production.finishing.packing_list.partials.list-modal')
                        ...
                        <div class="d-none" id="packing_list">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mt-1 mb-3">
                                        <input type="number" class="form-control border-input-10 quantity_pack" id="quantity_pack" name="qty_satuan" value="0" placeholder="masukkan qty pack...">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                {{-- <div class="col-md-6">
                                    ...
                                    <div class="input-group mt-1 mb-3">
                                        <input type="text" class="form-control border-input-10" id="warehouse" name="warehouse" placeholder="masukkan warehouse...">
                                    </div>
                                </div> --}}
                                <div class="col-md-6">
                                ...
                                {{-- <div class="col-md-6">
                                    ...
                                    <div class="input-group date mt-1 mb-3" id="Date" data-target-input="nearest">
                                        ...
                                        <input type="text" class="form-control datetimepicker-input border-input-10" name="tanggal" data-target="#Date" placeholder="Select Date"/>
                                    </div>
                                </div> --}}
                                <div class="col-md-6">
                                    <span class="title-sm">Tanggal</span>
                                ...
                                {{-- <div class="col-12">
                                <select  class="form-control border-input-10 multipleSelect" multiple="multiple">
                                    <option>two</option>
                                    <option>four</option>
                                    <option>six</option>
                                </select>
                        ...
                        <div class="d-none" id="ekspedisi">
                            <div class="row">
                                ...
                                {{-- <div class="col-md-6">
                                    <span class="title-sm">Tanggal</span>
                                    <div class="input-group date mt-1 mb-3" id="Date2" data-target-input="nearest">
                                        <div class="input-group-append datepiker" data-target="#Date2" data-toggle="datetimepicker">
                                        <div class="custom-calendar" style="height:40px; border-radius:10px 0 0 10px; padding: 0 20px; gap: .7rem !important">
                                            <i class="fas fa-calendar-alt"></i><span class="fs-14">Date</span><i class="fas fa-caret-down"></i>
                                        </div>
                                        </div>
                                        <input type="text" class="form-control datetimepicker-input border-input-10" name="tanggal2" data-target="#Date2" placeholder="Select Date"/>
                                    </div>
                                </div> --}}
                                <div class="col-md-6">
                                    <span class="title-sm">Tanggal</span>
                    ...
                    {{-- <button class="btnAddCarton" id="addSize" type="button" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="Add Carton"><i class="fas fa-plus"></i></button> --}}
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#qty_percent,#wo").keyup(function() {
            ...
            var qty2 = $("#qty2").val();
            var total2 = parseInt(qty_percent) * parseInt(qty2)/100;
