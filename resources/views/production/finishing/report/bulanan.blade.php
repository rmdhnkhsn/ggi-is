          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <h4 style="font-size:18px"><b>DAILY REPORT FINISHING</b></h4>
              </div>
              <div class="card-body">
                <form action="{{route ('report.index')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        @include('production.finishing.report.partials.form-control', ['submit' => 'Get'])
                </form>
              </div>
              <!-- /.card-body -->
            </div>
