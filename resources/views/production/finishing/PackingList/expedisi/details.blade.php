                            ...
                            <div class="col-12">
                                <div class="cards-scroll scrollX" id="scroll-bar-sm">
                                    ...
                                    <table id="DTtable" class="table table-content no-wrap">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sidata = collect($dataExpedisi)->where('packing_to_expedisi', '!=', 'DONE');
                                            ?>
                                            ...
                                            <table id="DTtable3" class="table table-content no-wrap">
                                                ...
                                                <tbody>
                                                    @foreach ($dataIdekspedisi as $key =>$value)
                                                        <?php
                                                            // Tanggal yang diambil adalah tgl approve jika nilai nya null maka yg diambil tanggal input
                                                            $dataNya = collect($value)->first();
                                                            if ($dataNya != null) {
                                                                if ($dataNya->date_to_expedisi == null) {
                                                                    $tanggal = $dataNya->tanggal;
                                                                }else {
                                                                    $tanggal = $dataNya->date_to_expedisi;
                                                                }
                                                            }else {
                                                                $tanggal = null;
                                                            }
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="flex" style="gap:.35rem;margin:-6px 0">
                                                                    <a href="{{route('data-Ekspedisi', $key)}}"  class="btn-merah">Download<i class="ml-2 fas fa-file-pdf"></i></a>
                                                                    <a href="{{ route('finishing.dataEkspedisiExcel',$key) }}" class="btn-green">Download<i class="ml-2 fas fa-file-excel"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
