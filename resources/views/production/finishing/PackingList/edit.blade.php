                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="flex mt-1">
                                            ...
                                            <select class="form-control  border-input-10 select2bs4 " id="action" name="action"  placeholder="masukkan nik..." required style="width:100%">
                                                ...
                                                <option value="PACKING" <?=$dataEdit->action == 'PACKING' ? ' selected="selected"' : '';?>> PERFORMA PACKING LIST </option>
                                                <option value="EXPEDISI" <?=$dataEdit->action == 'EXPEDISI' ? ' selected="selected"' : '';?>> PACKING LIST TO EXPEDISI </option>
                                            </select>
                                        </div>
                                    </div>
