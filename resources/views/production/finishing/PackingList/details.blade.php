                                    ...
                                    <tbody>
                                        ...
                                        @foreach($coba as $key => $value)
                                            <tr>
                                                ...
                                                <td style="color:blue;">{{ abs($value['qty_balance']) }}</td>
                                                @elseif($value['qty_actual'] <  $value['balance_ori'])
                                                <td style="color:orange;">{{ abs($value['qty_balance']) }}</td>
                                                @else
                                                <td>{{ abs($value['qty_balance']) }}</td>
                                                @endif
                                                ...
                                                <td>
                                                    <div class="justify-start">
                                                        @if ($value['balance_ori'] == $value['qty_actual'] &&  $value['qty_actual'] != null )
                                                        ...
                                                        @elseif ($value['balance_ori'] > $value['qty_actual']   &&  $value['qty_actual'] != null)
