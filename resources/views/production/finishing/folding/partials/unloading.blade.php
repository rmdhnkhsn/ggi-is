<form action="{{ route('folding.storeUnloading')}}" method="post" enctype="multipart/form-data">
@csrf
    <div class="row mt-4">
        <div class="col-md-8 mx-auto">
            <div class="cards-18" style="padding: 30px 35px">
                <div class="title-22 text-center">Form Input Data Unloading</div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <div class="input-group mt-1 mb-3">
                            <input type="text" class="form-control border-input-10 livesearch" id="nik2" name="nik2[]" placeholder="masukkan nik..." required>
                        </div>
                    </div>
                    <div class="col-12">
                        <span class="title-sm">Nama</span>
                        <div class="input-group mt-1 mb-3">
                            <input type="text" class="form-control border-input-10" id="nama2" name="nama2[]" placeholder="masukkan nama..." required>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="input-group mt-1 mb-3">
                            ...
                            <select class="form-control  border-input-10 select2bs4 input-data-fa" id="wo" name="wo" placeholder="masukkan wo..." required>
