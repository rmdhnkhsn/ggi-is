                        ...
                        <div class="flexx gap-3 mt-1">
                            <div class="col-md-4">
                                <div class="wrapperRadio mb-3">
                                    <input type="radio" name="status" value="Sale" class="radioBlue" id="sale1" checked>
                                    <label for="sale1" class="optionBlue  check actived">
                            ...
                            <div class="col-md-4">
                                <div class="wrapperRadio mb-3">
                                    <input type="radio" name="status2" value="RentalFinished" class="radioGreen" id="rental1">
                            ...
                            <div class="col-md-4">
                                <div class="wrapperRadio mb-3">
                                    <input type="radio" name="status2" value="TrialFinished" class="radioOrange" id="trial1">
