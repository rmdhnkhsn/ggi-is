                        ...
                        <div class="flexx gap-3 mt-1">
                            <div class="col-md-4">
                                <div class="wrapperRadio mb-3">
                                    <input type="radio" name="status23" value="Sale" class="radioBlue" id="sale1">
                            ...
                            <div class="col-md-4">
                                <div class="wrapperRadio mb-3">
                                    <input type="radio" name="status" value="RentalFinished" class="radioGreen" id="rental1" checked>
                                    <label for="rental1" class="optionGreen check actived">
                            ...
                            <div class="col-md-4">
                                <div class="wrapperRadio mb-3">
                                    <input type="radio" name="status23" value="TrialFinished" class="radioOrange" id="trial1" check>
