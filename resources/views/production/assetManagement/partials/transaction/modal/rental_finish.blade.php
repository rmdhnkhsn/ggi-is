<div class="modal fade" id="rentalFinish" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="wrapperRadio mb-3">
                        <input type="radio" name="category" value="1" class="radioBlue" id="sale3">
                        <label for="sale3" class="optionBlue check">
                ...
                <div class="col-md-4">
                    <div class="wrapperRadio mb-3">
                        <input type="radio" name="category" value="1" class="radioGreen" id="rental3">
                        <label for="rental3" class="optionGreen check">
                ...
                <div class="col-md-4">
                    <div class="wrapperRadio mb-3">
                        <input type="radio" name="category" value="0" class="radioOrange" id="trial3">
                        <label for="trial3" class="optionOrange check">
                ...
                <div class="col-12 justify-sb mb-3">
                    ...
                    <button id="addRowRental" type="button" class="btn-blue-md">Add<i class="fs-18 ml-2 fas fa-plus"></i> </button>
                </div>
                <div class="noItem" id="noItem2">
                    <img src="{{url('images/iconpack/asset_management/no-item.svg')}}">
                </div>
            </div>
            <div id="newRowRental"></div>
            <div class="row mt-3">
                <div class="col-md-6">
