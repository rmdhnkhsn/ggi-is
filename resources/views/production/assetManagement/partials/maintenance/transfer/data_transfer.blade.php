        ...
        <div class="cards px-4 pt-4">
          ...
          <ul class="nav nav-tabs blue-md-tabs2 mt-5" id="myTab" role="tablist">
            <li class="nav-item-show">
              <a href="{{ route('asset.maintenance.dataTransfer')}}" class="nav-link active"></i>Transfer</a>
          ...
          <div class="cards p-4">
              <div class="row">
                  <div class="col-12 justify-sb2">
                      <div class="title-20 text-left">Data Transfer</div>
                          ...
                          <div class="input-group"  id="filter_date">
                              <div class="input-group date" id="report_date" data-target-input="nearest">
                                  <div class="input-group-append datepiker" data-target="#report_date" data-toggle="datetimepicker">
                                   ...
                                   <input  id="sesat" type="text" class="form-control datetimepicker-input borderInput input-date-fa"
                              ...
                              <tbody>
                                 @foreach ($data as $key =>$value)
                                  <tr>
                                      ...
                                      @include('production.assetManagement.partials.maintenance.transfer.modal.edit')
                                  </tr>
                                @endforeach
                              </tbody>
                          </table>
  ...
  jQuery(document).ready(function($) {
    ...
    $("#report_date").on("change.datetimepicker", ({date}) => {
          if (filter_count > 0) {
            ...
            location.replace("{{ url('prd/maintenance/data-transfer/-') }}"+month)
          }
          filter_count++
    })
    var month = $("#month").val();
