            ...
            <div class="contents mx-auto mt-mins">
                <div class="headerContent gap-3 mb-4">
                    ...
                    <div class="judul truncate">
                        ...
                        <div class="title-24W mt-1 truncate">Ramadhon Ikhsan Prasetya</div>
                    </div>
                </div>
                <div class="card p-3">
                    <div class="buttons">
                        <div class="btn1 w-100">
                            <a href="" class="btn-blue justify-start h-64"><i class="iconBtn fas fa-random"></i><div class="title-none">Transfer</div></a> 
                            <div class="titleBtn">Transfer</div>
                        </div>
                        <div class="btn2 w-100">
                            <a href="" class="btn-yellow justify-start h-64"><i class="iconBtn fas fa-tasks"></i><div class="title-none">Checking</div></a>
                            <div class="titleBtn">Checking</div>
                        </div>
                        <div class="btn3 w-100">
                            <a href="" class="btn-green justify-start h-64"><i class="iconBtn fas fa-toolbox"></i><div class="title-none">Maintenance</div></a>
                            <div class="titleBtn">Maintenance</div>
                        </div>
                        <div class="btn4 w-100">
                            <a href="" class="btn-blue2 justify-start h-64"><i class="iconBtn fas fa-cogs"></i><div class="title-none">Setting</div></a>
