    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="contents mx-auto mt-mins">
                <div class="title-30W text-center mb-4">Checking Assets</div>
                <div class="card p-3">
                    <div class="title-20G">Check Information</div>
                        ...
                        <div class="containers">
                            ...
                            <div class="widthHalf">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control borderInput" name="" id="" placeholder="Input Jenis Mesin">
                                </div>
                                {{-- <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="inputGroupBlue" style="width:45px"><i class="fs-20 fas fa-toolbox"></i></span>
                            ...
                            <div class="widthHalf">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control borderInput" name="" id="" placeholder="Input from location">
                                </div>
                                {{-- <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="inputGroupBlue" style="width:45px"><i class="fs-20 fas fa-building"></i></span>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control borderInput pointer" id="" name="" required>
                                        ...
                                        @foreach ($data as $key => $value)
                                            <option name="CLN" value="{{$value['branch_code']}}">{{ $value['branch_code'] }}</option>    
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="col-12 mt-3">
                        <button type="button" class="btn-blue-md btn-block success">Add Asset Item</button>
...
<script>
  $("#addAssets").click(function () {
    var html = '';
        ...
        html +='<div class="title-sm">Asset No.</div> <div class="badgeSoftBlue">01</div>';
        html +='</div>';
        ...
        html +='</div>';
        html +='<input type="text" class="form-control borderInput2" name="" id="" placeholder="Input serial number">';
        html +='<div class="input-group-prepend">';
        html +='<button type="button" class="inputGroupBlueRight pointer" id="openCam" data-toggle="modal" data-target="#camera" style="width:45px"><i class="fs-20 fas fa-camera"></i></button>';
        html +='</div>';
        html +='</div>';
        html +='</div>';
        html +='<div class="widthHalf">';
        ...
        html +='<option selected disabled>Select Assets</option>';
        html +='<option name="Assets 1">Assets 1</option>   ';
        html +='<option name="Assets 2">Assets 2</option>    ';
        html +='</select>';
        html +='</div>';
        html +='</div>';
        html +='<div class="widthHalf">';
        ...
        html +='</div>';
        html +='<input type="text" class="form-control borderInput" name="" id="" placeholder="Input qty">';
        html +='</div>';
        html +='</div>';
        html +='<div class="widthHalf">';
        html +='<div class="input-group">';
        ...
        html +='</div>';
        html +='<select class="form-control borderInput select2bs4 pointer" id="" name="" required>';
        html +='<option selected disabled>From Location</option>';
        html +='<option name="CLN">CLN</option>   ';
        html +='<option name="MAJA">MAJA</option>   ';
        html +='<option name="MAJA 2">MAJA 2</option>   ';
        html +='</select>';
        html +='</div>';
        html +='</div>';
        html +='<div class="widthFull">';
        html +='<div class="input-group">';
        html +='<div class="input-group-prepend">';
        html +='<span class="inputGroupBlue" style="width:45px"><i class="fs-20 far fa-building"></i></span>';
        html +='</div>';
        html +='<select class="form-control borderInput select2bs4 pointer" id="" name="" required>';
        html +='<option selected disabled>To Location</option>';
        html +='<option name="CLN">CLN</option>';
        html +='<option name="MAJA">MAJA</option>';
        html +='<option name="MAJA 2">MAJA 2</option>';
        html +='</select>';
