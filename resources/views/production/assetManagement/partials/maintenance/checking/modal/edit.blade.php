<div class="modal fade" id="edit{{$value['id']}}" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:720px">
        <div class="modal-content p-4" style="border-radius:10px">
            <form  action="{{route('asset.maintenance.editCheckingAssets')}}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group mt-1 mb-3">
                            ...
                            <select class="form-control borderInput pointer select2bs4" id="" name="kondisi" required>
                            <option selected disabled>{{$value['kondisi']}}</option>
                            <option name="Proses Perbaikan">Proses Perbaikan</option>
                            <option name="Rusak Berat">Rusak Berat</option>
                            <option name="Siap Pakai">Siap Pakai</option>
                            </select>
                        </div>
                    </div>
