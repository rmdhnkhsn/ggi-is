...
@section("title","Maintenance Assets")
@push("styles")
...
<section class="content index">
    <div class="container-fluid">
        ...
        <form  action="{{route('asset.maintenance.updateMaintenanceAssets')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="contents mx-auto mt-mins">
                    <div class="title-30W judul2">Maintenance Asset</div>
                    <div class="card p-3">
                        <div class="title-20G">Maintenance Information</div>
                        ...
                        <div class="containers">
                            <div class="widthHalf">
                                ...
                                <div class="input-group mt-1 mb-3">
                                    ...
                                    <input type="text" class="form-control borderInput" name="created_by" id="" value="{{ auth()->user()->nama }}" style="border-radius:0 10px 10px 0" readonly>
                            ...
                            <div class="widthHalf">
                                ...
                                <div class="input-group mt-1 mb-3">
                                    ...
                                    <input type="text" class="form-control borderInput" name="status" id="" value="Maintenance" readonly>
                                </div>
                            </div>
                            <div class="widthHalf">
                            ...
                            <div class="widthHalf">
                                ...
                                <div class="input-group mt-1 mb-3">
                                    ...
                                    <select class="form-control borderInput pointer" id="" name="maintenance" required>
                                        <option selected disabled>Select Maintenance</option>
