      ...
      <div class="col-12">
        <div class="cards px-4 pt-4">
          ...
          <ul class="nav nav-tabs blue-md-tabs2 mt-5" id="myTab" role="tablist">
            ...
            <li class="nav-item-show">
              <a href="{{ route('asset.maintenance.dataMaintenance')}}" class="nav-link active"></i>Maintenance</a>
              <div class="blue-slide2"></div>
            </li>
            <li class="nav-item-show">
          ...
          <div class="cards p-4">
              <div class="row">
                  <div class="col-12 justify-sb2">
                      <div class="title-20 text-left">Data Maintenance</div>
                              ...
                              <tbody>
                                @foreach ($data as $key =>$value)
                                  <tr>
                                    ...
                                    @include('production.assetManagement.partials.maintenance.maintenance.modal.edit')
                                @endforeach
                              </tbody>
                          </table>
                      </div>
  ...
  jQuery(document).ready(function($) {
    ...
    $("#report_date").on("change.datetimepicker", ({date}) => {
          if (filter_count > 0) {
            ...
            location.replace("{{ url('prd/maintenance/data-setting/-') }}"+month)
          }
          filter_count++
    })
    var month = $("#month").val();
