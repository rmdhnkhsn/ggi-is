<div class="modal fade" id="edit{{ $value->id }}" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:720px">
        <div class="modal-content p-4" style="border-radius:10px">
            <form  action="{{route('asset.maintenance.editSettingAssets')}}" method="post" enctype="multipart/form-data">
            @csrf
                <input type="hidden" id="id" name="id" value="{{$value['id']}}">
                <input type="hidden" id="id_machine" name="id_machine" value="{{$value['id_machine']}}">
                <div class="row">
                    <div class="col-12 justify-sb">
                        <div class="title-18">Edit Data Setting</div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group mt-1 mb-3">
                            ...
                            <select class="form-control borderInput pointer" id="" name="setting" required>
                                <option selected disabled>{{ $value->setting }}</option>
