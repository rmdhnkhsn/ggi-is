      ...
      <div class="col-12">
        <div class="cards px-4 pt-4">
          ...
          <ul class="nav nav-tabs blue-md-tabs2 mt-5" id="myTab" role="tablist">
            ...
            <li class="nav-item-show">
              <a href="{{ route('asset.maintenance.dataSetting')}}" class="nav-link active"></i>Setting</a>
              <div class="blue-slide2"></div>
            </li>
            <li class="nav-item-show">
        ...
        <div class="cards p-4">
          <div class="row">
              <div class="col-12 justify-sb2">
                  <div class="title-20 text-left">Data Setting</div>
                          ...
                          <tbody>
                            @foreach ($data as $key =>$value)
                                  <tr>
                                      ...
                                      @include('production.assetManagement.partials.maintenance.setting.modal.edit')
                                  </tr>
                                @endforeach
                          </tbody>
                      </table>
