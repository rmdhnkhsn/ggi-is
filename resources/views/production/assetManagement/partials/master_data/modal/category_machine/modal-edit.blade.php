<div class="modal fade" id="editData{{ $value['id'] }}" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:650px">
        <div class="modal-content p-4" style="border-radius:10px">
            <form  action="{{route('asset.master.updateAssetMachineCategory',$value['id'])}}" method="post" enctype="multipart/form-data">
                @csrf 
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="jenis" value="{{ $value['jenis'] }}" placeholder="Input Category">
                    </div>
                    <div class="col-12">
