<form  action="{{route('asset.master.storeAssetMachineCategory')}}" method="post" enctype="multipart/form-data">
   @csrf 
                ...
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="jenis" placeholder="Input Category">
                        </div>
                        <div class="col-12">
