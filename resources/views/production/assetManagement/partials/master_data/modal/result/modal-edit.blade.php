        ...
        <div class="modal-content p-4" style="border-radius:10px">
            <form action="">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="title-sm">Result</div>
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="" placeholder="Input Result">
                    </div>
                    <div class="col-12 mt-3">
                        <button type="button" class="btn-blue-md btn-block success">Update</button>
                    </div>
                </div>
            </form>
        </div>
