        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:650px">
            <div class="modal-content p-4" style="border-radius:10px">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="title-sm">Branch Code</div>
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="branch_code" placeholder="Input Code">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="name" placeholder="Input Name">
                    </div>
                    <div class="col-12">
