<div class="modal fade" id="editData{{ $value['id'] }}" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:650px">
        <div class="modal-content p-4" style="border-radius:10px">
            <form  action="{{route('asset.master.updateAssetUserAkses')}}" method="post" enctype="multipart/form-data">
            @csrf     
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select class="form-control borderInput pointer select2bs4" name="company" id="">
                            ...
                            <option value='' selected >{{ $value['company']}}</option>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select class="form-control borderInput pointer select2bs4" name="branch" id="">
                            ...
                            @endif
                             @foreach ($dataAssetBranch as $key4 =>$value4)
                              <option {{ $value['branch'] == $value4['branch_code'] ? 'selected' : ''}} value="{{ $value4['branch_code']}}">{{ $value4['branch_code'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12 mb-3">
                            ...
                            <select class="form-control borderInput pointer select2bs4" name="nik" id="nik">
                                <option value="" selected>{{ $value['nik'] }}</option>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control borderInput mt-1 mb-3" id="nama" name="fullname" value="{{ $value['fullname'] }}" placeholder="Input Company">
                        </div>
                        <div class="col-12 mb-3">
                    ...
                    {{-- <div class="col-12">
                        ...
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="username" value="{{ $value['username'] }}" placeholder="Input User Name">
                    </div>
                    <div class="col-12">
                        <div class="title-sm">Full Name</div>
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="fullname" value="{{ $value['fullname'] }}" placeholder="Input Full Name">
                    </div> --}}
                    {{-- <div class="col-12">
                        <div class="title-sm">User Role</div>
                        <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="role" value="{{ $value['role'] }}" placeholder="Input User Role">
                    </div> --}}
                    <div class="col-12">
