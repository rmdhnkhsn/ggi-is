<form  action="{{route('asset.master.storeAssetCompany')}}" method="post" enctype="multipart/form-data">
@csrf 
                ...
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control borderInput mt-1 mb-3" id="" name="Code" placeholder="Input Code">
                        </div>
                        <div class="col-12">
