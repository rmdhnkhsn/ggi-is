        ...
        <div class="row pb-5">
            <div class="col-12">
                <div class="cards bg-card p-4">
                    <div class="row">
                         {{-- <form  action="{{route('asset.master.storeAssetBranch')}}" method="post" enctype="multipart/form-data">
                            @csrf --}}
                            <div class="col-12">
                                <div class="joblist-date">
                                    <div class="title-22">Master Company</div>
                                    <div class="approval-flex">
                                        <div class="flex gap-2">
                                            ...
                                            @include('production.assetManagement.partials.master_data.modal.company.modal-add')
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="container-tbl-btn flex gap-2">
                                                        ...
                                                        <a href="{{route ('asset.master.deleteAssetCompany',$value['ID'])}}" class="btn-icon-pink deleteFile"><i class="fs-18 fas fa-trash-alt"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @include('production.assetManagement.partials.master_data.modal.company.modal-edit')
                                        @endforeach
                                    </tbody>
                                </table>
                            </div>
