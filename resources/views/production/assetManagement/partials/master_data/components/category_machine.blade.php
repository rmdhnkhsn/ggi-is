@extends("layouts.app")
@section("title","Category Machine")
@push("styles")
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="joblist-date">
                                <div class="title-22">Machine Type</div>
                                <div class="approval-flex">
                                    <div class="flex gap-2">
                                        ...
                                        @include('production.assetManagement.partials.master_data.modal.category_machine.modal-add')
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="container-tbl-btn flex gap-2">
                                                    ...
                                                    <a href="{{route ('asset.master.deleteAssetMachineCategory', $value['id'])}}" class="btn-icon-pink deleteFile"><i class="fs-18 fas fa-trash-alt"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @include('production.assetManagement.partials.master_data.modal.category_machine.modal-edit')
                                        @endforeach
                                    </tbody>
                                </table>
                            </div>
