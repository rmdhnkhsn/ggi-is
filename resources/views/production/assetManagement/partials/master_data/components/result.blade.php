                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="joblist-date">
                                <div class="title-22">Result List</div>
                                <div class="approval-flex">
                                    <div class="flex gap-2">
                                        ...
                                        @include('production.assetManagement.partials.master_data.modal.result.modal-add')
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cards-scroll scrollX" id="scroll-bar">
                                ...
                                <table id="DTtable" class="table tbl-content">
                                    ...
                                    <tbody>
                                        ...
                                        @include('production.assetManagement.partials.master_data.modal.result.modal-edit')
                                    </tbody>
                                </table>
                            </div>
                        </div>
