                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="joblist-date">
                                <div class="title-22">User Access</div>
                                <div class="approval-flex">
                                    <div class="flex gap-2">
                                        ...
                                        @include('production.assetManagement.partials.master_data.modal.users.modal-add')
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="container-tbl-btn flex gap-2">
                                                    ...
                                                    <a href="{{route ('asset.master.deleteAssetUserAkses', $value['id'])}}" class="btn-icon-pink deleteFile"><i class="fs-18 fas fa-trash-alt"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @include('production.assetManagement.partials.master_data.modal.users.modal-edit')
                                        @endforeach
...
console.log(ID);
    if(ID){
        ...
        url: '{{ route("asset.master.getuser") }}',           
        type: "post",
        dataType: 'json',
