        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-1 mb-3">
                    <a href="{{ route('qrcode.index')}}" class="btn btn-block btn-secondary btn-sm" style="box-shadow: 3px 3px 3px rgba(0,0,0,0.2);">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add Data Sample</h3>
                        </div>
                        <div class="card-body">
                        <form action="{{ route('update', $data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf 
                            @include('production.qrcode.partials.form-edit-data',['submit' => 'Update'])
                        </form>  
                        <div class="row">
                            <div class="col-3"> 
                            </div>
