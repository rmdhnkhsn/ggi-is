@if($row['smv'] === null)
    @if (auth()->user()->nik == '330022' || auth()->user()->role == 'SYS_ADMIN')
        <button type="button" class="btn btn-upload1 btn-sm container-issue" data-toggle="modal" data-target="#modalPDFSMV-{{$row->id}}" title="Upload SMV">
                    ...
                    <div class="row">
                        ...
                        <div class="input-file-container">
                            ...
                            <div class="custom-file mb-2" style="box-sizing:border-box;">
                                <input type="file" accept=".pdf" class="custom-file-input" id="smv" name="smv" value="{{$row->smv}}">
        ...
        @else
         <button type="button" class="btn btn-upload1 btn-sm container-issue" data-toggle="modal" data-target="#modalPDFSMV-{{$row->id}}" title="Upload SMV" disabeled>
            <i class="fas fa-upload"></i>
        </button>
    @endif
    @else
        ...
        <button type="button" class="btn btn-upload2 btn-sm container-issue" data-toggle="modal" data-target="#modalsama-{{$row->id}}" title="Edit SMV">
