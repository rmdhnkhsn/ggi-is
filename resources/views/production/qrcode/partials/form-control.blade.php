...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="field">
            <input type="text" id="style" name="style" autocomplete="off" placeholder="Input Style . . ." required>
    ...
    <div class="col-lg-6">
        ...
        <div class="field">
            <input type="text" id="buyer" name="buyer" autocomplete="off" placeholder="Input Buyer . . ." required>
...
<div class="row mb-4">
    @if (auth()->user()->role == 'MD_USER' || auth()->user()->role == 'MD_MANAGER' || auth()->user()->role == 'SYS_ADMIN')
        <div class="col-lg-2 ml-auto">	
            ...
            <p class="file-return-techspech"></p>
        </div>
    @else
        <div class="col-lg-2 ml-auto">	
            <h5 class="nama">Techpack</h5>
    ...
    @if (auth()->user()->role == 'MD_USER' || auth()->user()->role == 'MD_MANAGER' || auth()->user()->role == 'SYS_ADMIN')
        <div class="col-lg-2">	
            ...
            <p class="file-return-trimcard"></p>
        </div>
   @else
        <div class="col-lg-2">	
            <h5 class="nama">TRIMCARD</h5>
