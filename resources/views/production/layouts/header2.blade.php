...
<head>
  ...
  <link rel="stylesheet" href="{{asset('/assets3/plugins/datatables-responsive/css/jquery.dataTables.min.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('/assets/css/style-form.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/css/poppins.css') }}">
