<div class="modal fade" id="detailDataProses2{{ $data2['id'] }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="containerDetailsSMV">
                        ...
                        <div class="sub-judul">{{round($data2['targetSmv'],2) }}</div>
                    </div>
                    <div class="containerDetailsSMV">
