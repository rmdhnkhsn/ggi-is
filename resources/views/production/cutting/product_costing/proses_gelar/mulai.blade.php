      ...
      <div class="row pb-5">
        ...
        <div class="col-md-6">
          <div class="cards margin-auto w-405 h-395 p-4">
            <form action="{{ route('gelar.simpan_user')}}" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="col-12 justify-center">
                <button type="submit" class="btn-blue mt-2 w-180">Mulai Gelar<i class="ml-2 fs-20 fas fa-arrow-right"></i></button>
              </div>
            </form>
          </div>
        </div>
