              ...
              <table id="example1" class="table hrd-tbl-content no-wrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Rp. {{number_format($value['prem_krj'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['tun_tetap'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['thp'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['gp_tun'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['bpjamsostek'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['bpjs_ks'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['uang_makan'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['gaji_per_hari'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['gaji_per_jam'], 2, ",", ".")}}</td>
                    <td>Rp. {{number_format($value['gaji_per_jam_lembur'], 2, ",", ".")}}</td>
