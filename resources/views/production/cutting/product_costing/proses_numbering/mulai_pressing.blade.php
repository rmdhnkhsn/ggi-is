    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-12 justify-center">
            <span class="ctg-ppic-title">Proses Pressing</span>
          </div>
        </div>
    </div>
</div>
      ...
      <div class="row pb-5">
        ...
        <div class="col-md-6">
          <div class="cards margin-auto w-405 h-395 p-4">
            <form action="{{ route('proses_pressing.simpan_user')}}" method="post" enctype="multipart/form-data">
              @csrf
