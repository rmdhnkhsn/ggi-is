@extends("layouts.app")
@section("title","Form Dalam Proses")
@push("styles")
        ...
        <div class="cards-part">
          <div class="cards-head">
            <div class="justify-sb3">
              <div class="title-24-blue no-wrap mt-1">Form Dalam Proses<span class="notif-message">(Assortmaker, action belum)</span></div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          ...
                          @include('production.cutting.product_costing.AdminCutting.components.FormProses.form')
                        </td>
                        <?php
                        ...
                        <td>
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ route('edit.proses')}}" class="dropdown-item"><i class="mr-2 fs-18 fas fa-pencil-alt"></i>Edit Detail</a>
                            <a href="{{ route('print.proses')}}" class="dropdown-item"><i class="mr-2 fs-18 fas fa-print"></i>Print Sisa Kain</a>
                            <a href="{{ route('detail.proses')}}" class="dropdown-item"><i class="mr-2 fs-18 fas fa-search"></i>Detail</a>
