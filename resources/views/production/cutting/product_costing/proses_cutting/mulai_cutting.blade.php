    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-12 justify-center">
            <span class="ctg-ppic-title">Proses Cutting</span>
          </div>
        </div>
    </div>
</div>
<section class="content">
    <div class="container-fluid">
      <div class="row pb-5">
        ...
        <div class="col-md-6">
          <div class="cards margin-auto w-405 h-395 p-4">
            <form action="{{ route('proses_cutting.simpan_user')}}" method="post" enctype="multipart/form-data">
              @csrf
              <input type="hidden" name="form_id" id="form_id" value="{{$form->id}}">
              <div class="card-transparent h-285 scrollY">
                <div class="col-12">
                ...
                <div class="col-12">
                  <span class="title-sm">NIK 3</span>
                  <div class="input-group mb-2">
                      <input type="text" class="form-control border-input" id="nik[]" name="nik[]" placeholder="Input NIK...">
                  </div>
                </div>
                <div class="col-12">
                  <span class="title-sm">NIK 4</span>
                  <div class="input-group mb-2">
                      <input type="text" class="form-control border-input" id="nik[]" name="nik[]" placeholder="Input NIK...">
                  </div>
                </div>
                <div class="col-12">
                  <span class="title-sm">NIK 5</span>
                  <div class="input-group mb-2">
                      <input type="text" class="form-control border-input" id="nik[]" name="nik[]" placeholder="Input NIK...">
                  </div>
                </div>
              ...
              <div class="col-12 justify-center">
                <button type="submit" class="btn-blue mt-2">Mulai Cutting<i class="ml-2 mt-1 fs-20 fas fa-arrow-right"></i></button>
              </div>
            </form>
          </div>
        </div>
