            ...
            <div class="col-12">
                <form action="{{ route('indah.Mdetail')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group date" id="reservationdate4" data-target-input="nearest" style="box-shadow: 1px 1px 5px rgba(0,0,0,0.2);">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate4" name="tanggal" placeholder="Pilih Tanggal" value="{{$tanggal}}" required/>
                    ...
                    <button type="submit" class="btn btn-info btn-block" style="box-shadow: 2px 2px 5px rgba(0,0,0,0.3);">Weekly Report</button>
                </div>
                </form>
            </div>
        </div> 
