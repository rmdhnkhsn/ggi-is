        ...
        <div class="row mb-4">
            <div class="col-12">
                <form action="{{ route('indah.Tdetail')}}" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-info btn-block" style="box-shadow: 2px 2px 5px rgba(0,0,0,0.3);">Yearly Report</button>
                </div>
                </form>
            </div>
        </div> 
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Annual Report | <th>{{$tahun}}</th></h3>
                  <br>
