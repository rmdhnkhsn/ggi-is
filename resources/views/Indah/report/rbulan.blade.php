            ...
            <div class="col-12">
                <form action="{{ route('indah.Bdetail')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group date" id="reservationdate1" data-target-input="nearest" style="box-shadow: 1px 1px 5px rgba(0,0,0,0.2);">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" name="bulan" placeholder="Pilih bulan" value="{{$bulan}}" required />
                    ...
                    <button type="submit" class="btn btn-info btn-block" style="box-shadow: 2px 2px 5px rgba(0,0,0,0.3);">Monthly Report</button>
                  </div>
                </form>
            </div>
          ...
          <div class="col-12">
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Monthly Report | <th>{{$kodeBulan}} {{$th}}</th></h3>
                  <br>
