              ...
              <div class="card-body">
                ...
                <?php $no++;?>
                    <tr>
                        ...
                        @if($value['status_indah'] == '1')
                        <td>
                          <a href="{{route('idivisi.edit', $value['id'])}}" class="btn btn-danger btn-sm" >
                            <i class="fas fa-edit">Response</i></a>
                          </a>
                        </td>
                        @endif
                        @if($value['status_indah'] == '2')
                        <td>
                          <a href="{{route('idivisi.editp', $value['id'])}}" class="btn btn-warning btn-sm" >
                        ...
                        <td>
                          <a href="{{route('idivisi.edit', $value['id'])}}" class="btn btn-success btn-sm" >
                            <i></i>Detail</a>
                          </a>
                        </td>
                        @endif
