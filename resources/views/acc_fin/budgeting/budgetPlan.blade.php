                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                      ...
                      <input type="date" class="form-control borderInput" name="tanggal[]" value="" required>
                    </div>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                      ...
                      <select class="form-control borderInput pointer ListBranch"id="" name="branch[]" required>
                        <option value="" selected></option>  
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                      ...
                      <select class="form-control borderInput pointer ListBuyer" id="" name="buyer[]" required>
                        <option value="" selected></option>  
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                    ...
                    <input type="text" class="form-control borderInput mt-1 mb-3"name="explanation[]" value="" placeholder="Explanation">
                  </div>
                  <div class="col-md-3">
                    <div class="title-sm">Plan Budget</div>
                    <input type="number" step="0.01" class="form-control borderInput mt-1 mb-3"name="plan_budget[]" value="" placeholder="Input Plan Budget" required>
                  </div>
                  <div class="col-md-3">
                  <div class="title-sm">Kurs</div>
                    <div class="input-group flex mt-1 mb-3">
                      ...
                      <input type="number" step="0.01" class="form-control borderInput" name="kurs[]"  aria-label="Text input with dropdown button" required>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
  ...
  $("#addRow").click(function () {
    var html = '';
        ...
        html +=`<span class="inputGroupBlue" style="width:50px"><i class="fs-20 fas fa-calendar-alt"></i></span>`;
        html +=`</div>`;
        html +=`<input type="date" class="form-control borderInput" name="tanggal[]" value="" required>`;
        html +=`</div>`;
        html +=`</div>`;
        html +=`<div class="col-md-3">`;
        html +=`<div class="title-sm">No Account</div>`;
        ...
        html +=`</div>`;
        html +=`<div class="col-md-3">`;
        html +=`<div class="title-sm">Branch</div>`;
        html +=`<div class="input-group flex mt-1 mb-3">`;
        html +=`<div class="input-group-prepend">`;
        html +=`<span class="inputGroupBlue" style="width:50px"><i class="fs-20 fas fa-stream"></i></span>`;
        html +=`</div>`;
        html +=`<select class="form-control borderInput pointer ListBranch"id="" name="branch[]" required>`;
        html +=`<option value="" selected></option>`;
        html +=`</select>`;
        html +=`</div>`;
        html +=`</div>`;
        ...
        html +=`<span class="inputGroupBlue" style="width:50px"><i class="fs-20 fas fa-stream"></i></span>`;
        html +=`</div>`;
        html +=`<select class="form-control borderInput pointer ListBuyer" id="" name="buyer[]" required >`;
        html +=`<option value="" selected></option>`;
        html +=`</select>`;
        html +=`</div>`;
        html +=`</div>`;
        html +=`<div class="col-md-3">`;
        html +=`<div class="title-sm">Explanation</div>`;
        html +=`<input type="text" class="form-control borderInput mt-1 mb-3"name="explanation[]" value="" placeholder="Explanation">`;
        html +=`</div>`;
        html +=`<div class="col-md-3">`;
        html +=`<div class="title-sm">Plan Budget</div>`;
        html +=`<input type="number" step="0.01" class="form-control borderInput mt-1 mb-3"name="plan_budget[]" value="" placeholder="Input Plan Budget" required> `;
        html +=`</div>`;
        html +=`<div class="col-md-3">`;
        html +=`<div class="title-sm">Kurs</div>`;
        html +=`<div class="input-group flex mt-1 mb-3">`;
        html +=`<div class="input-group-prepend">`;
        html +=`<select class="form-control pointer" id="" name="type[]" style="border-radius:10px 0 0 10px">`;
        html +=`<option selected value="USD" >USD</option>`;
        html +=`<option value="IDR" >IDR</option> `;
        html +=`</select>`;
        html +=`</div>`;
        html +=`<input type="number" step="0.01" class="form-control borderInput" name="kurs[]"  aria-label="Text input with dropdown button" required>`;
        html +=`</div>`;
        html +=`</div>`;
        html +=`</div>`;
        html +='<button id="removeRow" type="button" class="removeRow"><i class="fas fa-times"></i></button>'; 
...
<script>
  ...
  function ListBranch() {
    $('.ListBranch').select2({
        ...
        searchInputPlaceholder: 'search',
        data:<?php echo json_encode($list_Branch); ?>
      });
  }
  function ListBuyer() {
    $('.ListBuyer').select2({
      ...
      searchInputPlaceholder: 'search',
      data:<?php echo json_encode($list_buyer); ?>
    });
  }
