...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                @include('ppic.issue_mr.partials.modal_filter_issue')
                <div class="cards p-4">
                            ...
                            <div class="row">
                                <div class="col-12 justify-sb2 mb-3">
                                    ...
                                    <div class="flexx gap-3">
                                        ...
                                        <button type="button" class="btn-blue-md" data-toggle="modal" data-target="#IssueDirectSearch">Filter</button>
                                        <div class="flex gap-2">
  ...
  jQuery(document).ready(function($) {
    ...
    $("#report_date").on("change.datetimepicker", ({date}) => {
        ...
        if (filter_count >= 0) {
            ...
            // console.log( month);
            var url = "{{ route('ppic.issue_mr.report',[':id']) }}";
