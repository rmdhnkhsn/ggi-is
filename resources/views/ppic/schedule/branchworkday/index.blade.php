        ...
        <div class="cards p-4">
          <div class="row">
            <div class="col-12 justify-sb2">
              <div class="title-20-grey">Data Branch Workday</div>
              <div class="filterSMV">
                @if(Auth::user()->role=='SYS_ADMIN'||Auth::user()->role=='PPIC_PLANNER')
                  <a href="{{route('ppic.schedule.workday.create')}}" type="button" class="btn-blue-md">Add Workday <i class="fs-18 ml-2 fas fa-plus"></i></a>
                @endif
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="container-tbl-btn">
                          <a href="{{route('ppic.schedule.workday.edit',['id'=>$d->id])}}" class="btn-icon-yellow" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Edit"><i class="fs-18 fas fa-pencil-alt"></i></a>
                        </div>
                        @endif
                      </td>
                    </tr>
