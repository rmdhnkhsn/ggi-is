            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                        ...
                        <select class="form-control borderInput select2Line pointer" id="branch_id" name="branch_id" required>
                ...
                <div class="col-12">
                    <div class="title-sm">WO Start From</div>
                    <div class="input-group flex mt-1 mb-3">
                        <div class="input-group-prepend">
                            <span class="inputGroupBlue" style="width:50px"><i class="fs-20 fas fa-calendar-alt"></i></span>
                        </div>
                        <input type="date" class="form-control borderInput" id="start_date_from" name="start_date_from" value="{{Request::get('start_date_from')}}" placeholder="From Date">
                    </div>
                </div>
                <div class="col-12">
                    <div class="title-sm">WO Start To</div>
                    <div class="input-group flex mt-1 mb-3">
                        <div class="input-group-prepend">
                            <span class="inputGroupBlue" style="width:50px"><i class="fs-20 fas fa-calendar-alt"></i></span>
                        </div>
                        <input type="date" class="form-control borderInput" id="start_date_to" name="start_date_to" value="{{Request::get('start_date_to')}}" placeholder="To Date">
                    </div>
                </div>
