<div class="row">
    ...
    <div class="col-md-3">
        <div class="title-sm">Target/Day</div><span class="badge badge-info font-weight-light ml-1" id="labelsmv" ></span>
    ...
    <div class="col-12">
        ...
        <div class="input-group flex mt-1 mb-3">
            ...
            <select class="form-control borderInput select2bs4 pointer" name="cutting_factory_id" id="cutting_factory_id">
    ...
    <div class="col-md-6">
        ...
        <div class="input-group flex mt-1 mb-3">
            ...
            <select class="form-control borderInput select2bs4 pointer " name="plot_setting" id="plot_setting">
    ...
    <div class="col-md-6">
        ...
        <div class="input-group flex mt-1 mb-3">
            ...
            <select class="form-control borderInput select2bs4 pointer " name="production_line_id" id="production_line_id">
    ...
    <div class="col-md-6">
        ...
        <div class="input-group flex mt-1 mb-3">
            ...
            <select class="form-control borderInput select2bs4 pointer " name="prod_wo" id="prod_wo">
            <!-- @foreach ($master_line as $d)
    ...
    <div class="col-md-6">
        <div class="title-sm">Estimate Finish</div>
        <div class="input-group flex mt-1 mb-3">
            <div class="input-group-prepend">
    ...
    <div class="col-12">
        <div class="input-group date mb-3">
            <div class="input-group-append">
                <div class="inputGroupBlue" style="width: 142px"><i class="fs-20 mr-2 fas fa-calendar-alt"></i>Fabric ETA</div> 
            </div>
    ...
    <div class="col-md-6">
        <div class="input-group date mb-3">
            <div class="input-group-append">
                <div class="inputGroupBlue" style="width: 142px"><i class="fs-20 mr-2 fas fa-calendar-alt"></i>Cut Date</div> 
            </div>
    ...
    <div class="col-md-6">
        <div class="input-group date mb-3">
            <div class="input-group-append">
                <div class="inputGroupBlue" style="width: 142px"><i class="fs-20 mr-2 fas fa-calendar-alt"></i>Ship Date</div> 
            </div>
    ...
    <div class="col-md-6">
        <div class="input-group date mb-3">
            <div class="input-group-append">
                <div class="inputGroupBlue" style="width: 142px"><i class="fs-20 mr-2 fas fa-calendar-alt"></i>Start Date</div> 
            </div>
    ...
    <div class="col-md-6">
        <div class="input-group date mb-3">
            <div class="input-group-append">
                <div class="inputGroupBlue" style="width: 142px"><i class="fs-20 mr-2 fas fa-calendar-alt"></i>Finish Date</div> 
            </div>
...
<div class="row">
    <div class="col-12">
        ...
        @if(Auth::user()->role=='SYS_ADMIN'||Auth::user()->role=='PPIC_PLANNER')
            ...
            <a href="#" type="button" class="btn btn-red-md btn-block" onclick="return confirm('Delete Schedule ?')">Delete Schedule<i class="ml-3 fs-18 fas fa-trash"></i></a> 
        @endif
    </div>
</div>