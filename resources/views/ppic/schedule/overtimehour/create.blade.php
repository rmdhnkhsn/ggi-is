@extends("layouts.app")
@section("title","Overtime Hour Create")
@push("styles")
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-9 mx-auto">
        <div class="cards p-4">
          <div class="title-20 text-left">Create Branch Overtime Hour</div>
          <div class="borderlight2 mb-3"></div>
          <form action="{{route('ppic.schedule.overtimehour.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-12">
              ...
              <div class="col-12">
                ...
                <div class="input-group flex mt-1 mb-3">
                  ...
                  <input type="number" class="form-control borderInput" id="hour" name="hour" value="" min="0" max="6" placeholder="Hour" required>
                </div>
              </div>
