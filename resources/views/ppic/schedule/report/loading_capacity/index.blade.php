...
<section class="content">
    <!-- Main content -->
      <div class="container-fluid">
        ...
        <div class="row mt-2">
          <div class="col-12">
            <span class="reject-cutting-tittle">Report Loading Capacity</span>
          </div>
        </div>

        <div class="row">
          <div class="col-6">
            <form id="form_wo" action="{{route('ppic.schedule.report_loading_capacity_show')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-row">
