<table id="tabelReject" class="table table-sm table-border">
  <thead>
    <tr>
      ...
      <th style="font-weight:bold;text-align:center;width:250px;background-color:#66a3ff;">Branch</th>
      ...
      <th style="font-weight:bold;text-align:center;width:80px;background-color:#66a3ff;">%</th>
    </tr>
  </thead>
  @php
    $i=1;
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$d->des}}</td>
      <td>{{$total}}</td>
      <td>{{round(($total/$d->total)*100,2)}}</td>
    </tr>
    @php
    $i+=1;
    @endphp
