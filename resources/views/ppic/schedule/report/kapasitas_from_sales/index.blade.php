...
<section class="content">
    <!-- Main content -->
      <div class="container-fluid">
        ...
        <div class="row mt-2">
          <div class="col-12">
            <span class="reject-cutting-tittle">Report Kapasitas From Sales</span>
          </div>
        </div>

        <div class="row">
          <div class="col-6">
            <form id="form_wo" action="{{route('ppic.schedule.report_kapasitas_from_sales_show')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-row">
              ...
              <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                      <label>Date To</label>
                      <input type="date" class="form-control" id="target_date_to" name="target_date_to" value="{{$dateto->target_date}}" placeholder="To Date">
                  </div>
              </div>
