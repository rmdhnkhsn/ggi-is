        ...
        <div class="cards p-4">
          <div class="row">
            <div class="col-12 justify-sb2">
              <div class="title-20-grey">Data Overtime</div>
              <div class="filterSMV">
                @if(Auth::user()->role=='SYS_ADMIN'||Auth::user()->role=='PPIC_PLANNER')
                  <a href="{{route('ppic.schedule.overtime.create')}}" type="button" class="btn-blue-md">Add Overtime <i class="fs-18 ml-2 fas fa-plus"></i></a>
                @endif
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="container-tbl-btn flex gap-2">
                          <a href="{{route('ppic.schedule.overtime.edit',['id'=>$d->id])}}" class="btn-icon-yellow" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Edit"><i class="fs-18 fas fa-pencil-alt"></i></a>  
                          <a href="{{route('ppic.schedule.overtime.destroy',['id'=>$d->id])}}" class="btn-icon-red deleteData" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Delete"><i class="fs-18 fas fa-trash-alt"></i></a>
                        </div>
                        @endif
                      </td>
                    </tr>
