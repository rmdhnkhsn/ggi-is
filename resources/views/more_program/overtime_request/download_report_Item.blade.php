    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
                <b style="font-size:13px">FORM MONITORING OVERTIME BY ITEM</b> 
        ...
        <div class="row mt-2">
            <div class="col-12 mt-1">
               <table class="tables table-bordered">
                        ...
                        <tr class="bg-header">
                            <th rowspan="3" width="60px" style="font-size:11px;padding:3px">ITEM</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:10px;padding:3px"><b>{{$value2['item']}}</b></td> 
