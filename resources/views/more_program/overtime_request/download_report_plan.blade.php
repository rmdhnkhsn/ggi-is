    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
                <b style="font-size:13px">FORM PLAN MONITORING OVERTIME BY BAGIAN</b> 
               ...
               <table class="tables table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size:10px;padding:3px;text-align:center"></td>
                                <td style="font-size:10px;padding:3px;text-align:center"></td>
                                <td style="font-size:10px;padding:3px;text-align:center"></td>
                                <td style="font-size:10px;padding:3px"></td>
                                <td style="font-size:10px;padding:3px"></td>
                            </tr>
                            @endforeach
                            ...
                            <tr class="bg-jumlah">
                                ...
                                <td style="font-size:11px;padding:3px;text-align:center"><b></b></td> 
                                <td style="font-size:11px;padding:3px;text-align:center"><b></b></td>
                                <td style="font-size:11px;padding:3px;text-align:center"><b></b></td>
                                <td colspan="2" style="font-size:11px;padding:3px;text-align:center"><b></b></td> 
                            </tr>
                            @endif
                            @endforeach
