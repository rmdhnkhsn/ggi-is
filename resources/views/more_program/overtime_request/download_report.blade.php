    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
                <b style="font-size:13px">FORM MONITORING OVERTIME BY BAGIAN</b> 
        ...
        <div class="row mt-2">
            <div class="col-12 mt-1">
               <table class="tables table-bordered">
                        ...
                        <tr>
                            <th colspan="12">FACTORY : {{$key}}</th>
                        </tr>
                        <tr class="bg-header">
                            <th rowspan="3" width="60px" style="font-size:11px;padding:3px">DEPT</th>
                            <th rowspan="3" width="60px" style="font-size:11px;padding:3px">BAGIAN</th>
                            <th colspan="5" style="font-size:11px;padding:3px">PLAN OVERTIME</th>
                            <th colspan="5" style="font-size:11px;padding:3px">REALISASI OVERTIME</th>
                        </tr>
                        <tr class="bg-header">
                            <th rowspan="2" width="50px" style="font-size:10px;padding:3px">JLH<div>ORANG</div></th> 
                            <th rowspan="2" width="50px" style="font-size:10px;padding:3px">JLH JAM<div>KERJA</div></th> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:10px;padding:3px"><b>{{$value2['departemen']}}</b></td>
                                <td style="font-size:10px;padding:3px"><b>{{$value2['bagian']}}</b></td> 
                                <td style="font-size:10px;padding:3px;text-align:center">{{$value2['jumlah_karyawan']}}</td>
                                <td style="font-size:10px;padding:3px;text-align:center">{{round($value2['jumlah_jam_rencana'],2)}}</td>
                                ...
                                <td style="font-size:10px;padding:3px;text-align:center">{{$value2['jumlah_karyawan_realisasi']}}</td>
                                <td style="font-size:10px;padding:3px;text-align:center">{{round($value2['jumlah_jam_realisasi'],2)}}</td>
                            ...
                            <tr class="bg-jumlah">
                                <td colspan="2" style="font-size:11px;padding:3px;text-align:center"><b>TOTAL {{$key}}</b></td> 
                                <td style="font-size:11px;padding:3px;text-align:center"><b>{{$value3['jml_orang']}}</b></td> 
                                <td style="font-size:11px;padding:3px;text-align:center"><b>{{round($value3['jam_rencana'],2)}}</b></td> 
                                ...
                                <td style="font-size:11px;padding:3px;text-align:center"><b>{{$value3['jml_orang_realisasi']}}</b></td> 
                                <td style="font-size:11px;padding:3px;text-align:center"><b>{{round($value3['jam_realisasi'],2)}}</b></td>
                                <td style="font-size:11px;padding:3px;text-align:center"><b>Rp. {{number_format($value3['cost_realisasi'], 2, ",", ".")}}</b></td>
                                <td colspan="2" style="font-size:11px;padding:3px;text-align:center"><b>{{$value3['realisasi_kuantitatif']}}</b></td> 
                            </tr>
                            @endif
                            @endforeach
                        ...
                        <tr class="bg-total">
                            <td colspan="2" style="font-size:11px;padding:3px;text-align:center"><b>TOTAL ALL</b></td> 
                            <td style="font-size:11px;padding:3px;text-align:center"><b>{{$total_all['jml_orang']}}</b></td> 
                            <td style="font-size:11px;padding:3px;text-align:center"><b>{{round($total_all['jam_rencana'],2)}}</b></td> 
                            ...
                            <td style="font-size:11px;padding:3px;text-align:center"><b>{{$total_all['jml_orang_realisasi']}}</b></td> 
                            <td style="font-size:11px;padding:3px;text-align:center"><b>{{round($total_all['jam_realisasi'],2)}}</b></td>
                            <td style="font-size:11px;padding:3px;text-align:center"><b>Rp. {{number_format($total_all['cost_realisasi'], 2, ",", ".")}}</b></td>
                            <td colspan="2" style="font-size:11px;padding:3px;text-align:center"><b>{{$total_all['realisasi_kuantitatif']}}</b></td> 
                        </tr>
                </table>
            </div>
        </div>
