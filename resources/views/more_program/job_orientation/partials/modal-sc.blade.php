<div class="modal fade" id="sc" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:620px">
        <div class="modal-content" style="border-radius:10px">
            ...
            <form id="simpansc" action="{{ route('job.sc_store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row px-4">
                    <div class="col-12 text-center mb-3">
                        <span class="title-22" style="font-weight:600">Your Source Code Document </span>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group mt-1">
                            ...
                            <select class="form-control border-input-10 select2bs4_sc" name="departemen" id="departemen_sc">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group mt-1">
                            ...
                            <select class="form-control border-input-10 select2bs4_sc" name="bagian" id="bagian_sc">
                                <option selected></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <input type="hidden" name="kategori" id="kategori" value="SC">
                        <span class="title-sm">Your Document</span>
                        <div class="customFile mt-1 mb-3">
                            <input type="file" class="customFileInput" id="customFile28" name="dokumen" value="dokumen" accept=".txt">
                            <label class="customFileLabelsBlue" for="customFile28">
                            <span class="chooseFile"></span></label>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="customSwitch12"  value="1" name="remark">
                            <label class="custom-control-label" for="customSwitch12">Set Public</label>
                        </div>
                    </div>
