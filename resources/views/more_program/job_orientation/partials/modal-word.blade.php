<div class="modal fade" id="word" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:620px">
        <div class="modal-content" style="border-radius:10px">
            ...
            <form id="saveWord" action="{{ route('job.word_store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row px-4">
                    <div class="col-12 text-center mb-3">
                        <span class="title-22" style="font-weight:600">Your Word Document </span>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group mt-1">
                            ...
                            <select class="form-control border-input-10 select2bs4_word" name="departemen" id="departemen_word">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group mt-1">
                            ...
                            <select class="form-control border-input-10 select2bs4_word" name="bagian" id="bagian_word">
                                <option selected></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <input type="hidden" name="kategori" id="kategori" value="WORD">
                        <span class="title-sm">Your Document</span>
                        <div class="customFile mt-1 mb-3">
                            <input type="file" class="customFileInput" id="customFile3" name="dokumen" value="dokumen" accept=".docx">
                            <label class="customFileLabelsBlue" for="customFile3">
                            <span class="chooseFile"></span></label>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="customSwitch18"  value="1" name="remark">
                            <label class="custom-control-label" for="customSwitch18">Set Public</label>
                        </div>
                    </div>
