<div class="modal fade" id="pdf" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:620px">
        <div class="modal-content" style="border-radius:10px">
            ...
            <form id="savepdf" action="{{ route('job.pdf_store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row px-4">
                    <div class="col-12 text-center mb-3">
                        <span class="title-22" style="font-weight:600">Your PDF Document </span>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group mt-1">
                            ...
                            <select class="form-control border-input-10 select2bs4_pdf" name="departemen" id="departemen_pdf">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group mt-1">
                            ...
                            <select class="form-control border-input-10 select2bs4_pdf" name="bagian" id="bagian_pdf">
                                <option selected></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <input type="hidden" name="kategori" id="kategori" value="PDF">
                        <span class="title-sm">Your Document</span>
                        <div class="customFile mt-1 mb-3">
                            <input type="file" class="customFileInput" id="customFile2" name="dokumen" value="dokumen" accept=".pdf">
                            <label class="customFileLabelsBlue" for="customFile2">
                            <span class="chooseFile"></span></label>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="customSwitch15"  value="1" name="remark">
                            <label class="custom-control-label" for="customSwitch15">Set Public</label>
                        </div>
                    </div>
