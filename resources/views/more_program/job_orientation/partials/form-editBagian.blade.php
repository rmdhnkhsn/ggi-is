<div class="modal fade" id="editBagian-{{$value3->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
                ...
                <div class="row px-4">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="customFile mt-1 mb-3">
                            <input type="file" class="customFileInput" id="customFileBagian{{$value3->id}}" name="dokumen" value="dokumen">
                            <label class="customFileLabelsBlue" for="customFileBagian{{$value3->id}}">
