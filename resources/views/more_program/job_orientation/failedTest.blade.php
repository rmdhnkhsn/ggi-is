                ...
                <div class="cards resultTest">
                    <div class="row" style="height:100%">
                        <div class="imgContainer">
                            <img src="{{url('images/iconpack/job_orientation/failed.svg')}}" class="imgCompleted">
                        </div>
                        <div class="descContainer">
                            <div class="judul">Your score is less than <br/>the passing grade.</div>
                            <div class="score">
                                <div class="yourScore">
                                    <div class="text">Your Score</div>
                                    <div class="number-fail">{{$data->final_score}}</div>
                                </div>
                                <div class="result">
                                    <img src="{{url('images/iconpack/job_orientation/result_tdklulus.svg')}}" class="relative">
                                        <div class="btnHome">
