<div class="modal fade" id="previewImagesSub{{$value3->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:570px">
        <div class="modal-content" style="border-radius:10px;padding:16px 26px">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <img id="priviewImageBawah{{$value3->id}}" src="#" class="imgResponsive">
                </div>
            </div>
        </div>
    </div>
