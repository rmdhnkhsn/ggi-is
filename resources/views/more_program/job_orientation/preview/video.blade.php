<div class="modal fade" id="previewVideo{{$value3->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:1000px">
        <div class="modal-content" style="border-radius:10px;padding:16px 26px">
            ...
            <div class="row mt-3" id="siVideoAtas{{$value3->id}}">
