...
<nav class="main-header navbar navbar-expand navbar-blue navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('trimcard.dashboard')}}" class="nav-link text-white">Dashboard</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('trimcard.dashboard')}}" class="nav-link <?php if($page=='TrimCardDashboard'){echo 'active';}?>">
          ...
          <li class="nav-item">
            <a href="{{route('trimcard.index')}}" class="nav-link <?php if($page=='TrimCardIndex'){echo 'active';}?>">
