<input type="hidden" class="form-control"  id="rekap_detail_id" name="rekap_detail_id" value="{{$detail->id}}">
<input type="hidden" class="form-control"  id="master_order_id" name="master_order_id" value="{{$detail->master_order_id}}">
<div class="row">
    <div class="col-lg-4">
