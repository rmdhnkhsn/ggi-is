...
<div class="row">
    <div class="col-12">
        <div class="ws-judul mb-2">Attention & Guide</div>
    </div>
    <div class="col-12">
        <div class="title-14 text-left">Attention Sewing</div>
        <div class="messageGrey mt-2 mb-4">
            <textarea id="attention_sewing" name="attention_sewing" maxlength="500" placeholder="Write youre attention Sewing..">{{$attention_sewing}}</textarea>
        </div>
    </div>
    <div class="col-12">
        <div class="title-14 text-left">Sewing Image</div>
    </div>
