...
<div class="row">
    <div class="col-12">
        <div class="title-14 text-left">Attention Trimming</div>
        <div class="messageGrey mt-2 mb-4">
            <textarea id="attention_trimming" name="attention_trimming" maxlength="500" placeholder="Write youre attention trimming..">{{$attention_trimming}}</textarea>
        </div>
    </div>
    <div class="col-12">
        <div class="title-14 text-left">Trimming Image</div>
    </div>
