...
<form action="{{ route('worksheet.sewing_update')}}" method="post" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="id" id="id" value="{{$value->id}}">
    <input type="hidden" name="master_id" id="master_id" value="{{$value->master_id}}">
    <div class="modal fade" id="edit_detail-{{$value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="text-align:left;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-body">
                    <div class="row">
