<!-- Modal -->
<div class="modal fade" id="inac_detail-{{$value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<form action="{{ route('worksheet.inac_update')}}" method="post" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="id" id="id" value="{{$value->id}}">
    <input type="hidden" name="master_id" id="master_id" value="{{$value->master_id}}">
    <div class="modal fade" id="inac_edit-{{$value->id }}" role="dialog" aria-labelledby="myModalLabel" style="text-align:left;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control borderInput mt-1 mb-3" id="port" name="port" placeholder="Example (main fabric)" value="{{$value->port}}">
                        </div>
                        <div class="col-md-6">
