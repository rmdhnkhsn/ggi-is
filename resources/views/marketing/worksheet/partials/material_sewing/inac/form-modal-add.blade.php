...
<form action="{{ route('worksheet.inac_store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="inac_add" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 text-center mb-4">
                            <span class="ms-add-title">Inac (Accesories)</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="input-group mb-3 mt-2">
                                ...
                                <select class="custom-select select2bs_inac1" style="width:50%;" name="material1">
                                    <option disabled selected>Example (Polyester100%)</option>
                                    @foreach($inac as $key => $value)
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="input-group mb-3 mt-2">
                                ...
                                <select class="custom-select select2bs_inac2" id="inputGroupSelect02" name="material2">
