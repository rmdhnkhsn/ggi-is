...
<div class="row mt-2">
    <div class="col-sm-6">
        ...
        <div class="ws-message mt-2">
            <textarea placeholder="Write youre attention Label.." name="attention_label" id="attention_label" value="" style="height:160px">{{$attention_label}}</textarea>
        </div>
    </div>
    <div class="col-sm-6">
        <span class="ws-sub-title">Label Guide</span>
        <div class="ws-message mt-2">
            <textarea placeholder="Write youre Label guide.." name="label_guide" id="label_guide" value="" style="height:160px">{{$label_guide}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
