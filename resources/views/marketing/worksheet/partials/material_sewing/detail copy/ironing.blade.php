...
<div class="row mt-5">
    <div class="col-12">
        <div class="ws-judul">Ironing</div>
    </div>
</div>
<div class="row">
...
<div class="row mt-2">
    <div class="col-sm-6">
        ...
        <div class="ws-message mt-2">
            <textarea placeholder="Write youre attention Ironing.." name="attention_ironing" id="attention_ironing" value="" style="height:160px">{{$attention_ironing}}</textarea>
        </div>
    </div>
    <div class="col-sm-6">
        <span class="ws-sub-title">Label Ironing</span>
        <div class="ws-message mt-2">
            <textarea placeholder="Write youre Ironing guide.." name="ironing_guide" id="ironing_guide" value="" style="height:160px">{{$ironing_guide}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
