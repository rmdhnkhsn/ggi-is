...
<section class="content">
    <div class="container-fluid">
      <center>
        <span class="label_worksheet">Measurement</span>
      </center> 
      @include('marketing.worksheet.partials.stepbar')
      <div class="col-lg-12 kotak_satu">
        <span class="judul_biru">Measurement Spec</span>
        <button type="button" class="ws-add-item ml-4" data-toggle="modal" data-target="#modal-form-measurement" onclick="add_form();">
        ...
        <div class="row mt-2 mb-2">
          <div class="col-4">
            <span class="ws-sub-title">Document</span>
          </div>
        </div>
        <div class="row mt-2 mb-2">
          <div class="col-12">
              <div class="custom-file mt-2">
                  ...
                  <label class="custom-file-labels" for="customFile">
                    <span class="choose-file">{{$master_data->file_measurement}}</span>
                  </label>
              </div>
          </div>
          <div class="col-12">
              <div class="custom-file mt-2">
                  ...
                  <label class="custom-file-labels" for="customFile">
                    <span class="choose-file">{{$master_data->file1}}</span>
                  </label>
              </div>
          </div>
          <div class="col-12">
              <div class="custom-file mt-2">
                  ...
                  <label class="custom-file-labels" for="customFile">
                    <span class="choose-file">{{$master_data->file2}}</span>
                  </label>
              </div>
          </div>
          <div class="col-12">
              <div class="custom-file mt-2">
                  ...
                  <label class="custom-file-labels" for="customFile">
                    <span class="choose-file">{{$master_data->file3}}</span>
                  </label>
              </div>
          </div>
          <div class="col-12">
              <div class="custom-file mt-2">
                  ...
                  <label class="custom-file-labels" for="customFile">
                    <span class="choose-file">{{$master_data->file4}}</span>
                  </label>
              </div>
          </div>
          <div class="col-12">
              <div class="custom-file mt-2">
                  ...
                  <label class="custom-file-labels" for="customFile">
                    <span class="choose-file">{{$master_data->file5}}</span>
                  </label>
              </div>
          </div>
        </div>    
      ...
      <div class="container" style="padding-top:10px">
        <a href="{{route('worksheet.material_sewing',$master_data->id)}}" class="btn btn_back btn-sm title-navigate-next">Back <i class="fas fa-arrow-left icon_back"></i></i></a>
