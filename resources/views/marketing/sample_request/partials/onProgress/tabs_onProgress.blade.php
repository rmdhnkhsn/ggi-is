    <div class="row">
        <div class="col-12 customSR">
            ...
            <button type="button" class="btn-blue" data-toggle="modal" data-target="#create2">Create Request<i class="ml-2 fs-20 fas fa-plus"></i></button>
            @include('marketing.sample_request.partials.onProgress.add_request',['submit' => 'Submit'])
        </div>
    </div>
    <div class="row">
      <div class="col-12">
        <div class="cards-scroll scrollX" id="scroll-bar">
            ...
            <table id="DTtable2" class="table hrd-tbl-content no-wrap py-2">
                <thead>
                    <tr>
                        <th>Style</th>
                        <th>Qty</th>
                ...
                <tbody>
                    @foreach ($dataSampleOnProgress as $key =>$value)
                        <tr>
                            <td>{{ $value['style'] }}</td>
                            ...
                            <td>
                                @include('marketing.sample_request.partials.onProgress.btn_action')
                            </td>
                        </tr>
                    @endforeach
                </tbody>
