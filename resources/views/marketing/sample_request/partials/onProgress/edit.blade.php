<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
            ...
            <div class="row px-4">
                <div class="col-12">
                    ...
                    <div class="input-group mt-1 mb-3">
                        <input type="text" class="form-control border-input" id="" name="" value="" placeholder="Input buyer...">
                    </div>
                </div>
                <div class="col-12">
                    <span class="title-sm">Style</span>
                    <div class="input-group mt-1 mb-3">
                        <input type="text" class="form-control border-input" id="" name="" value="" placeholder="Input style...">
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-qty">
                    <div class="input-group mb-3 mt-1">
                        <input id="center" type="text" class="form-control input1" id="" name="" value="" placeholder="...">
                        <input id="center" type="text" class="form-control border-input" id="" name="" value="" placeholder="0">
                    </div>
                </div>
                <div class="col-qty">
                    <div class="input-group mb-3 mt-1">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mt-1 mb-3">
                        <div class="input-group date" id="DueDate" data-target-input="nearest">
                            ...
                            <input type="text" class="form-control datetimepicker-input input-data-fa" data-target="#DueDate" name="tanggal" placeholder="Select date..."/>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="custom-file mt-1 mb-3">
                        <input type="file" class="custom-file-input" id="" name="" value="">
