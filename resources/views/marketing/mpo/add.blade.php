                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add New PO Number</h3>
                        </div>
                        <div class="card-body">
                        <form action="{{ route('masterpo.store')}}" method="post" enctype="multipart/form-data">
                            @csrf 
                                        @include('marketing.mpo.partials.form-control',['submit' => 'Submit'])
                        </form>  
                        <div class="row">
                            <div class="col-3"> 
                            </div>
