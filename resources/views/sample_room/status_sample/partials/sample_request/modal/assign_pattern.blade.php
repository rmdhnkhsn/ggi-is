<form action="{{route ('sample.storeDailyRemark') }}" method="post" enctype="multipart/form-data">
@csrf
    <div class="modal fade" id="dailyUpdate" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
