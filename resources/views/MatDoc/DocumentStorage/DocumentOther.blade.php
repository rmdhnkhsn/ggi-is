@extends("layouts.app")
@section("title","Document Storage Other")
@push("styles")
  ...
  <div class="container-fluid pb-5">
    <div class="row">
      <div class="col-12">
        ...
        @include('MatDoc.DocumentStorage.partials.DocOther.upload')
      </div>
    </div>
          ...
          <div class="cardBody p-3">
            <div class="row">
              <div class="col-12 pb-5">
                ...
                @include('MatDoc.DocumentStorage.partials.DocOther.radioFilter')
                <div class="cards-scroll scrollX" id="scroll-bar">
                  <table id="DTtable" class="tables3 tbl-content-cost no-wrap">
                    ...
                    <tbody>
                      ...
                      @include('MatDoc.DocumentStorage.partials.DocOther.editDoc')
                    </tbody> 
                  </table>
                </div>
              </div>
