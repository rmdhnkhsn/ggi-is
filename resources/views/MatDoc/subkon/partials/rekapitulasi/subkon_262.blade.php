                  ...
                  <tr>
                    ...
                    <td>
                      <div class="container-tbl-btn flex gap-2">
                        <a href="{{route('subkon.rekapitulasi262.dok',[$no_kontrak,$value['id_no_aju']])}}"  class="btn-icon-blue" ><i class="fas fa-info"></i></a>
                        <a  href="" data-toggle="modal" data-target="#myModal{{$value['id_no_aju']}}" class="btn-icon-hijau" ><i class="fas fa-file-excel"></i></a>
                        @if($data_kontrak['status_kontrak']!='Close')
                          ...
                          <a href="{{route('subkon.rekapitulasi262.edit',[$no_kontrak,$value['id_no_aju']])}}" class="btn-icon-yellow"><i class="fas fa-pencil-alt"></i></a>
                          <a href="{{route('subkon.rekapitulasi261.delete',[$no_kontrak,$value['id_no_aju']])}}" class="btn-icon-red deletePartialReceive"><i class="fas fa-trash"></i></a>
                          @endif
                        @endif
                      </div>
                      <div class="modal fade" id="myModal{{$value['id_no_aju']}}">
