                  ...
                  <tr>
                    ...
                    <td>
                      <div class="container-tbl-btn flex gap-2">
                        <a href="{{route('subkon.rekapitulasi.dok',[$no_kontrak,$value['no_daftar']])}}"  class="btn-icon-blue" ><i class="fas fa-info"></i></a>
                        <a href="{{route('subkon.rekapitulasi.excel',[$no_kontrak,$value['no_daftar']])}}"  class="btn-icon-hijau" ><i class="fas fa-file-excel"></i></a>
                        @if($data_kontrak['status_kontrak']!='Close')
                          ...
                          <a href="{{route('subkon.rekapitulasi.edit',[$no_kontrak,$value['no_daftar']])}}" class="btn-icon-yellow"><i class="fas fa-pencil-alt"></i></a>
                          <a href="{{route('subkon.rekapitulasi.delete',[$no_kontrak,$value['no_daftar']])}}" class="btn-icon-red deletePartial"><i class="fas fa-trash"></i></a>
                          @endif
                        @endif
                      </div>
