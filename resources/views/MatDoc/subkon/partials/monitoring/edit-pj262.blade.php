  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-10 ml-auto mr-auto mb-5">
        ...
        @endphp
      <form  action="{{route('subkon.update.pj262')}}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <!-- <div class="col-lg-3">
              ...
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control border-input" id="no_aju" name="no_aju" value="{{$collect_aju->no_aju}}">
              </div>
            </div> -->
            <div class="col-lg-4">
              <span class="title-sm">Nomor AJU Dokumen</span>
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control border-input" id="dok_aju" name="dok_aju" value="{{$collect_aju->dok_aju}}">
              </div>
            </div>
            <div class="col-lg-4">
              <span class="title-sm">Nomor Daftar</span>
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control border-input" id="no_daftar" name="no_daftar" value="{{$collect_aju->no_daftar}}">
              </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-12">
              <div class="cards p-4">
                <div class="justify-sb3">
                  <div class="title-20 text-left">Edit Data 261</div>
                ...
                <div class="cards-scroll mh-530 scrollY" id="scroll-bar">
                  <table id="DTtable_StickyHeader" class="table tbl-content-left no-wrap pr-2">
                    ...
                    <tbody> 
                      <?php $no=0;?>
                      @foreach($receive_pemasukan as $key =>$value)
                        @if($value->sum('qty')>0)
                          <?php $no++;?>
                          <tr>
                            <td>{{$no}}</td>
                            <td>{{$value->first()['kode_barang']}}</td>
                            <td>{{$value->first()['nama_barang']}}</td>
                            <td>{{$value->first()['glpt']}}</td>
                            <td><input type="text" class="form-control border-input" id="qty[]" name="qty[]" value="{{$value->sum('qty')}}" style="height:37px;margin:-7px 0" readonly></td>
                            <td>{{$value->first()['satuan']}}</td>
                            <td>{{$value->first()['tersisa']}}</td>
                          </tr>
                        @endif
                      @endforeach
                    </tbody>
          ...
          <div class="row">
            ...
            <input type="hidden" id="id_no_aju" name="id_no_aju" value="{{$id_no_aju}}" required>
