<div class="row">
    <div class="col-12">
        ...
        @if($data_kontrak['status_kontrak']!='Close')
            ...
            @if(auth()->user()->role == 'SYS_ADMIN' || auth()->user()->departemensubsub == 'EXIM'|| auth()->user()->departemensubsub == 'DOCUMENT'|| auth()->user()->nik == 'GISCA' || auth()->user()->departemensubsub == 'PPIC' || auth()->user()->departemensubsub == 'PURCHASING' )
            <form  action="{{route('subkon.create.pj')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="flexx" style="gap:.8rem">
                    <div class="form-input d-flex">
                        ...
                        <input type="date" placeholder="tanggal transaksi" class="form-control border-input mr-3" id="tanggal_transaksi" name="tanggal_transaksi" value="" required>
                        <input type="text" placeholder="No Penyerahan" class="form-control border-input" id="no_aju" name="no_aju" value="" required>
                    </div>
                    <div class="buttons">
            ...
            <form  action="{{route('subkon.sinkronjde.pj')}}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control border-input" id="no_kontrak" name="no_kontrak" value="{{$no_kontrak}}" required>
                <div class="buttons">
                    <button type="submit" class="btn-blue no-wrap">Sinkron JDE<i class="ml-2 fas fa-plus"></i></button>
                </div>
            </form>
            @endif
          ...
          <div class="row">
            <div class="col-12">
                <div class="flex gap-6">
                    ...
                    <a href="{{route('subkon.monitoring261.excel',$no_kontrak)}}" class="btn-icon-green" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Export Excel" style="width:37px;height:37px"><i class="fs-18 fas fa-file-excel"></i></a>
                </div>
            </div>
            <div class="col-12">
