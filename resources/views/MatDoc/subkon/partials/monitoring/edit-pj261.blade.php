    ...
    <div class="row">
      ...
      <form  action="{{route('subkon.update.pj261')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="row mb-4" id="ScrollUp">
            <div lass="col-12 ">
              <span class="title-24">Edit data partrial</span>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-3">
              ...
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control borderInput" id="no_aju" name="no_aju" value="{{$collect_aju->no_aju}}" >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">Nomor AJU Dokumen</span>
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control borderInput" id="dok_aju" name="dok_aju" value="{{$collect_aju->dok_aju}}">
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">Nomor Daftar</span>
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control borderInput" id="no_daftar" name="no_daftar" value="{{$collect_aju->no_daftar}}" readonly>
              </div>
            </div>
            <div class="col-lg-3">
              ...
              <div class="input-group mt-1 mb-3">
                <div class="input-group date">
                  ...
                  <input type="date" class="form-control input-data-fa" name="tanggal" value="{{$collect_aju->tanggal}}" />
                </div>
              </div>
            </div>
            <div class="col-lg-3">
              ...
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="bm" name="bm"value="{{$collect_aju->bm}}" onkeyup="jumlah()" value="0" required >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">PPN</span>
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="ppn" name="ppn" value="{{$collect_aju->ppn}}" onkeyup="jumlah()" value="0" required >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">PPH</span>
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="pph" name="pph" value="{{$collect_aju->pph}}"  onkeyup="jumlah()" value="0" required >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">Total Jaminan</span>
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="total_jaminan" name="total_jaminan" value="{{$collect_aju->total_jaminan}}"  readonly >
              </div>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
              <div class="cards p-4">
                <div class="justify-sb3">
                  <div class="title-20">Edit Data 261</div>
                  <div class="containerSearch">
                    <input type="text" class="form-control borderInput" id="DTtableSearch" placeholder="Search..."><i class="srch fas fa-search"></i>
                  </div>
                </div>
                <div class="cards-scroll mh-530 pr-1 scrollY" id="scroll-bar">
                  <table id="DTtable_StickyHeader" class="table tbl-content no-wrap">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Item Code</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <input type="hidden" id="" name="id_material[]" value="{{$value['id_material']}}" required>
                        ...
                        <td>
                          <input type="number" onchange="jumlahSisa(this)" onkeyup="jumlahSisa(this)" class="form-control borderInput sumQty" id="" name="qty[]" value="{{$value['qty']}}" style="height:37px;margin:-7px 0;padding:10px">
                          <input type="hidden" class="form-control borderInput" id=""  value="{{$value['tersisa']+$value['qty']}}" style="height:37px;margin:-7px 0" onkeyup="sisa{{$value['id']}}()">
                        </td>
                        
                        <td>{{$value['satuan']}}</td>
                        <td>
                          <input type="number" class="form-control borderInput tersisa sumQtySisa" id=""  value="{{$value['tersisa']}}" style="height:37px;margin:-7px 0;padding:10px" onkeyup="sisa{{$value['id']}}()" readonly>
                        </td>
                        <td>
                          <input type="checkbox" class="check1" id="" name="gl_class[]" {{ $value['gl_class']!=null ? 'checked' : ''}} value="{{$value['id_material']}}">
                        </td>
                        <td>
                          <input type="checkbox" class="check1" id="" name="hanca[]" {{ $value['hanca']!=null ? 'checked' : ''}} value="{{$value['id_material']}}">
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
                    <tfoot>
                      <tr>
                        ...
                        <th>
                          <input type="number" class="form-control borderInput totalQty" id=""  value="{{collect($record)->sum('qty')}}" style="height:37px;margin:-7px 0;padding:10px" readonly>
                        </th>
                        <th></th>
                        <th colspan="3">
                          <input type="number" class="form-control borderInput totalQtySisa" id=""  value="{{collect($record)->sum('tersisa')}}" style="height:37px;margin:-7px 0;padding:10px" readonly>
                        </th>
                      </tr>
                    </tfoot>
                  </table>
...
<script>
  function jumlahSisa(input){
    ...
    const qtyPengeluaran =  parseInt(input.value); 
    const qtyTersisa = input.closest('td').nextElementSibling.nextElementSibling.querySelector('input'); 
    qtyTersisa.value = qtyContract - qtyPengeluaran
    qtyTersisa.value < '0' ?  qtyTersisa.style.color = 'red'  :  qtyTersisa.style.color = '#2b2b2b'
