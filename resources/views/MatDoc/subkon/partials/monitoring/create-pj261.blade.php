  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <form  action="{{route('subkon.insert.pj')}}" id="myForm" method="post" enctype="multipart/form-data">
          @csrf
          <input type="hidden" class="form-control borderInput" id="no_kontrak" name="no_kontrak" value="{{$no_kontrak}}" required>
          <div class="row mb-4">
          ...
          <div class="row">
            <div class="col-lg-6 col-sm-12">
              <span class="title-sm">Nomor Penyerahan</span>
              <div class="input-group mt-1 mb-3">
                <input type="text" class="form-control borderInput" id="no_aju" name="no_aju" maxlength="6" value="{{$no_aju}}" placeholder="Masukan Nomor Penyerahan..." readonly>
              </div>
              <div class="input-group">
                <input type="hidden" class="form-control borderInput" id="no_bpb" name="no_bpb" value="{{$no_bpb}}" required>
                <input type="hidden" class="form-control borderInput" id="tipe_partial" name="tipe_partial" value="{{$tipe_partial}}" required>
                
                <input type="hidden" class="form-control borderInput" id="bm" name="bm" placeholder="Masukan BM..." onkeyup="jumlah()" value="{{$bm}}" required >
                <input type="hidden" class="form-control borderInput" id="ppn" name="ppn" placeholder="Masukan PPN..." onkeyup="jumlah()" value="{{$ppn}}" required >
                <input type="hidden" class="form-control borderInput" id="pph" name="pph" placeholder="Masukan PPH..."  onkeyup="jumlah()" value="{{$pph}}" required >
                <input type="hidden" class="form-control borderInput" id="total_jaminan" name="total_jaminan" placeholder="Masukan Total Jaminan..."  value="{{$total_jaminan}}" readonly >
              </div>
            </div>
            <!-- <div class="col-lg-3">
              <span class="title-sm">Nomor AJU Dokumen</span>
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control borderInput" id="dok_aju" name="dok_aju" maxlength="6" value="{{$dok_aju}}" placeholder="Masukan Dokumen AJU SJ...">
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">Nomor Daftar</span>
              <div class="input-group mt-1 mb-3">
                  <input type="text" class="form-control borderInput" id="no_daftar" name="no_daftar" maxlength="6" value="{{$no_daftar}}" placeholder="Masukan Nomor Daftar...">
              </div>
            </div> -->
            <div class="col-lg-6 col-sm-12">
            ...
            <!-- <div class="col-lg-3">
              ...
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="bm" name="bm" placeholder="Masukan BM..." onkeyup="jumlah()" value="{{$bm}}" required >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">PPN</span>
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="ppn" name="ppn" placeholder="Masukan PPN..." onkeyup="jumlah()" value="{{$ppn}}" required >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">PPH</span>
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="pph" name="pph" placeholder="Masukan PPH..."  onkeyup="jumlah()" value="{{$pph}}" required >
              </div>
            </div>
            <div class="col-lg-3">
              <span class="title-sm">Total Jaminan</span>
              <div class="input-group mt-1 mb-3">
                  <input type="number" class="form-control borderInput" id="total_jaminan" name="total_jaminan" placeholder="Masukan Total Jaminan..."  value="{{$total_jaminan}}" readonly >
              </div>
            </div> -->
            

            <div class="col-lg-12">
              <span class="title-sm">Daftar BPB Pada Document Ini</span>
                  ...
                  <table id="DTtable_StickyHeader" class="table tbl-content-left no-wrap pr-2">
                    ...
                    <tbody> 
                      ...
                      <tr>
                          ...
                          <input type="hidden"  name="gl_class_jde[]" value="{{$value['gl_class_jde']}}" required>

                        <td>{{$no}}</td>
                        <td>{{$value['item_number']}}</td>
                        <td>{{$value['deskripsi']}}</td>
                        <td>{{$value['gl_class_jde']}}</td>
                        
                        <td>
                          <input type="number" onchange="jumlahSisa(this)" onkeyup="jumlahSisa(this)" class="form-control borderInput sumQty" id="qty{{$value['id']}}" name="qty[]" value="{{$value['qty']}}" style="height:37px;margin:-7px 0">
                          
                          <input type="hidden" class="form-control borderInput" id="tersisa{{$value['id']}}"  value="{{$value['tersisa']}}" style="height:37px;margin:-7px 0" onkeyup="sisa{{$value['id']}}()">
                        </td>
                        <td>{{$value['satuan']}}</td>
                       
                        <td>
                          <input type="number" class="form-control borderInput tersisa sumQtySisa" id="tampil{{$value['id']}}"  value="{{$value['tampil_sisa']}}" style="height:37px;margin:-7px 0" onkeyup="sisa{{$value['id']}}()" readonly>
                        </td>
                        <td>
                          <input type="checkbox" class="check1" id="" name="gl_class[]" {{ $value['gl_class']!=null ? 'checked' : ''}} value="{{$value['id']}}">
                        </td>
                        <td>
                          <input type="checkbox" class="check1" id="" name="hanca[]" {{ $value['hanca']!=null ? 'checked' : ''}} value="{{$value['id']}}">
                        </td>
                      </tr>
                      @endif
                      @endforeach
                      <tr>
                        ...
                        <td>
                          <input type="number" class="form-control borderInput totalQty" id=""  value="{{collect($data_material)->sum('qty')}}" style="height:37px;margin:-7px 0" readonly>
                        </td>
                        <td></td>
                        <td colspan="3">
                          <input type="number" class="form-control borderInput totalQtySisa" id=""  value="{{collect($data_material)->sum('tersisa')}}" style="height:37px;margin:-7px 0" readonly>
                        </td>
...
<script>
  function jumlahSisa(input){
    const inputQty = document.getElementsByClassName('sumQty'); 
    document.getElementsByClassName('totalQtySisa')[0].value = olahData(document.getElementsByClassName('sumQtySisa'))
    document.getElementsByClassName('totalQty')[0].value = olahData(inputQty)
    const qtyContract =  parseInt(input.nextElementSibling.value); 
    const qtyTersisa =  parseInt(input.value); 
    const qtyTotal = input.closest('td').nextElementSibling.nextElementSibling.querySelector('input'); 
    qtyTotal.value = qtyContract - qtyTersisa
    qtyTotal.value < '0' ?  qtyTotal.style.color = 'red'  :  qtyTotal.style.color = '#2b2b2b'
  }

  function olahData(element){
    let total = 0
