      ...
      <div class="col-xl-3 col-md-6">
        <div class="flat-card pd-flat-card" style="height:156px">
          ...
          <div class="containerGrid">
            <a href="{{ route('invoiceList.detailPackinglistPdf',$collectionData['kode_ekspedisi']) }}" class="btn-merah">Download<i class="fs-18 ml-3 fas fa-file-pdf"></i></a>
        ...
        <div class="cards-18" style="padding:1.5rem">
          <div class="cards-scroll scrollX" id="scroll-bar">
            ...
            <table id="DTtable4" class="table tbl-content-left no-wrap">
                <thead>
                    <tr>                       
                        <th rowspan="2"><div class="mb-3">CARTON NUMBER</div></th> 
                        <th rowspan="2"><div class="mb-3">TOTAL CARTON</div></th>
                        <th rowspan="2"><div class="mb-3">WORK NO</div></th>
                        <th rowspan="2"><div class="mb-3">STYLE NO</div></th>
                        <th rowspan="2"><div class="mb-3">PO NO</div></th>
                        <th rowspan="2"><div class="mb-3">COLOR</div></th>
                        <th colspan="{{ $dataJumlahPerSizeCount }}" class="text-center">SIZE</th>
                        <th rowspan="2"><div class="mb-3">TOTAL QTY</div></th>
                        <th rowspan="2"><div class="mb-3">UNIT OF MESUREMENT</div></th>
                        <th rowspan="2"><div class="mb-3">N.W (KGS)</div></th>
                        <th rowspan="2"><div class="mb-3">G.W (KGS)</div></th>
                    </tr>
                    <tr>
