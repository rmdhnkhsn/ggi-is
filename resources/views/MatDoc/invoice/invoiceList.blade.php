      ...
      <div class="col-12">
        <div class="cards3 py-4 mt-3">
          <ul class="nav nav-tabs orangeTabs">
            ...
            <li class="nav-item-show">
              <a class="nav-link active btnPrevious" data-bs-toggle="tab" href="#Buyer">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="Buyer">
            @include('MatDoc.invoice.components.buyer')
          </div>
          <div class="tab-pane" id="Information">
            @include('MatDoc.invoice.components.information')
          </div>
        </div>
      </div>
    </div>
  ...
  function testing(ID) {
    if(ID){
        ...
        success: function (data) {     
          ...
          $('#finalDes').val(data.partOfDestination)
