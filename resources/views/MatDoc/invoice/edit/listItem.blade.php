      ...
      <div class="col-12">
        <div class="cards3 py-4 mt-3">
          <ul class="nav nav-tabs orangeTabs">
            ...
            <li class="nav-item-show">
              <a href="{{ route('invoiceList.index')}}" class="nav-link">
            ...
            <li class="nav-item-show">
              <a href="{{ route('invoiceList.list-item')}}" class="nav-link active">
                <div class="numberOrange">3</div>
                List Item
              </a>
              <div class="sliderOrange"></div>
            </li>
        ...
        <div class="tab-content">
          <div class="tab-pane active">
            <form  action="{{route('invoiceList.listItemInvoiceEdit',$filter)}}" method="post" enctype="multipart/form-data">
            @csrf
                <input type="hidden" name="id_invoice_detail" value="{{ $filter }}">
                <input type="hidden" name="id_detail" value="{{ $filter }}">
                <div class="row">
                    <div class="col-12">
                        <div class="cardPart">
                                            ...
                                            <table id="DTtable" class="tables3 tbl-content-cost no-wrap">
                                                <thead>
                                                     <tr class="bg-thead2">
                                                        ...
                                                        @if ($data->buyer_detail == 'AGRON, INC.' ||$data->buyer == 'HEXAPOLE COMPANY LIMITED'||$data->buyer == 'TEIJIN FRONTIER CO., LTD SEC. 831')
                                                            <th>WO NUMBER</th>
                                                        @endif
                                                            {{-- marubeni, Hexapole, Marusa, JCP Penney --}}
                                                        @if ($data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer_detail == 'MARUBENI FASHION LINK LTD.'||$data->buyer_detail == 'HEXAPOLE COMPANY LIMITED'||$data->buyer_detail == 'MARUSA Co.,Ltd.'|| $data->buyer_detail == 'JC PENNEY')
                                                            <th>CONTRACT NUMBER</th>
                                                        @endif
                                                         @if ($data->buyer_detail == 'AGRON, INC.' ||$data->buyer == 'MARUBENI CORPORATION JEPANG' ||$data->buyer_detail == 'MARUBENI FASHION LINK LTD.'|| $data->buyer_detail == 'HEXAPOLE COMPANY LIMITED'||$data->buyer_detail == 'MATSUOKA TRADING CO., LTD.'|| $data->buyer_detail == 'MARUSA Co.,Ltd.'|| $data->buyer_detail == 'JIANGSU TEXTILE INDUSTRY' ||$data->buyer_detail == ' TOYOTA TSUSHO CORPORATION' ||$data->buyer == 'YAMATO TRANSPORT (S) PTE LTD'||$data->buyer_detail == 'Ritra Cargo Holland B.V.' ||$data->buyer_detail == 'HONG KONG DESCENTE TRADING LTD.'||$data->buyer_detail == 'HAP., CO LTD' ||$data->buyer_detail == 'EXPRESS, LLC' ||$data->buyer_detail == 'ASMARA INTERNATIONAL LIMITED'|| $data->buyer == 'JC PENNEY'||$data->buyer_detail == 'PENTEX LTD')
                                                            <th>STYLE</th>
                                                        @endif
                                                        ...
                                                        @if ($data->buyer_detail == 'MARUSA Co.,Ltd.' || $data->buyer == 'JC PENNEY')
                                                            <th>ITEM</th>
                                                        @endif
                                                            {{-- Marubeni, Hexapole, Express World --}}
                                                        @if ($data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer == 'MARUBENI FASHION LINK LTD.'|| $data->buyer == 'HEXAPOLE COMPANY LIMITED' || $data->buyer == 'EXPRESS, LLC')
                                                            <th>SIZE</th>
                                                        @endif
                                                            {{-- pentex,HAP, Express World, Asmara Adrenaline --}}
                                                        @if ($data->buyer_detail == 'PENTEX LTD' ||$data->buyer == 'HAP., CO LTD'|| $data->buyer == 'ASMARA INTERNATIONAL LIMITED' || $data->buyer == 'EXPRESS, LLC')
                                                            <th>COLOUR</th>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                            <th>SUB</th>
                                                ...
                                                <tbody>
                                                    @foreach ($data2 as $key =>$value)
                                                        <tr>
                                                            @if ($data->buyer_detail != 'AGRON, INC.' && $data->buyer_detail != 'HEXAPOLE COMPANY LIMITED')
                                                            <input type="hidden" class="form-control border-input" id="wo" name="wo[]" value="{{ $value['wo'] }}" readonly>
                                                            @endif
                                                            <input type="hidden" class="form-control border-input" id="id" name="id[]" value="{{ $value['id'] }}" readonly>
                                                        ...
                                                        @if ($data->buyer_detail == 'MARUSA Co.,Ltd.' || $data->buyer == 'JC PENNEY')
                                                        <td>
                                                            <input type="text" class="form-control borderInput" id="" name="item[]"  value="{{ $value['item'] }}" placeholder="-" style="min-width:250px" required></td>
                                                        @endif
                                                        {{-- Marubeni, Hexapole, Express World --}}
                                                        @if ($data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer == 'MARUBENI FASHION LINK LTD.'|| $data->buyer == 'HEXAPOLE COMPANY LIMITED' || $data->buyer == 'EXPRESS, LLC')
                                                        <td>
                                                        ...
                                                        @endif
                                                        {{-- pentex,HAP, Express World, Asmara Adrenaline --}}
                                                        @if ($data->buyer_detail == 'PENTEX LTD' ||$data->buyer_detail == 'HAP., CO LTD'|| $data->buyer_detail == 'ASMARA INTERNATIONAL LIMITED' || $data->buyer_detail == 'EXPRESS, LLC')
                                                        <td>
                                                             <input type="text" class="form-control borderInput" id="" name="color[]"   value="{{ $value['color'] }}" placeholder="-" style="min-width:250px" required>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                        <td>
                                                            <div class="container-tbl-btn">
                                                                <input type="text" class="form-control borderInput" id="" name="sub[]"   value="{{ $value['sub'] }}" placeholder="-" style="min-width:250px" required>
                                                            </div>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                        <td>
                                                            <div class="container-tbl-btn">
                                                                <input type="text" class="form-control borderInput" id="" name="lp[]"   value="{{ $value['lp'] }}" placeholder="-" style="min-width:250px" required>
                                                            </div>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                        ...
                                                        <td>
                                                            <div class="container-tbl-btn">
                                                                <input type="text" class="form-control borderInput" id="" name="no_of_units[]" value="{{ $value['no_of_units'] }}" placeholder="-" style="min-width:250px">
                                                            </div>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                        ...
                                                        <td>
                                                            <div class="container-tbl-btn">
                                                                <input type="text" class="form-control borderInput" id="" name="cm[]" value="{{ $value['cm'] }}" placeholder="-" style="min-width:250px">
                                                            </div>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                        <td>
                                                            <div class="container-tbl-btn">
                                                                <input type="text" class="form-control borderInput" id="" name="fabric[]" value="{{ $value['fabric'] }}" placeholder="-" style="min-width:250px">
                                                            </div>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'PENTEX LTD')
                                                        <td>
                                                            <div class="container-tbl-btn">
                                                                <input type="text" class="form-control borderInput" id="" name="trims[]" value="{{ $value['trims'] }}" placeholder="-" style="min-width:250px">
                                                            </div>
                                                        </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'AGRON, INC.' ||$data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer_detail == 'MARUBENI FASHION LINK LTD.'|| $data->buyer_detail == 'HEXAPOLE COMPANY LIMITED'||$data->buyer_detail == 'MATSUOKA TRADING CO., LTD.'|| $data->buyer_detail == 'MARUSA Co.,Ltd.'|| $data->buyer_detail == 'JIANGSU TEXTILE INDUSTRY' ||$data->buyer_detail == ' TOYOTA TSUSHO CORPORATION' ||$data->buyer_detail == 'YAMATO TRANSPORT (S) PTE LTD'||$data->buyer_detail == 'Ritra Cargo Holland B.V.' ||$data->buyer_detail == 'HONG KONG DESCENTE TRADING LTD.'||$data->buyer_detail == 'HAP., CO LTD' ||$data->buyer_detail == 'EXPRESS, LLC' ||$data->buyer_detail == 'ASMARA INTERNATIONAL LIMITED'|| $data->buyer_detail == 'JC PENNEY' || $data->buyer_detail == 'TEIJIN FRONTIER CO., LTD SEC. 831' || $data->buyer_detail == 'PENTEX LTD')
                                                            <td>
                                                                <div class="container-tbl-btn">
                                                                    <input type="text" class="form-control borderInput" id="" name="descOfGood[]" value="{{ $value['descOfGood'] }}" placeholder="-" style="min-width:250px" required>
                                                                </div>
                                                            </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'AGRON, INC.' ||$data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer_detail == 'MARUBENI FASHION LINK LTD.'|| $data->buyer_detail == 'HEXAPOLE COMPANY LIMITED'||$data->buyer_detail == 'MATSUOKA TRADING CO., LTD.'|| $data->buyer_detail == 'MARUSA Co.,Ltd.'|| $data->buyer_detail == 'JIANGSU TEXTILE INDUSTRY' ||$data->buyer_detail == ' TOYOTA TSUSHO CORPORATION' ||$data->buyer_detail == 'YAMATO TRANSPORT (S) PTE LTD'||$data->buyer_detail == 'Ritra Cargo Holland B.V.' ||$data->buyer_detail == 'HONG KONG DESCENTE TRADING LTD.'||$data->buyer_detail == 'HAP., CO LTD' ||$data->buyer_detail == 'EXPRESS, LLC' ||$data->buyer_detail == 'ASMARA INTERNATIONAL LIMITED'|| $data->buyer_detail == 'JC PENNEY' || $data->buyer_detail == 'TEIJIN FRONTIER CO., LTD SEC. 831' || $data->buyer_detail == 'PENTEX LTD')
                                                            ...
                                                            <td>
                                                                <div class="container-tbl-btn">
                                                                    <input type="text" class="form-control borderInput" id="" name="hsCode[]" placeholder="-" value="{{ $value['hsCode'] }}" required>
                                                                </div>
                                                            </td>
                                                        @endif
                                                        {{-- agron, marubeni, Hexapole, Teijin, Hongkong, Matsuoka, Jiangsu, Marusa, Toyota, Benlux, HAP, Express World, JCP Penney, Ritra Cargo, Adrenaline --}}
                                                        ...
                                                        @if ($data->buyer_detail == 'AGRON, INC.' ||$data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer_detail == 'MARUBENI FASHION LINK LTD.'|| $data->buyer_detail == 'HEXAPOLE COMPANY LIMITED'||$data->buyer_detail == 'MATSUOKA TRADING CO., LTD.'|| $data->buyer_detail == 'MARUSA Co.,Ltd.'|| $data->buyer_detail == 'JIANGSU TEXTILE INDUSTRY' ||$data->buyer_detail == ' TOYOTA TSUSHO CORPORATION' ||$data->buyer_detail == 'YAMATO TRANSPORT (S) PTE LTD'||$data->buyer_detail == 'Ritra Cargo Holland B.V.' ||$data->buyer_detail == 'HONG KONG DESCENTE TRADING LTD.'||$data->buyer_detail == 'HAP., CO LTD' ||$data->buyer_detail == 'EXPRESS, LLC' ||$data->buyer_detail == 'ASMARA INTERNATIONAL LIMITED'|| $data->buyer_detail == 'JC PENNEY' || $data->buyer_detail == 'TEIJIN FRONTIER CO., LTD SEC. 831' || $data->buyer_detail == 'PENTEX LTD')
                                                            ...
                                                            <td>
                                                                <div class="container-tbl-btn">
                                                                    <input type="text" class="form-control borderInput unitPrice" name="unitPrice[]" value="{{ $value['unitPrice'] }}" placeholder="-" required>
                                                                </div>
                                                            </td>
                                                        @endif
                                                        @if ($data->buyer_detail == 'AGRON, INC.' ||$data->buyer_detail == 'MARUBENI CORPORATION JEPANG' ||$data->buyer_detail == 'MARUBENI FASHION LINK LTD.'|| $data->buyer_detail == 'HEXAPOLE COMPANY LIMITED'||$data->buyer_detail == 'MATSUOKA TRADING CO., LTD.'|| $data->buyer_detail == 'MARUSA Co.,Ltd.'|| $data->buyer_detail == 'JIANGSU TEXTILE INDUSTRY' ||$data->buyer_detail == ' TOYOTA TSUSHO CORPORATION' ||$data->buyer_detail == 'YAMATO TRANSPORT (S) PTE LTD'||$data->buyer_detail == 'Ritra Cargo Holland B.V.' ||$data->buyer_detail == 'HONG KONG DESCENTE TRADING LTD.'||$data->buyer_detail == 'HAP., CO LTD' ||$data->buyer_detail == 'EXPRESS, LLC' ||$data->buyer_detail == 'ASMARA INTERNATIONAL LIMITED'|| $data->buyer_detail == 'JC PENNEY' || $data->buyer_detail == 'TEIJIN FRONTIER CO., LTD SEC. 831' || $data->buyer_detail == 'PENTEX LTD')
                                                        ...
                                                        @endforeach
                                                        <tr>
                                                            @if ($data->buyer_detail == 'AGRON, INC.' )
                                                            <th colspan="5">INVOICE TOTAL</th>
                                                            @elseif ($data->buyer_detail == 'HEXAPOLE COMPANY LIMITED')
                                                            <th colspan="8">INVOICE TOTAL</th>
                                                            @elseif ($data->buyer_detail == 'TEIJIN FRONTIER CO., LTD SEC. 831')
                                                            ...
                                                            <td><input type="text" class="form-control borderInput totalInvoice" name="totalInvoice" id="totalInvoice" placeholder="-" value="{{ $value['totalInvoice'] }}" style="height:37px; width:120px; margin:-7px 0; padding:0 !important;border:none;background:#fff" readonly></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="10">
                                                                <div class="container-tbl-btn">
                                                                    <input type="text" class="form-control readOnlyForm" id="terbilang" value="{{ $value['terbilang'] }}" name="terbilang" style="font-style: italic" readonly>
                                                                </div>
                                                            </td>
                                                        </tr>
    ...
    $(document).ready(function() {
        $(".unitPrice").keyup(function() {
            ...
            function calculateSum() {
                ...
                $("#totalInvoice").val(parseInt(sum.toFixed(2)));
            } 
