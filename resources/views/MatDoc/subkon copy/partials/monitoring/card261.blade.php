<div class="row mt-4">
    <div class="rc-col-2">
        <div class="sb-card2 justify-start p-3">
            ...
            <a href="{{route('subkon.hitung.jaminan',$no_kontrak)}}" class="export-excel"><i class="fas fa-file-excel"></i></a>
        </div>
    </div>
    <div class="rc-col-2">
    ...
    <div class="rc-col-2">
        <div class="sb-card justify-start p-3">
            <div class="keterangan">Qty Contract (262)</div>
    ...
    <div class="rc-col-2">
        <div class="sb-card justify-start p-3">
            <div class="keterangan">Ratio</div>
            <div class="count">{{number_format($Ratio, 2, '.', '')}}</div>
        </div>
    </div>
</div>