<div class="container-tbl-btn" >
    ...
    <div class="dropdown-menu">
        ...
        @if(auth()->user()->role == 'SYS_ADMIN' || auth()->user()->departemensubsub == 'PPIC'|| auth()->user()->departemensubsub == 'EXIM'|| auth()->user()->departemensubsub == 'DOCUMENT')
        ...
        @if($value['status']==0 ||auth()->user()->role == 'SYS_ADMIN')
