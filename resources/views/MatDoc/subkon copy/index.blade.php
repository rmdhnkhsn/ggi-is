...
<style>
  .general-identity-title, .custom-calendar, .input-group-select{
    border-radius : 10px 0px 0px 10px !important;
  }

  .dropdown-menu.show {
    transform  : translate3d(-180px, -100px, 0px) !important; 
  }
  .modal-backdrop {
    z-index: -1;
  }
              ...
              <div class="input-group date relative mt-3" id="download" data-target-input="nearest">
                ...
                <div class="input-group-append datepiker" data-target="#download" data-toggle="datetimepicker">
                  <div class="fa-custom-calendar" >
                    <i class="far fa-calendar-alt mr-2"></i> <span class="fs-14">Date</span><i class="ml-2 fas fa-caret-down"></i>
                  </div>
                </div>
                    <input type="text" name="tgl_awal" value="{{$tgl_awal}}" class="form-control datetimepicker-input input-date-fa" data-target="#download" placeholder="Select Date" />
              </div>
              <div class="input-group date relative mt-3" id="download1" data-target-input="nearest">
                ...
                <div class="input-group-append datepiker" data-target="#download1" data-toggle="datetimepicker">
                  <div class="fa-custom-calendar" >
                    ...
                    <input type="text" name="tgl_akhir" value="{{$tgl_akhir}}" class="form-control datetimepicker-input input-date-fa" data-target="#download1" placeholder="Select Date" />
              </div>
