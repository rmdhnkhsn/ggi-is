...
<head>
    ...
    <body> 
        <tr>
          <td>DATA PENGUSAHA TPB</td>
          <td colspan="11"></td>
          <td>DATA PENERIMA SUBKONTRAK :</td>
        </tr>
        <tr>
          <td>A. NPWP : 31.560.872.9-423.000	</td>
          <td colspan="11"></td>
          <td>A. NPWP : {{$data->npwp}}	</td>
        </tr>
        <tr>
          <td>B. NAMA TPB : PT.GISTEX GARMEN INDONESIA</td>
          <td colspan="11"></td>
          <td>B. NAMA TPB : {{$data->supplier}}</td>
        </tr>
        <tr>
          <td>C. NOMOR SURAT IJIN TPB : {{$data->izintpb}}</td>
          <td colspan="11"></td>
          <td>-</td>
        </tr>
        <tr>
        ...
        <table>
            ...
            @endforeach
            <tr>
                <td colspan="15" style="font-weight:bold;" >Total Jaminan</td>
