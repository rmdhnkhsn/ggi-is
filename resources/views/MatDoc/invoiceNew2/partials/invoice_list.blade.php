                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container-tbl-btn flex gap-2">
                                <a href="" class="btn-icon-blue" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Preview Invoice"><i class="fs-18 fas fa-file-invoice-dollar"></i></a>
                                <a href="" class="btn-icon-green" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Preview Packing List" style="width:35px;height:35px"><i class="fs-18 fas fa-paste"></i></a>
                                <a href="" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Edit Invoice" class="btn-icon-yellow"><i class="fs-18 fas fa-pencil-alt"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
