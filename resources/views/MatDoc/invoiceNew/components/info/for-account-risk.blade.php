...
if ($info_tambahan == null) {
    ...
    $buyer_for = $info_tambahan->buyer_for ?? $info_tambahan->buyer_detail;
    $address_for = $info_tambahan->address_for ?? $info_tambahan->address_cons;
    $country_for = $info_tambahan->country_for ?? $info_tambahan->country;
    $telp_for = $info_tambahan->telp_for ?? $info_tambahan->telp;
    // dd($buyer_for);
}
?>
            ...
            <div class="row mt-2">
                <div class="col-12">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                        ...
                        <input type="text" class="form-control borderInput" id="buyer_detail" value="{{$buyer_for}}" name="buyer_for">
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                        ...
                        <input type="text" class="form-control borderInput" id="address" value="{{$address_for}}" name="address_for" placeholder="Input Address">
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                        ...
                        <input type="text" class="form-control borderInput" id="country" value="{{$country_for}}" name="country_for">
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="input-group flex mt-1 mb-3">
                        ...
                        <input type="text" class="form-control borderInput" id="telp" value="{{$telp_for}}" name="telp_for" placeholder="Input telp/fax">
                    </div>
                </div>
                @endif
                <!-- end  -->
