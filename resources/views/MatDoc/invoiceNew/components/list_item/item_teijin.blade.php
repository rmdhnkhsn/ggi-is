        ...
        <tr>
            ...
            <td>
                ...
                <div class="justify-start">
                  <div>Container No : </div><input type="text" class="form-transparent ml-1" id="no_kontainer" name="no_kontainer[]" value="{{ $value['no_kontainer'] }}" readonly>
                </div>
                <div class="justify-start">
                  <div>Total CTN : </div><input type="text" class="form-transparent ml-1" id="total_ctn" name="total_ctn[]" value="{{ $value['total_ctn'] }}" readonly>
                </div>
            </td>
            <td>
