...
<table id="DTtable" class="tables3 tbl-content-cost no-wrap">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input type="text" class="form-control border-input" id="item" name="item[]" value="{{ $value['item'] }}" style="height:37px; width:150px; margin:-7px 0; padding:0 !important;border:none;background:#fff" readonly></td>
