                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container-tbl-btn flex gap-2">
                                <a href="{{route('invoiceList.preview',$value['invoice_final_id'])}}" class="btn-icon-blue" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Preview Invoice"><i class="fs-18 fas fa-file-invoice-dollar"></i></a>
                                <a href="{{ route('download-packingEkspedisi',$value['invoice_final_id']) }}" class="btn-icon-green" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Preview Packing List" style="width:35px;height:35px"><i class="fs-18 fas fa-paste"></i></a>
                                <a href="{{route('invoiceList.index',$value['invoice_final_id'])}}" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Edit Invoice" class="btn-icon-yellow"><i class="fs-18 fas fa-pencil-alt"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
