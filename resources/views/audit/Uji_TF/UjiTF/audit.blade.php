        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
                <div class="row">
                  <div class="col-12">
                    <h3 class="card-judul text-center">Ledger VS IT INV Pengeluaran</h3>
                  </div>
                </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($records as $key => $value)
                    ...
                    <tr>
                        ...
                        <td>{{ $dp['F4111_GLPT'] }} </td>
                        <td>{{ $dp['F4111_TRDJ'] }}</td>
                        <td>{{ $dp['F564111H_DGL'] }} </td>
                        <td>{{ $dp['F4111_LOTN'] }} </td>
                        <td>{{ $dp['F4111_TRQT'] }} </td>
                        <td>{{ $dp['F4111_TRUM'] }} </td>
                        <td>{{ $dp['F564111H_DSCP2'] }} </td>
                        <td>{{ $dp['F564111H_DSC1'] }} </td>
                        <td>{{ $dp['F4111_USER'] }} </td>
                        <td>{{ $dp['Uji_ITM'] }} </td>
                        <td>{{ $dp['Uji_QTY'] }} </td>
                        <td>{{ $dp['Uji_UOM'] }} </td>
                        ...
                        <!-- <th>{{ $dp['remark'] }} </th> -->
                        <td>
                        <a href="{{route('temuantf.konfir',$key)}}" class="btn btn-primary btn-sm" target="_blank">
  ...
  $(function () {
    $("#example1").DataTable({
      ...
      buttons: [
        {
            extend: 'excelHtml5',
            title: 'Ledger VS IT INV Pengeluaran {{$tgl_awal}} s/d {{$tgl_akhir}}'
        },
        {
            extend: 'pdfHtml5',
            title: 'Ledger VS IT INV Pengeluaran {{$tgl_awal}} s/d {{$tgl_akhir}}'
