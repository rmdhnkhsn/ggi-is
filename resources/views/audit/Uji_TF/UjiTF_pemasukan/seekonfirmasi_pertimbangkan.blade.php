              ...
              <div class="card-header">
                <div class="row">
                  <div class="col-lg-6 col-6">
                    <a href="{{ route('audittfp.dipertimbangkan')}}">
                        <div>
                            <div class="label_ijo">Konfirmasi Anomali FALSE Dipertimbangkan</div>
                            <div class="container btn_ijo"></div>
                        </div>
                    </a>
                  </div>
                  <div class="col-lg-6 col-6">
                    <a href="{{ route('auditna.dipertimbangkan')}}">
                        <div>
                            <div class="label_abu">Konfirmasi Anomali #N/A Dipertimbangkan</div>
