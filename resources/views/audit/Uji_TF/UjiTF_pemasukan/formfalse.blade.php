        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{route('auditpf.get')}}" id="get_data" method="post" enctype="multipart/form-data">
                    @csrf
                        @include('audit.Uji_TF.UjiTF_pemasukan.partials.formf-control', ['submit' => 'Get'])
                </form>
