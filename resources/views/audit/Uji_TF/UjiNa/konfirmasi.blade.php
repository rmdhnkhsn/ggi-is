              ...
              <div class="card-header">
                <div class="row">
                  <div class="col-lg-6 col-6">
                    <a href="{{ route('audittfp.konfir')}}">
                        <div>
                            <div class="label_abu"> Anomali FALSE dikonfirmasi Gudang</div>
                            <div class="container btn_abu"></div>
                        </div>
                    </a>
                  </div>
                  <div class="col-lg-6 col-6">
                    <a href="{{ route('auditna.konfir')}}">
                        <div>
                            <div class="label_ijo"> Anomali #N/A dikonfirmasi Gudang</div>
