        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{route('icr.get.ladger')}}" id="get_data" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                      <button type="submit" class="btn btn-primary btn-block mt-3">Get Data</button>
                    </div>
                </form>
