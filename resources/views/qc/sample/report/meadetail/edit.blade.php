        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('mdetail.update', $detail->report_id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    @include('qc.sample.report.meadetail.partials.form-edit', ['submit' => 'Save'])
                            </form>
