        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('work.update', $data->report_id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    @include('qc.sample.report.workmanship.partials.form-edit', ['submit' => 'Save'])
                            </form>
