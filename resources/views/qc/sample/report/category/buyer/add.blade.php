                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('list_buyer.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        @include('qc.sample.report.category.buyer.partials.form-add', ['submit' => 'Create'])
                                </form>
...
<script>
    ...
    $('.select2bs4_add').on('select2:select', function (e) {
        ...
        $('#kode_buyer').val(data.id);
        $('#nama_buyer').val(data.text);
    });
</script>
