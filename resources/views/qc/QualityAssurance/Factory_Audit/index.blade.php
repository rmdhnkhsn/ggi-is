      ...
      <div class="col-12">
        <div class="cardFlat pt-4">
          ...
          <ul class="nav nav-tabs blue-md-tabs2 mt-4" id="myTab" role="tablist">
            ...
            <li class="nav-item-show">
              <a href="{{ route('qa.factory.index')}}" class="nav-link active"></i>FACTORY AUDIT</a>
              <div class="blue-slide2"></div>
            </li>
            <li class="nav-item-show">
        ...
        <div class="cardPart">
          <div class="cardHead">
            <div class="justifySearch gap-3 p-3">
              <div class="justify-start">
                <div class="title-24-dark2 no-wrap mt-1" style="width:175px"> QA PRE-FINAL</div>
                ...
                <div class="dropdown-menu" role="tablist">
                  ...
                  <button class="dropdown-item anuIeu" data-toggle="tab" href="#FactoryAudit" role="tab">QA FA</button>
                </div>
              </div>
              <div class="margin-search">
                ...
                @include('qc.QualityAssurance.Factory_Audit.filter')
              </div>
            </div>
          </div>
          ...
          <div class="cardBody p-3">
            <div class="tab-content card-block">
              <div class="tab-pane active" id="PreFinal" role="tabpanel">
                @include('qc.QualityAssurance.Factory_Audit.partials.PreFinal')
              </div>
              <div class="tab-pane" id="FactoryAudit" role="tabpanel">
                @include('qc.QualityAssurance.Factory_Audit.partials.FactoryAudit')
              </div>
            </div>
          </div>
        </div>
