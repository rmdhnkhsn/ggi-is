  <div class="row">
    <div class="col-12 pb-5">
      ...
      <div class="card-close-orange mt-2 py-1 px-2">
        <div class="txt-orange">Keterangan : Data dibawah adalah data QC PRE-FINAL / INLINE menunggu untuk diprosess QC FA</div>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="dropdown-menu">
                  <a href="{{ route('go.factory.index')}}" class="dropdown-item">
                    <div style="width:28px"><i class="mr-2 fs-18 far fa-arrow-alt-circle-right"></i></div>Factory Audit
                  </a>
