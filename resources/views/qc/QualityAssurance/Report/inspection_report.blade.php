...
@section("title","FINAL INSPECTION REPORT")
@push("styles")
  ...
  <div class="container-fluid pb-5">
    <div class="row">
      <div class="col-12 text-center mt-3 mb-4">
        <div class="title-24-dark">REPORT FINAL INSPECTION MATSUOKA TRADING CO., LTD. </div>
        ...
        <div class="cardPart">
          <div class="cardHead">
            <div class="justifySearch gap-3 p-3">
              <div class="title-24-dark2 no-wrap mt-1">QA FINAL INSPECTION</div>
                  ...
                  <table id="DTtable" class="tables3 tbl-content-cost no-wrap">
                    <thead>
                      <tr class="bg-thead2">
                        ...
                        <th rowspan="2" class="pdt-tbl">SHIP PERIOD/ TOD</th>
                        ...
                        <th rowspan="2" class="pdt-tbl">SAMPLE SIZE</th>
                        <th rowspan="2" class="pdt-tbl">PASS</th>
                        <th rowspan="2" class="pdt-tbl">FAIL</th>
                        <th rowspan="2" class="pdt-tbl">QTY CHECK (PCS)</th>
                        <th rowspan="2" class="pdt-tbl">QTY CHECK (CTN)</th>
                        <th rowspan="2" class="pdt-tbl">CTN NO</th>
                        <th colspan="12" class="text-center">TYPE OF DEFECT</th>
                        <th rowspan="2" class="pdt-tbl">TOTAL DEFECT</th>
                        <th rowspan="2" class="pdt-tbl">RESULT</th>
