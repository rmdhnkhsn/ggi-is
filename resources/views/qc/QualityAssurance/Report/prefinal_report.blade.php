...
@section("title","PRE-FINAL REPORT")
@push("styles")
  ...
  <div class="container-fluid pb-5">
    <div class="row">
      <div class="col-12 text-center mt-3 mb-4">
        <div class="title-24-dark">REPORT PRE-FINAL MATSUOKA TRADING CO., LTD. </div>
        ...
        <div class="cardPart">
          <div class="cardHead">
            <div class="justifySearch gap-3 p-3">
              <div class="title-24-dark2 no-wrap mt-1">QA PRE-FINAL</div>
