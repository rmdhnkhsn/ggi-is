        ...
        <div class="col-xl-9 mx-auto">
          <div class="cardFlat p-4">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="title-sm">Total Check</div>
                <input type="text" class="form-control borderInput mt-1 mb-3" name="" id="" placeholder="Input Total Check">
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="title-sm">Total Good</div>
                <input type="text" class="form-control borderInput mt-1 mb-3" name="" id="" placeholder="Input Total Good" readonly>
              </div>
              <div class="col-md-6">
                <div class="title-sm">Percentage</div>
                <input type="text" class="form-control borderInput mt-1 mb-3" name="" id="" placeholder="Input %" readonly>
              </div>
              <div class="col-12">
            ...
            <div class="row">
              ...
              <div class="col-12 flex gap-4 mt-4">
                ...
                <button type="submit" class="btn-blue-md saveInspect w-100">Edit Inspection</button>
              </div>
            </div>
          </div>
        </div>
...
<script>
  $('.saveInspect').on('click', function (event) {
    swal({
      ...
      text: 'Data Inspection Diperbaharui',
      button: false,
      timer: 2000
    })
  });
