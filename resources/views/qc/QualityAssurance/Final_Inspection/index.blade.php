      ...
      <div class="col-12">
        <div class="cardFlat pt-4">
          ...
          <ul class="nav nav-tabs blue-md-tabs2 mt-4" id="myTab" role="tablist">
            ...
            <li class="nav-item-show">
              <a href="{{ route('qa.inspection.index')}}" class="nav-link active"></i>FINAL INSPECTION</a>
              <div class="blue-slide2"></div>
            </li>
            <li class="nav-item-show">
        ...
        <div class="cardPart">
          <div class="cardHead">
            <div class="justifySearch gap-3 p-3">
              <div class="title-24-dark2 no-wrap mt-1">FINAL INSPECTION</div>
              <div class="margin-search flex gap-3">
                ...
                @include('qc.QualityAssurance.Final_Inspection.filter')
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12 pb-5">
                ...
                <div class="cards-scroll scrollX" id="scroll-bar">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ route('edit.inspection.index')}}" class="dropdown-item">
                              <div style="width:28px"><i class="mr-2 fs-18 fas fa-pencil-alt"></i></div>Edit Data 
                            </a>
                            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#detailsInspection">
                  ...
                  @include('qc.QualityAssurance.Final_Inspection.details')
                </div>
              </div>
            </div>
          </div>
