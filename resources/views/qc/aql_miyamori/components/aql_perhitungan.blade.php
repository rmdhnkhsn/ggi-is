                  ...
                  <table id="DTtable" class="tables3 table-border table-bg tbl-content-cost no-wrap">
                    <thead>
                      <tr class="bg-thead2">
                        ...
                        <th class="text-center"></th>
                        <th class="text-center" colspan="8">PERHITUNGAN AQL</th>
                        <th class="text-center">色</th>
                        <th class="text-center" colspan="8">HASIL PEMBULATAN AQL</th>
                        <th class="text-center">合計数量</th>
                      </tr>
                      <tr class="bg-thead2">
                        <th class="text-center pdt-tbl" rowspan="2">Color</th>
                        <th class="text-center pdt-tbl" rowspan="2">AQL</th>
                        <th class="text-center pdt-tbl" rowspan="2">%</th>
