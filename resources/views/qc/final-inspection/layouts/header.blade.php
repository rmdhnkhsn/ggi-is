...
<head>
  ...
  <title> GCC [ QC - Final Inspection ]</title>
...
<!-- Daterange picker -->
  ...
  <link rel="stylesheet" href="{{asset('/assets3/plugins/toastr/toastr.min.css')}}">
  <link rel="stylesheet" href="{{asset('/assets3/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">
  <link rel="stylesheet" href="{{asset('/assets3/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css')}}">
  <link rel="stylesheet" href="{{asset('/assets/css/style-inspection.css')}}">
  <link rel="stylesheet" href="{{asset('/assets/css/accord-sub.css')}}">
