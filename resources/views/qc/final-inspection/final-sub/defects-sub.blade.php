...
<link rel="stylesheet" href="{{asset('/common/css/accord-sub.css')}}">
            ...
            <div class="card-accordion">
              <div class="wrapper-accordion">
                <div class="head-defects mb-4 mt-2">
                  <table class="table-header conclusion-content box-shadow">
                    <thead>
                      <tr>
                        ...
                        <div class="col-11 ml-auto mr-auto">
                          <div class="accordion" id="accordionGroup">
                            @foreach ($item as $key2 => $item2)
                              <div class="card defect-sub-menu card-defect mt-4" data-final-inspection-defect-id="{{ $item2->id }}" data-sub-menu-id="{{ $item2->final_submenu_id }}">
                                <a class="card-link collapsed" type="button" data-toggle="collapse" data-target="#collapse1-{{ $item2->final_submenu_id }}" 
                                  ...
                                  <div class="card-header" id="heading1">
                                    <div class="title-headers flex flex-row justify-between py-2">
                                      <div class="acc-title">
                                                ...
                                                <div class="row">
                                                  <div class="col-3 mt-3 ml-2 mr-auto">
                                                   ...
                                                   <div class="col-3 mt-3 ml-2 ml-auto text-right">
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="modalInputPhotoMajor{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}" tabindex="-1" aria-labelledby="modalInputPhotoMajor{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}Label" aria-hidden="true">
                                                      <div class="modal-dialog">
                                                        ...
                                                        >
                                                          ...
                                                          @method('PUT')
                                                          <div class="modal-header">
                                                            <h5 class="modal-title" id="modalInputPhotoMajor{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}Label">INPUT PHOTO</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                              <span aria-hidden="true">&times;</span>
                                                            </button>
                                                          </div>
                                                          <div class="modal-body">
                                                            <div class="row">
                                                              <div class="col-lg-6 mr-auto ml-auto">
                                                                <div class="file-upload">
                                                                  <button class="file-upload-btn mb-3" type="button" onclick="$('.file-upload-input-major{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}').trigger('click')">
                                                                    Add Image
                                                                  </button>

                                                                  <div class="image-upload-wrap-Major">
                                                                    <input class="file-upload-input-major{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}" type="file" id="foto_major" name="foto_major" style="display:none;" onchange="readURL1{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}(this);" accept="image/*" />
                                                                  </div>
                                                                  <div class="file-upload-content{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}">
                                                                    <center>
                                                                    <img class="file-upload-image{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}" src="" width="200px" />
                                                  ...
                                                  <div class="col-3 mt-3 ml-2">
                                                    @if ($item2->foto_major != NULL)
                                                      <a href="{{ asset('storage/'.$item2->foto_major)}}" data-toggle="lightbox" data-title=""data-gallery="gallery" title="View Photo">
                                                        <div class="btn-defects show-photo">
                                                          <i class="far fa-images mr-2"></i>
                                                          Show Photo
                                                        </div>
                                                ...
                                                <div class="row">
                                                 ...
                                                 <div class="col-3 mt-3 ml-2 ml-auto text-right">
                                                    ...
                                                    <div class="modal fade" id="modalInputPhotoMinor{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}" tabindex="-1" aria-labelledby="modalInputPhotoCritical{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}Label" aria-hidden="true">
                                                      <div class="modal-dialog">
                                                        <form action="{{ route('finali.header.updatePhotoHoleMinor', [$inspection->F4801_DOCO, $finalInspection->id, $item2->id]) }}" 
                                                          method="post" class="modal-content" enctype="multipart/form-data"
                                                        >
                                                          @csrf
                                                          @method('PUT')
                                                          ...
                                                          <div class="modal-body">
                                                            <div class="row">
                                                              <div class="col-lg-6 mr-auto ml-auto">
                                                                <div class="file-upload">
                                                                  <button class="file-upload-btn mb-3" type="button" onclick="$('.file-upload-input-minor{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}').trigger('click')">
                                                                    Add Image
                                                                  </button>

                                                                  <div class="image-upload-wrap-Minor">
                                                                    <input class="file-upload-input-minor{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}" type="file" id="foto_minor" name="foto_minor" style="display:none;" onchange="readURL1{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}(this);" accept="image/*" />
                                                                  </div>
                                                                  <div class="file-upload-content{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}">
                                                                    <center>
                                                                    <img class="file-upload-image{{ "_{$item2->final_submenu_id}_{$item2->menu_final_id}" }}" src="" width="200px" />
      ...
      $(this).children().find('div#accordionGroup').children().each(function (idx2, $el2) {
        ...
        $($el2).children().find('#critical-' + subMenuId).each(function(idx3, $el3) {
          ...
          $($el3).find("#kurang").click(function() {
            fetch(`/qcr/inspect/final-inspection/defects/{{ $inspection->F4801_DOCO }}/final/{{ $finalInspection->id }}/inspection-defect/${finalInspectionDefectId}/decrement-critical-defects`, {
              method: 'POST',
          ...
          $($el3).find("#tambah").click(function() {
            fetch(`/qcr/inspect/final-inspection/defects/{{ $inspection->F4801_DOCO }}/final/{{ $finalInspection->id }}/inspection-defect/${finalInspectionDefectId}/increment-critical-defects`, {
              method: 'POST',
              mode: 'cors', // no-cors, *cors, same-origin
              cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
              credentials: 'same-origin', // include, *same-origin, omit
        ...
        $($el2).children().find('#major-' + subMenuId).each(function(idx3, $el3) {
          ...
          $($el3).find("#kurang").click(function() {
            fetch(`/qcr/inspect/final-inspection/defects/{{ $inspection->F4801_DOCO }}/final/{{ $finalInspection->id }}/inspection-defect/${finalInspectionDefectId}/decrement-major-defects`, {
              method: 'POST',
              mode: 'cors', // no-cors, *cors, same-origin
              cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
              credentials: 'same-origin', // include, *same-origin, omit
          ...
          $($el3).find("#tambah").click(function() {
            fetch(`/qcr/inspect/final-inspection/defects/{{ $inspection->F4801_DOCO }}/final/{{ $finalInspection->id }}/inspection-defect/${finalInspectionDefectId}/increment-major-defects`, {
              method: 'POST',
              mode: 'cors', // no-cors, *cors, same-origin
              cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
              credentials: 'same-origin', // include, *same-origin, omit
        ...
        $($el2).children().find('#minor-' + subMenuId).each(function(idx3, $el3) {
          ...
          $($el3).find("#kurang").click(function() {
            fetch(`/qcr/inspect/final-inspection/defects/{{ $inspection->F4801_DOCO }}/final/{{ $finalInspection->id }}/inspection-defect/${finalInspectionDefectId}/decrement-minor-defects`, {
              method: 'POST',
              mode: 'cors', // no-cors, *cors, same-origin
              cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
              credentials: 'same-origin', // include, *same-origin, omit
          ...
          $($el3).find("#tambah").click(function() {
            fetch(`/qcr/inspect/final-inspection/defects/{{ $inspection->F4801_DOCO }}/final/{{ $finalInspection->id }}/inspection-defect/${finalInspectionDefectId}/increment-minor-defects`, {
              method: 'POST',
              mode: 'cors', // no-cors, *cors, same-origin
              cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
              credentials: 'same-origin', // include, *same-origin, omit
