...
<section class="content">
  <div class="container-fluid">  
    <div class="row">
      ...
      @include('qc.smqc.user.kategori.partials.form-modal')
      <div class="col-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="{{route('kategori.delete', $value->id)}}" onclick="return confirm('Delete This Category ?');" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                          @include('qc.smqc.user.kategori.partials.modal-edit')
                        </td>
                    </tr>
                    @endforeach
                </tbody>
