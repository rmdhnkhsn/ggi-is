...
<section class="content">
  <div class="container-fluid">  
    <div class="row">
      ...
      @include('qc.smqc.kain.buyer.partials.form-modal')
      <div class="col-12">
              ...
              <table id="example1" class="table hrd-tbl-content no-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <button data-toggle="modal" data-target="#editBuyer{{$value->id}}" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></button>
                          <a href="{{route('listbuyer.delete', $value->id)}}" onclick="return confirm('Delete This Buyer ?');" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                          @include('qc.smqc.kain.buyer.partials.modal-edit')
                        </td>
                    </tr>
                    @endforeach
                </tbody>
