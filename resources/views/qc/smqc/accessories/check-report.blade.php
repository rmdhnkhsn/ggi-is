    ...
    <div class="row mt-3 pb-5">
      <div class="col-lg-12">
        <div class="cards bg-card p-4">
          Done Report
          <form action="{{route('report_aksesoris.cek_report')}}" method="post" enctype="multipart/form-data">
            @csrf    
            <div class="row">
              <div class="col-12 mt-3">
                <span class="general-identity-title">Date</span>
                    <div class="field2 mt-2">
                      <input type="month" id="date" name="date" value="" placeholder="Insert Date" required>
                    </div>
                </div>
              <div class="col-12 mt-3">
