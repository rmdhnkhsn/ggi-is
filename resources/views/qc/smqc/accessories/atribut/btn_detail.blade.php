...
<td>
    <center>
    <button id="{{$value->id}}" onclick="myFunction(this.id)" class="btn btn-info btn-sm dicobasaja{{$value->id}}" pic-url="{{asset('storage/smqc/accessories/'.$value->detail->file)}}" title="Detail Report"><i class="fas fa-eye"></i></button>
