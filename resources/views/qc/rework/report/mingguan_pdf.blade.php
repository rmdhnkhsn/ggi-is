...
<style>
    ...
    <body> 
        <center><font style="font-weight:bold;font-size:20px;">WEEKLY REPORT QC REWORK</font></center>
        <center><font style="font-weight:bold;font-size:15px;">FACTORY : {{$dataBranch->nama_branch}}</font></center>
        <center><font style="font-weight:bold;font-size:13px;">{{$FirstDate}} s/d {{$LastDate}}</font></center>
        <br>
