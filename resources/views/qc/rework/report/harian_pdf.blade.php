    ...
    <body> 
        ...
        <table style="width:1260px">
            ...
            <tr>
                ...
                <td style="font-weight:bold;">PK / TW</td>
            ...
            <tr>
              <th colspan="26" style="text-align:left;">{{ $no }}. {{$key}}</th>
            </tr>
            @foreach($value as $dp)
            <tr>
            ...
            @if($dt['line'] == $key)
            <tr>
                <td rowspan="2" style="background-color:#DCDCDC;">TOTAL</td>
            ...
            @endforeach
            <tr>
                <td style="background-color:#C0C0C0;" rowspan=2> TOTAL ALL LINE</td>
