                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="overflow:scroll;">
                            <center><h4>WEEKLY REPORT QC REWORK</h4></center>
                            <center><h6>FACTORY : {{$dataBranch->nama_branch}}</h6></center>
                            <center><h6>{{$FirstDate}} s/d {{$LastDate}}</h6></center>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex" style="gap:.6rem">
                                    <form action="{{ route('rmingguan.pdf')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <form action="{{ route('rmingguan.excel')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="FirstDate" id="FirstDate" value="{{$FirstDate}}">
                                        <input type="hidden" name="LastDate" id="LastDate" value="{{$LastDate}}">
                                        <input type="hidden" name="branch" id="branch" value="{{$dataBranch->id}}">
