...
<head>
  ...
  <title>GCC [ QC - Reject Garment ]</title>
  ...
  <script src="{{asset('/assets2/easy-number-separator.js')}}"></script>  
  <script src="{{asset('/assets2/easy-number-separator2.js')}}"></script>  
  <script src="{{asset('/assets2/easy-number-separator3.js')}}"></script>  
  @laravelPWA
</head>
