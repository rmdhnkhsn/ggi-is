                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body" style="overflow:scroll;">
                                  <center><h3 style="font-weight:bold;">DATA REJECT FABRIC & CUTTING / DAY</h3></center>
                                  ...
                                  <table style="width:1300px">
                                      ...
                                      @foreach ($reportHarian as $key => $value)
                                        ...
                                        <tr>
                                          {{-- <td></td> --}}
                                          <td colspan="3" style="background-color:#C0C0C0;">% PERCENTAGE</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_f_misprint'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_f_cacat_tenun'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_f_bolong'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_f_kotor'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_f_lain_lain'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_totalFabric'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_c_pinggir_kain'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_c_tidak_pas_pola'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_c_bolong'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_c_kotor'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_c_lain_lain'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_totalCutting'],2) }}%</td>
                                          <td  style="background-color:#d0d0d0;">{{ round($value['percentage_grandTotal'],2) }}%</td>
                                          <td></td>
                                        </tr>
                                        @endforeach
                                        ...
                                        <tr>
                                          <td colspan="3" style="background-color:#C0C0C0;">TOTAL</td>
