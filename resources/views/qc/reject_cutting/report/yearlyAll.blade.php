                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" style="overflow:scroll;">
                                <center><h4 style="font-weight:bold;">DATA REJECT FABRIC & CUTTING ALL FACILITY</h4></center>
                                ...
                                <div class="row">
                                  <div class="col-md-1 col-6">
                                    <form action="{{ route('RejectCutting.yearlyAllPDF') }}" method="post" enctype="multipart/form-data">
                                        @csrf
