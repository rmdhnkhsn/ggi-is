                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" style="overflow:scroll;">
                                <center><h4 style="font-weight:bold;">DATA REJECT FABRIC & CUTTING / HARI</h4></center>
                                ...
                                <div class="row">
                                  <div class="col-md-1 col-6">
                                    <form action="{{ route('RejectCutting.monthlyPDF') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                  ...
                                  <div class="col-md-1 col-6  ml-5">
                                    <form action="{{ route('RejectCutting.monthlyExcel') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                          <input type="hidden" name="bulan" id="bulan" value="{{$bulan}}">
                                          <input type="hidden" name="branch" id="branch" value="{{ $dataBranch->id }}">
