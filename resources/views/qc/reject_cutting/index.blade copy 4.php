                          ...
                          <div class="modal-body">
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                      <span class="general-identity-title">WO Number</span>
                                        <div class="input-group mb-3 mt-2">
                                          ...
                                          <select class="form-control select-wo select2insidemodal"   id="F4801_DOCO" name="F4801_DOCO" >
                            ...
                            <div class="hide" data-step="2" data-title="Reject">
                              ...
                              <div class="row mb-4 mt-3">
                                <div class="col-lg-12 text-right">
                                  <button type="button" class="btn btn-next store-wo-information" id="wo">Save
                                            ...
                                            <table class="table">
                                             <thead>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    @if(($value5 ['t_v4801c_doco'] ==  $value2['F4801_DOCO']) && ($value5['color'] == $value2['color']) && ($value5['qty_gelar'] == $value2['qty_gelar'])  && ($value5['updated_at'] == $value2['updated_at']))  
                                                    <tr>
                              ...
                              <td>
                                  <form action="{{route ('RejectCutting.update.approve') }}" method="post" enctype="multipart/form-data">
                                    <div class="container-rc-btn">
                                      <a href="javascript:void(0)" class="btn rc-btn-edit update-wo-information mr-1" 
                                      data-id="{{ $value5['id'] }}">Edit<i class="ml-3 fas fa-pencil-alt"></i></a>
                                      @csrf
                                      <input type="hidden" id="id" name="id" value="{{ $value5['id'] }}">
                                      <input type="hidden" id="status" name="status" value="prosess">
                                      <button type="submit" class="btn rc-btn-approve editProduct">Approve<i class="ml-3 fas fa-check"></i></button>
                                    </div>
                                </form>
                              </td>
                            </tr>
                                  ...
                                  <td>  
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="status" name="status" value="waiting">
                                          <button type="submit" class="btn rc-btn-cancel">cancel<i class="ml-1 fas fa-times-circle"></i></button>
                                      </form>
                                    </div>
                                      </td>
                                    </tr>
                    ...
                    <div class="col-xl-6 col-lg-6">
                      <span class="general-identity-title">WO Number</span>
                        <div class="input-group mb-3 mt-2">
                          ...
                          <select class="form-control select-wo" id="update_F4801_DOCO" name="F4801_DOCO" >
                            <option  selected> </option>
                            @foreach($data as $key => $value)
                              <option value="{{$value->F4801_DOCO}}">{{$value->F4801_DOCO}}</option>
                            @endforeach
