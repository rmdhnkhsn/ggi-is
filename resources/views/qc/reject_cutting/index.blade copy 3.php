                          ...
                          @foreach ($dataMenuReject as $key => $value)
                            <tr>
                              ...
                              <td>  
                                ...
                                <td>
                                        <button type="button" class="CRD" data-toggle="modal" data-target="#myModalEdit" title="Create">
                                      ...
                                      <button type="button" class="AVP"  title="Create">
                              ...
                              @foreach ($dataMenuReject as $key => $value)
                                <tr>
                                  ...
                                  <td>  
                                    ...
                                    <td>{{ $value['percentage'] }}%</td>
                                    <td>
                                        <button type="button" class="NOT"  title="Create">
...
function sum() {
  ...
  <script>
    ...
    function showUpdateWoInformation(id_wo) {
      $.ajax({
        data: {
          id_wo: id_wo,
        },
