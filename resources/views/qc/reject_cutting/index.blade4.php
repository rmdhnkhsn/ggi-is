                          ...
                          <div class="modal-body">
                            ...
                            <div class="hide" data-step="1" data-title="General Identity">
                              ...
                              <div class="row">
                                ...
                                <div class="col-6">
                                  <span class="general-identity-title">Quantity / Check</span>
                              ...
                              <div class="row line-2" id="F560020_SIZE55"></div>
                              <div class="row">
                                <div class="col-6">
                              ...
                              <td>
                                  ...
                                  data-wo_id="{{ $value5['t_v4801c_doco'] }}">Update</a> --}}
                                    <form action="{{route ('RejectCutting.update.approve') }}" method="post" enctype="multipart/form-data">
                                          <a href="javascript:void(0)" class=" btn btn-primary btn-sm update-wo-information"                                       data-wo_id="{{ $value5['t_v4801c_doco'] }}">
                                          @csrf
                                         Update</a>
                                          @csrf
                                          <input type="hidden" id="id" name="id" value="{{ $value5['id'] }}">
                                          <input type="hidden" id="status" name="status" value="prosess">
                                          <button type="submit" class="btn btn-success btn-sm editProduct"><i class="fas  fa-times-circle"></i>Approve</button>
                                    </form>
                              </td>
                            </tr>
                          @endforeach
            ...
            <div class="hide_0" data-step="1" data-title="General Identity">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      ...
                      <div class="field mt-2">
                          <input type="text" id="update_qty_check" name="qty_check" placeholder="Wo Number" value="0" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row line-2" id="update_F560020_SIZE55"></div>
                  <div class="row">
                    <div class="col-lg-12 text-right py-3 mt-4">
