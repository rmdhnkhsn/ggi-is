    ...
    <div class="row">
      <a href="{{ route('qc-cutting')}}" class="column-2">
        <div class="cards nav-card bg-card-active h-95 p-3">
          <div class="row">
            <div class="col-12">
              <i class="icons-active fas fa-file-signature"></i>
              <div class="desc-active">Cek Marker</div>
            </div>
          </div>
        </div>
      </a>
        ...
        <div class="cards p-4">
          <div class="row">
            <div class="col-12 justify-sb">
              <div class="title-20 title-hide">Data Check Marker</div>
              <div class="flexx" style="gap:.6rem">
                ...
                @include('qc.qc-cutting.partials.cek-marker.add-data')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container-tbl-btn">
                                ...
                                @include('qc.qc-cutting.partials.cek-marker.ratio')
                            </div>
                        </td>
                        <td>2 Way Cut</td>
                        <td>2</td>
                        ...
                        <td>
                            <div class="container-tbl-btn">
                                ...
                                @include('qc.qc-cutting.partials.cek-marker.update-data')
                            </div>
                        </td>
                    </tr>
                  </tbody>
