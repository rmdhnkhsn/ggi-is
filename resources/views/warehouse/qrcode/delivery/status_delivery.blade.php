@extends("layouts.app")
@section("title","Warehouse - Subcont Delivery")
@push("styles")
...
<section class="content">
  <div class="container-fluid">
      ...
      <a href="{{ route('warehouse-delivery') }}" class="column-2">
        <div class="cards nav-card bg-card-active h-95 p-3">
          <div class="row">
            ...
            <div class="col-12">
              <div class="desc-active">Menu Delivery</div>
            </div>
          </div>
        </div>
      </a>
      <a href="{{ route('warehouse-receiving') }}" class="column-2">
        <div class="cards nav-card h-95 p-3">
          <div class="row">
            ...
            <div class="col-12">
              <div class="desc">Menu Receiving</div>
            </div>
          </div>
        </div>
      </a>
    ...
    <div class="row pb-4">
      ...
      <div class="col-lg-3 sr-notification">
        <div class="cards-18" style="max-height:855px; padding:1.3rem">
          <div class="row">
            <div class="col-12 mb-2">
              ...
              <a href="{{route('delivery-details')}}" class="btn-blue-md store-qr-code"><span class="text-truncate">Create QRcode</span></a> 
            </div>
...
<script>
  ...
  $('body').on('click', '.search-delivery-detail', function () {
    ...
    $.ajax({
      url: '{{ url("/war/verify-valid-buyer") }}/'+number_contract+"/"+transaction_date,           
      type: "get",
      dataType: 'json',            
      success: function (data) {
  ...
  <script>
    window.onload = function() {
      swal({
        ...
        text: 'Tidak Di Temukan No Kontrak Yang DiCari !',
