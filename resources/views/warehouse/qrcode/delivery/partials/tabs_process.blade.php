                        ...
                        @foreach ($data->where('status',2) as $k=>$v)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="container-tbl-btn d-inline-block">
                                        <a href="{{route('warehouse-qrcodeID',$v->id)}}" class="btn-icon-hijau" target="_blank" title="Print QRCode"><i class="fas fa-print"></i></a>
                                    </div>
                                    <div class="container-tbl-btn d-inline-block">
                                        <a href="{{route('warehouse-detailsid',$v->id)}}" class="btn-icon-yellow" target="_blank" title="Edit"><i class="fas fa-chevron-right"></i></a>
                                    </div>
                                </td>
