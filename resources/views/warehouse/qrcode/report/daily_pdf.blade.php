                          ...
                          <div class="card">
                              <div class="card-body" style="overflow:scroll;">
                                 {{-- @if($status_delivery =='DELIVERY')
                                    <center><h3 style="font-weight:bold;">REPORT HARIAN [PENERIMAAN] [MATERIAL/BARANG JADI/MESIN-SPAREPART</h3></center>
                                  @elseif($status_delivery =='RECEIVING') --}}
                                    <center><h3 style="font-weight:bold;">REPORT HARIAN [PENGIRIMAN] [MATERIAL/BARANG JADI/MESIN-SPAREPART</h3></center>
                                  {{-- @endif --}}
                                  ...
                                  <table style="width:1300px">
                                    <tr>
                                      ...
                                      <td style="font-weight:bold;padding-right:15px;padding-left:15px;">NO BOX</td>
                                      <td style="font-weight:bold;padding-right:15px;padding-left:15px;">DOC NUMBER</td>
                                      <td style="font-weight:bold;padding-right:15px;padding-left:15px;">DESC 1</td>
                                      <td style="font-weight:bold;padding-right:15px;padding-left:15px;">DESC 2</td>
