...
<section class="content">
  <div class="container-fluid">
    <div class="row pb-4">
        ...
        <div class="cards-18" style="padding:2rem">
          <ul class="nav nav-tabs sch-md-tabs mb-4" role="tablist">
            <li class="nav-item-show">
              <a class="nav-link relative active" onclick="PLClass()" bagian="request" data-toggle="tab" href="#list" role="tab"></i>
                ...
                <span class="tabs-badge">{{ $countFull }}</span>
                @else
                <span class="tabs-badge">{{ $jumlahcilenyi }}</span>
                @endif
              </a>
            ...
            <li class="nav-item-show">
              <a class="nav-link relative" onclick="dailyClass()" data-toggle="tab" href="#daily" role="tab"></i>
                ...
                <span class="tabs-badge">{{ $dataExpedisiCount }}</span>
              </a>
              <div class="sch-slide"></div>
            </li>
          </ul>
          <div class="tab-content card-block">
            <div class="tab-pane active" id="list" role="tabpanel">
                @include('warehouse.expedition2.packing_list.partials.packing_list')
            </div>
            <div class="tab-pane" id="daily" role="tabpanel">
                @include('warehouse.expedition2.packing_list.partials.daily_target')
            </div>
          </div>
      ...
      <div class="col-12">
        <div id="hidden" class="cards-18" style="padding:2rem">
          <div class="tab-content card-block">
            <div class="tab-pane active" id="list" role="tabpanel">
                @include('warehouse.expedition2.packing_list.partials.list_invoice')
            </div>
          </div>
        </div>
      </div>
