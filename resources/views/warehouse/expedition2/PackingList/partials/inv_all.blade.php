...
<div class="row">
    <div class="col-12 pb-5">
        <div class="cards-scroll scrollX" id="scroll-bar">
            ...
            <table id="DTtable4" class="table tbl-content-left">
                <thead>
                    <tr>
                        <th>ID</th>    
                        <th>Tanggal</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex" style="gap:.35rem;margin:-6px 0">
                                <a href="{{ route('download-packingEkspedisi', $key) }}" class="btn-simple-info"><i class="fas fa-info"></i></a>
                                @if(auth()->user()->departemensubsub != 'EXIM')
                                <a href="{{ route('edit-details',$key) }}" class="btn-simple-edit"><i class="fas fa-pencil-alt"></i></a>
                                @endif
