...
<thead class="bg-thead">
    <tr>      
        ...
        <th rowspan="2" style="font-weight:bold;text-align:center;width:50px;background-color:#C0C0C0;"><div class="mb-3">WAREHOUSE</div></th>
        @endif
        <th rowspan="2" style="font-weight:bold;text-align:center;width:50px;background-color:#C0C0C0;"><div class="mb-3">Contract No.</div></th>
        <th rowspan="2" style="font-weight:bold;text-align:center;width:50px;background-color:#C0C0C0;"><div class="mb-3">Style#</div></th>
        <th rowspan="2" style="font-weight:bold;text-align:center;width:50px;background-color:#C0C0C0;"><div class="mb-3"> Description</div></th>
