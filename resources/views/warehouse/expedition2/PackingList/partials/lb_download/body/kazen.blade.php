...
<tbody>
    ...
    <tr>
        ...
        ?>
        <td style="text-align:center;width:30px;">{{$jumlahnya}}</td>
        @endforeach
...
<tr>
    ...
    <td colspan="3" style="font-weight:bold;text-align:center;background-color:#f0f0f0;"></td>
    <?php
        $sizeperWo = [];
    ...
    @foreach($jenisSize as $key6 => $value6)
        ...
        ?>
        <td style="font-weight:bold;text-align:center;background-color:#f0f0f0;width:30px;">{{$sizeAkhir}}</td>
    @endforeach
