              ...
              <div class="col-12">
                <div class="card">
                    <div class="card-body" style="overflow:scroll;">
                      <center><h3 style="font-weight:bold;font-size:20px;"> MONTHLY REPORT TICKET IT DT </h3>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tr>
                          <th style="background-color:#DCDCDC;" colspan="2" style="font-weight:bold;"> Support</th>
