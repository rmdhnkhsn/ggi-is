      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 justify-start">
            <a href="{{ route('error.it.create')}}" class="btn-blue-md">Add New<i class="fs-18 ml-2 fas fa-plus"></i> </a>
          </div>
                        ...
                        <tbody>
                          ...
                          <?php $no++;?>
                              <tr>
                                ...
                                <td>{{ $value['bagian'] }}</td>
                                <td>
                                  <div class="container-tbl-btn-sm flex" style="gap:.5rem">
                                    <a href="{{route('error.it.sub', $value['id'])}}" class="btn-simple-edit" title="edit">
                                      <i class="fas fa-pencil-alt"></i></a>
                                    </a>
                                    @if($value['sub_error']=='0')
                                    <a href="{{route('error.it.delete', $value['id'])}}" class="btn-simple-delete" title="Delete">
