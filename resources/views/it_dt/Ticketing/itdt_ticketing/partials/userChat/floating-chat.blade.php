    ...
    <div class="floating-legends fade-Out">
        ...
        <div class="tab-content" id="tab-content">
            <div class="tab-pane" id="noHistory" role="tabpanel">
                <div class="floating-header" style="width:370px">
                ...
                <div class="buttonBottom">
                    <div class="relative">
                        <a href="#kategori" class="btn-blue-md" aria-controls="kategori" role="tab" data-toggle="tab">Send Massage<i class="fs-20 ml-2 fas fa-paper-plane"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane" id="document" role="tabpanel">
                ...
                <input type="text" class="form-control chatSearch search-joborientation search2" placeholder="search documents...">
                <div class="cards-scroll mt-3 pr-1 scrollY list-joborientation" id="scrollBlue" style="height:250px">
            ...
            <div class="tab-pane" id="directChat" role="tabpanel">
                ...
                <form id="formSubmitMessage">
                    ...
                    <div class="bottomChat">
                        <div class="relative">
                            <div class="sendChat">
                                <input type="text" class="form-control message" name="message"  id="write" placeholder="ketik pesan...">
