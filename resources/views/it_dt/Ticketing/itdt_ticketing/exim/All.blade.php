                ...
                <div class="cards p-4">
                    <div class="row">
                        <div class="col-12 justify-sb2">
                            <div class="title-20 text-left">Monitoring Import</div>
                            <div class="filterSMV flexx gap-2">
                                ...
                                <form action="{{route('export.ticket.docall')}}" class="flex gap-2" method="post" enctype="multipart/form-data">
                                    @csrf
...
<script>
    ...
    $("#filter_date").on("change.datetimepicker", ({date}) => {
        ...
        console.log(result);
        location.replace("{{ url('/itd/ticket/all-doc?date=')}}"+result) 
    })
  });
</script>
@endpush