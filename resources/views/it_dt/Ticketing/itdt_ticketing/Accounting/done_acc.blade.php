                        ...
                        <div class="col-12 mt-2">
                            <ul class="nav nav-tabs sch-md-tabs mb-4" id="myTab" role="tablist">
                                <li class="nav-item-show">
                                    <a class="nav-link relative active" data-toggle="tab" href="#waiting" role="tab"></i>
                                        <i class="fs-28 fas fa-user-check "></i>
                                ...
                                <li class="nav-item-show">
                                    <a class="nav-link relative" data-toggle="tab" href="#process" role="tab"></i>
                                        <i class="fs-28 fas fa-user-slash"></i>
                            ...
                            <div class="tab-content card-block">
                                <div class="tab-pane active" id="waiting" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 justify-sb2">
                                            <div class="title-20">Ticketing Done</div>
                                            <div class="filterSMV flexx gap-2">
                                                ...
                                                <form action="{{route('export-ticket-acc')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="tgl_awal" value="{{$tgl_awal}}">
                                                    <input type="hidden" name="tgl_akhir" value="{{$tgl_akhir}}">
                                                    <button type="submit" class="btn-icon-hijau" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Export Excel"><i class="fs-18 fas fa-file-excel"></i></button>
                                                </form>
                                                <form action="{{route('export-ticket-acc-tfr')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="tgl_awal" value="{{$tgl_awal}}">
                                                    <input type="hidden" name="tgl_akhir" value="{{$tgl_akhir}}">
                                                    <button type="submit" class="btn-icon-hijau" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Export Excel Transfer"><i class="fs-18 fas fa-file-excel"></i></button>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="process" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 justify-sb2">
                                            <div class="title-20">Ticketing Reject</div>
                                            <div class="filterSMV flexx gap-2">
                                                <div class="input-group justify-center" id="filter_date">
                                                    <div class="sub-title-14 mr-2 title-hide">Show : </div>
                                                    <div class="input-group-prepend">
                                                ...
                                                <div class="btnExport">
                                                    <button type="button" class="btn-icon-hijau exportExcel" onclick="test(this)" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Export Excel"><i class="fs-18 fas fa-file-excel"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 pb-5">
...
<script>
    function test(button) {
        ...
        if (button.classList.contains('exportExcels')) {
            tombol[0].click();
        } else if (button.classList.contains('exportExcel')) {
            tombol[1].click();
        }
    }
</script>
