...
@foreach($TiketPendingIT as $key => $value)
            ...
            <tr>
                ...
                <td width="70%" class="tbl2">
                    <div class="justify-start" style="gap:.8rem">
                        <a href="" data-toggle="modal" data-target="#solvedPending{{$value['id']}}" class="btn-green-md" style="width:140px">Solved</a>
                            @include('it_dt.Ticketing.itdt_ticketing.partials_admin.modal.respon_pending')
