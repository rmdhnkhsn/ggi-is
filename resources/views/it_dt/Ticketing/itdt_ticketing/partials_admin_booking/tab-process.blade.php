        ...
        <div class="accordion_content borderTop">
            <table class="tables2">
                ...
                <tr>
                    ...
                    <a href="" class="" data-toggle="modal" data-target="#process{{ $value['booking_id'] }}">{{ $value['datawaktu'] }} Hour</a>
                        <div class="modal fade" id="process{{ $value['booking_id'] }}" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
