@foreach($TiketCancelBooking as $key => $value)
            ...
            <table class="tables2">
                ...
                <tr>
                    ...
                    <td width="70%" class="tbl2">
                        <a href="" class="" data-toggle="modal" data-target="#cancel{{ $value['booking_id'] }}">{{ $value['datawaktu'] }} Hour</a>
                        <div class="modal fade" id="cancel{{ $value['booking_id'] }}" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
                ...
                <tr>
                    <td width="30%" class="tbl1">Remark</td>
                    <td width="70%" class="tbl2">{{$value['remark_cancel'] }}</td>
                </tr>
            </table>
