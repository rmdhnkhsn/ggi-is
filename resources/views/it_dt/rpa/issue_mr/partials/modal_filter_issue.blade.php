<div class="modal fade" id="ReportIssueMR" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:630px">
        <div class="modal-content p-4" style="border-radius:10px">
            <form action="{{ route('rpa.issue_mr.issue_report')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <span class="general-identity-title">NO WO</span>
                        <div class="mt-1 mb-3">
...
<div class="modal fade" id="ReportMRDirect" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:630px">
        <div class="modal-content p-4" style="border-radius:10px">
            <form action="{{ route('rpa.issue_mr.issue_report')}}" method="post" enctype="multipart/form-data">
                @csrf
