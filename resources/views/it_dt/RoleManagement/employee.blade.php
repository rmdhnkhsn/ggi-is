...
<section class="content relative o-hidden">
  <div class="container-fluid role">
    <div class="row pb-5" style="padding-top:4rem">
        ...
        <div class="justify-start2 gap-8 mt-4">
          ...
          <ul class="nav navBlue">
            <div class="cards-scroll scrollX justify-start" id="scrollBlue">
              ...
              <li class="nav-item-show">
                <a href="{{ route('employee.management.index')}}" class="nav-link active"></i>Employee</a>
              </li>
              <li class="nav-item-show">
                <a href="{{ route('position.management.index')}}" class="nav-link"></i>Position</a>
              </li>
            </div>
          </ul>
        </div>
        <div class="cards-part mt-3" style="z-index:9">
          <div class="cards-head">
            <div class="joblist-date">
              <div class="title-20-dark-blue2 fw-5 no-wrap">Employee</div>
              <div class="flex gap-3">
                <a href="" class="btn-blue-md no-wrap" data-toggle="modal" data-target="#addEmployee">Add <span class="title-none ml-1">Employee</span> <i class="fs-18 ml-2 fas fa-plus"></i></a>
                @include('it_dt.RoleManagement.partials.employee.addEmployee')
      ...
      @include('it_dt.RoleManagement.partials.employee.canvasEmployee')
    </div>
  </div>
