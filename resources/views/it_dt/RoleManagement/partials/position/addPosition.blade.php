<div class="modal fade" id="addPosition" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:650px">
    <div class="modal-content p-4" style="border-radius:10px">
      <div class="row">
        <div class="col-12 justify-sb">
          <div class="title-18">Add Position</div>
        ...
        <div class="col-12">
          ...
          <div class="input-group flex mt-1 mb-3">
            ...
            <select class="form-control borderInput select2bs4 pointer" id="" name="" required>
              ...
              <option name="Kabag">Kabag</option>    
              <option name="Manager">Manager</option>    
            </select>
          </div>
        </div>
        <div class="col-12">
            <a href="" class="btn-blue-md">Save</a>
        </div>
      </div>
    </div>
  </div>
