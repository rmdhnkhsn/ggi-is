          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <a href="{{ route('cc2.rework', $dataBranch->id) }}" class="col-lg-2">
                    <div class="info-box bg-gradient-primary">
                      <span class="info-box-icon"><i class="far fa-flag"></i></span>
                      <div class="info-box-content">
                        <span class="info-box-text" style="font-weight:bold;font-size:16px;">ALL LINE</span>
                        <span class="info-box-number" style="font-weight:bold;font-size:12px;">TOT REWORK : <br>{{$px_total_reject['p_total_reject']}}</span>
                        <div class="progress">
                  ...
                  <a href="{{route('cc2.lines', $ml['id_line'])}}" class="card col-lg-2" style="padding-top:13px" id="example2">
                  @else
