      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-6 col-md-12 col-sm-12">
            <div class="cards bg-card p-3 h-330">
              <span class="card-tittle-repair"><center>Last 30 days Repair Data</center></span>
                <div class="card-block p-3" style="height: 260px; width: 100%;">
          ...
          <div class="col-xl-6 col-md-12 col-sm-12">
            <div class="cards bg-card p-3 h-330">
                <div class="col-12 ml-auto mr-auto">
                    <span class="card-tittle-repair"><center>{{$dataBranch->branchdetail}} Repair {{$tgl_grafik['dataBulan1']}} {{$tgl_grafik['tahun1']}} - {{$tgl_grafik['dataBulan2']}} {{$tgl_grafik['tahun2']}}</center></span>
            ...
            <div class="col-xl-7">
                <ul class="nav nav-tabs md-tabs mb-4" role="tablist">
                    <li class="nav-item-show">
                        <a class="nav-link py-2 active" data-toggle="tab" href="#waiting" role="tab"></i>Waiting<span class="number-badge">{{$total_tiket['waiting']}}</span></a>
                        <div class="slide"></div>
                    </li>
                    <li class="nav-item-show">
                        <a class="nav-link py-2" data-toggle="tab" href="#process" role="tab"></i>Process<span class="number-badge">{{ $total_tiket['proggres'] }}</span></a>
                        <div class="slide"></div>
                    </li>
                    <li class="nav-item-show">
                        <a class="nav-link py-2" data-toggle="tab" href="#pending" role="tab"></i>Pending<span class="number-badge">{{ $total_tiket['pending'] }}</span></a>
                        <div class="slide"></div>
                    </li>
                </ul>
                    ...
                    @if($value['judul'] == 'Software')
                        ...
                        <div class="accordion__content border-top">
                          <table class="tables title-content">
                            ...
                            <tr>
                                <td width="35%">Description Error</td>
                                <td width="65%">{{ $value['deskripsi'] }}</td>
                            </tr>
                            <tr>
                                <td width="35%">Create Date</td>
                    ...
                    <div class="accordion__item">
                        ...
                        <div class="accordion__content border-top">
                          <table class="tables title-content">
                            ...
                            <tr>
                                <td width="35%">IT Support</td>
                                <td width="65%">{{ $value['petugas'] }}</td>
                            </tr>
                            <tr>
                                <td width="35%">Start Process</td>
                    ...
                    <div class="accordion__item">
                        ...
                        <div class="accordion__content border-top">
                          <table class="tables title-content">
                            ...
                            <tr>
                                <td width="35%">Problem Category</td>
                            ...
                            <tr>
                                <td width="35%">Pending Date</td>
                                <td width="65%">{{ $value['tgl_pending'] }}</td>
                            </tr>
                            <tr>
                                <td width="35%">Pending Description</td>
                                                        ...
                                                        <div class="col-12">
                                                            <table class="info-content">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="60%">2022-01-11 11:06:53</td>
                                                                </tr>
                                                            </table>
                                                        </div>  
                                                    </div>  
