    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          @endforeach
            <a href="{{ route('cc.dt.ticketing')}}"class="col-lg-3 col-xl-2 col-md-6 mb-4">
              <div class="adt-box2">
                <div class="icon-box">
                  <i class="fas fa-receipt"></i>
                </div>
                <span class="ledgerVS">DT Ticketing</span>
              </div>
            </a>
        </div>
        <div class="row">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-5">
                <div class="cards card-finish-detail h-400F scrollY">
                    <div class="row py-4">
