<div class="modal fade" id="filter" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:500px">
        <div class="modal-content" style="border-radius:10px">
            <form action="{{route('cc.production.monitoring.filter', $id)}}" method="post" enctype="multipart/form-data" class="flexx" style="gap:.7rem;width:100%">
                @csrf
                <div class="row p-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group flex mt-1 mb-3">
                            ...
                            <input type="hidden" class="form-control border-input-10" name="id" value='{{$id}}' style="height:38px" required>
