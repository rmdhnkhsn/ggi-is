  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-12 justify-sb mb-4">
            ...
            @elseif($comcent=='false')
                @include('CommandCenter2.production.monitoring.partials.modal-filter-dashboard')
            @endif
        </div>
    ...
    <div class="row">
        ...
        <div class="column-5">
            <a href="{{route('performance.product.index')}}">
                <div class="navCard">
                    <div class="icons">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <div class="navCards" style="padding:1.8rem;border-radius:20px;height:375px">
                            ...
                            <div class="chartContainer ">
                                <div class="justify-sb">
                                    <div class="chartHeader">
                                        ...
                                        <div class="txt2"><span class="fw-5">{{$value['buyer']}} {{$value['style']}}</span></div>
                                    </div>
                ...
                <div class="date" style="margin-top : -16px">{{$nama_bulan}}</div>
            </div>
        </div>
    </div>
  </div>
