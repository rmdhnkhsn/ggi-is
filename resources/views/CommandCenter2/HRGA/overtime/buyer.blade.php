        ...
        <div class="justify-start2 gap-4">
          ...
          <ul class="nav navBlue">
            <div class="cards-scroll scrollX justify-start" id="scrollBlue">
              ...
              <li class="nav-item-show">
                <a class="nav-link active" href="{{ route('cc.overtime.buyer')}}"></i>Buyer</a>
              </li>
              <li class="nav-item-show">
        ...
        <div class="cards-part br-20 relative stacking mt-3">
          <div class="cards-head br-20-top">
            <div class="justify-sb3">
              <div class="title-16-dark-blue2 text-center">TOP 10 Buyer with the most overtime hours</div>
          ...
          <div class="cards-body br-20-bot p-3">
            <ul class="containerList" id="scroll-bar2">
              <li class="list">
                ...
                <div class="name2">
                  <div class="title-16-dark3">CHARMING SHOPPES, INC</div>
              ...
              <li class="list">
                ...
                <div class="name2">
                  <div class="title-16-dark3">MARUBENI INDONESIA CORPORATION</div>
              ...
              <li class="list">
                ...
                <div class="name2">
                  <div class="title-16-dark3">NISHIMAYA.CO.,LTD</div>
                  <div class="title-14-dark"><span class="fw-500 mr-1">Cost :</span> Rp. 90.000.000,-</div> 
                </div>
                <div class="time">
                  <div class="title-12-grey">Jam Lembur</div>
              ...
              <li class="list">
                ...
                <div class="name2">
                  <div class="title-16-dark3">CONTEMPO FASHION LTD</div>
              ...
              <li class="list">
                ...
                <div class="name2">
                  <div class="title-16-dark3">SHANGHAI DOUBLEGULL TEXTILE CO., LTD</div>
