    ...
    <div class="container-fluid">
      ...
      <div class="row">
            ...
            <div class="row px-2">
              <div class="col-5">
                <div class="row">
                  <div class="col-12">
                    <center>
                      @if($px_total_reject['p_total_reject'] == 0)
                      <div class="container-knob-rework">
                        <input class="dial" data-displayPrevious=true data-fgColor="#0CAE63" data-skin="tron" data-width="100" data-thickness=".22" data-height="100" value="{{$px_total_reject['p_total_reject']}}" disabled>
                      </div>
                      @else
                      <div class="container-knob-rework">
                        <input class="dial" data-displayPrevious=true data-fgColor="#FB5B5B" data-skin="tron" data-width="100" data-thickness=".22" data-height="100" value="{{$px_total_reject['p_total_reject']}}" disabled>
                      </div>
                      @endif
                    </center>
                  </div>
              ...
              <div class="col-7">
                <div class="row">
                  <div class="col-10 border-bot2 ml-auto mr-auto pt-4">
                    <span class="branch-lines2">All Line CLN</span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-10 ml-auto mr-auto content-branch-lines2">
                    <span>Production : {{$px_total_reject['total_check']}} Pcs</span><br>
                    <span>Target : {{$px_total_reject['target_wo']}} Pcs</span><br>
        ...
        <a href="{{route('cc2.lines', $ml['id_line'])}}" class="col-xl-3 col-md-6">
          <div class="cards card-rework">
            @if($ml['terpenuhi'] == $ml['target'] && $ml['id_line'] == $id_line)
            <span class="fulfilled2"><span class="finish-text2">Good</span></span>
            @elseif($ml['terpenuhi'] == $ml['target'] && $ml['id_line'] != $id_line)
              ...
              <div class="col-7 border-donut ml-auto mr-auto">
                <table class="table-rework">
                  <tr>
                    ...
                    <td width="40%">: {{$x_terpenuhi}} Pcs</td>
                    <td width="4%"></td>
                  </tr>
                  <tr>
                    <td width="4%"></td>
                    <td width="52%">Target</td>
                    <td width="40%">: {{$x_target}} Pcs</td>
                    <td width="4%"></td>
                  </tr>
                  <tr>
                    <td width="4%"></td>
                      ...
                      <div class="skill-bars">
                        <div class="bar">
                          <div class="progress-line">
                              ...
                              @endif
                            <!-- <span class="bar100" style="width: 80%;">
                              <span class="percent-bar100"></span>
                            </span> -->
