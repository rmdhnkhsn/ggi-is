      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="cards bg-card p-4">
                ...
                <span class="adt-anom-details">Anomali Pemasukan Details</span>
                <div class="row mt-2">
                <div class="col-12 text-center">
                    ...
                    <tbody>
                        ...
                        @foreach($pemasukanF as $key=>$value)
                        <tr>
                            <td>
                                <a class="adt-modal-details" data-toggle="modal" data-target="#anomali-details{{$value['F564111C_UKID']}}" title="View Info">
                                {{$value['F564111C_UKID']}}
                                </a>

                                <div class="modal fade" id="anomali-details{{$value['F564111C_UKID']}}" tabindex="-1" role="dialog" aria-labelledby="modal-infoLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="adt-no-daftar-user">
