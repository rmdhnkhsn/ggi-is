...
@section("content")
    ...
    <section class="content f-poppins">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <a href="{{ route('cc.icr.ledge-it', $Branch->id)}}" class="col-xl-3 col-md-6 col-sm-12 mb-adt">
            <div class="cards bg-card h-80">
              <div class="adt-kotak-anom">
                <div class="adt-count">{{$jml_anomali_alluser['total']}}</div>
            ...
            <div class="cards bg-card p-3 h-630">
              ...
              <div class="row">
                <div class="col-12 justify">
                  ...
                  <a href="{{ route('cc.icr.ledge-it.pemasukanU',[$Branch->id, $user])}}" class="adt-details">Details<i class="icon-details fas fa-arrow-right"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="cards bg-card p-3 h-630">
              ...
              <div class="row">
                <div class="col-12 justify">
                  ...
                  <a href="{{ route('cc.icr.ledge-it.pengeluaranU',[$Branch->id, $user])}}" class="adt-details">Details<i class="icon-details fas fa-arrow-right"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="cards bg-card p-3 h-630">
              ...
              <div class="row">
                <div class="col-12 justify">
                  ...
                  <a href="{{ route('cc.icr.ledge-it.naU',[$Branch->id, $user])}}" class="adt-details">Details<i class="icon-details fas fa-arrow-right"></i></a>
                </div>
              </div>
            </div>
          </div>
